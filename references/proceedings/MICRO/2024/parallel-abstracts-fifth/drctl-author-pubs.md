...
- **[DATE]** **[An IR drop-robust Mapping Method for Reliable Memristive Accelerators](https://ieeexplore.ieee.org/abstract/document/11539583)** is accepted by Design, Automation & Test in Europe Conference & Exhibition (DATE), 2026.
  <br/>Jinpeng Liu, Shiyi Song, Bing Wu, Huan Cheng, Heng Zhou, Xueliang Wei, Wei Tong and Dan Feng.
- **[DATE]** **[Data Distribution-Aware Analog/Digital Conversion Strategy for Energy-Efficient Memristive In-Situ Accelerators](https://ieeexplore.ieee.org/abstract/document/11539353)** is accepted by Design, Automation & Test in Europe Conference & Exhibition (DATE), 2026.
...
- **[JSA]** **[ColRefresh: A variation-robust read disturbance mitigation framework in RRAM-based computing-in-memory architectures](https://www.sciencedirect.com/science/article/pii/S1383762126002456)** is accepted by Journal of Systems Architecture(JSA), 2026. 
  <br/>Heng Zhou, Bing Wu, Jinpeng Liu, Huan Cheng, Taoming Lei, Zezheng Li, Dan Feng, Wei Tong, Xueliang Wei
