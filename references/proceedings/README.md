...
[ASPLOS 2026](ASPLOS/2026/README.md)沿用已核对的 168 个日程 DOI，当前筛读 85 篇完整原始摘要；82 份代表 PDF／1,411 页含两份复用原件。35 篇正文候选中 Shift、SuperOffload、AttenIO 与 RedFuser 已选读声明范围，另三十一篇待读；三十一篇备查、十九篇排除，83 篇摘要待补。第 81–105 项新增二十一篇摘要、二十一份代表 PDF／353 页，四个出版商 403 和三个作者元数据范围分别保留。另存的四页 CAL 2024 STRAW 稿不计入本届覆盖，版本、机构摘要与失败路径分别记录。五份公开位置查询覆盖 168 个不同 DOI，171 条位置记录保留重复，不增加论文数。
