...
[ASPLOS 2025 出版目录核对](ASPLOS/2025/README.md)将官方主日程的 184 个 DOI 全部匹配到出版元数据，包含 24 个 ASPLOS 2024 Volume 4 条目。两份查询覆盖本日程，不能证明正式卷全集；匹配结果没有摘要，另由作者／机构来源取得 34 份公开稿，筛读 35 篇原始摘要并选读 IKS、FSMoE、昇腾单元分析、Diffuse、CXLfork 和 DarwinGame 的声明正文范围；其余 149 篇摘要及更多正文继续归档。
