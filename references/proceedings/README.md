...
[ASPLOS 2026](ASPLOS/2026/README.md)沿用已核对的 168 个日程 DOI，当前筛读 100 篇完整原始摘要；96 份代表 PDF／1,653 页含两份复用原件。39 篇正文候选中 Shift、SuperOffload、AttenIO、RedFuser、RhymeRL 与 LOOPRAG 已选读声明范围，另三十三篇待读；三十七篇备查、二十四篇排除，68 篇摘要待补。第 106–130 项新增十五篇完整摘要、十四份代表 PDF／242 页；机构摘要、早期稿、题名差异与失败路径分别记录。另存四页 CAL 2024 STRAW 和十四页 2022 COGENT 稿，不计入本届覆盖。五份公开位置查询覆盖 168 个不同 DOI，171 条位置记录保留重复，不增加论文数。
