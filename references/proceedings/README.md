...
[ASPLOS 2025 出版目录核对](ASPLOS/2025/README.md)将官方主日程的 184 个 DOI 全部匹配到出版元数据，包含 24 个 ASPLOS 2024 Volume 4 条目。两份查询覆盖本日程，不能证明正式卷全集；匹配结果没有摘要，另由作者／机构来源取得 65 份代表 PDF／1110 页，筛读 68 篇原始完整摘要，十二篇有声明范围的正文阅读，最新补 Helix；其余 116 篇摘要及更多正文继续归档。PipeLLM 另一个作者版本单列，不重复计为论文。
