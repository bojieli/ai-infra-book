...
def main():
 ...
 source=ROOT.parent/'storage-v3';shutil.copytree(source,storage)
 trace=[json.loads(l) for l in (ROOT.parent/'results/consumer-v6/storage.jsonl').read_text().splitlines()]
