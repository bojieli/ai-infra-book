...
输入：`{"accepted_samples": 16, "head_strategy": "dense", "output_tokens": 256, "prompt_tokens": 1024, "prompts": 16, "reference_passes": 1, "rollout_replicas": 1, "samples_per_prompt": 4, "teacher_passes": 0, "update_epochs": 1}`
...
| generated_output_tokens | 16,384 |
...
| first_decode_matrix_flops | 1,007,408,906,240 |
| last_decode_matrix_flops | 1,016,997,085,184 |
| rollout_matrix_flops | 1,188,397,586,579,456 |
| cycle_matrix_flops | 3,410,701,494,255,616 |
| matrix_flops_per_accepted_sample | 213,168,843,390,976.0 |
| matrix_flops_per_accepted_output_token | 832,690,794,496.0 |
...
| 阶段 | 样本 | 次数 | 矩阵 FLOPs |
| --- | ---: | ---: | ---: |
| rollout_prefill | 64 | 1 | 930285822672896 |
| rollout_decode | 64 | 255 | 258111763906560 |
| reference_scoring | 64 | 1 | 1269887947243520 |
| teacher_scoring | 64 | 0 | 0 |
