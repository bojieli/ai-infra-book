...
输入：`{"capacity_bytes": 16384, "causal": true, "kv_blocks": [1, 64, 128], "kv_slots": 1, "tokens": 129}`
...
| --- | ---: |
| head_dim | 128 |
| one_read_write_qkvo_bytes | 132,096 |
| separate_fp32_score_and_probability_bytes | 133,128 |
| separate_score_probability_read_write_bytes | 266,256 |
| valid_matrix_flops | 4,293,120 |
| feasible_candidates | 1 |
| best_enumerated_kv_block | 1 |
| best_enumerated_interface_bytes | 347,136 |
| measured_hbm_bytes | `null` |
| predicted_kernel_seconds | `null` |

| b | a | 可放 | 接口 bytes | 块对更新 | 旧输出缩放乘法 |
| --- | --- | --- | ---: | ---: | ---: |
| 1 | 20 | True | 347136 | 549 | 1056768 |
| 64 | None | False | None | None | None |
| 128 | None | False | None | None | None |
