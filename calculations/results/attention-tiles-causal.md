...
输入：`{"capacity_bytes": 131072, "causal": true, "kv_blocks": [1, 64, 128], "kv_slots": 1, "tokens": 8192}`
...
| valid_matrix_flops | 17,181,966,336 |
| feasible_candidates | 3 |
| best_enumerated_kv_block | 1 |
| best_enumerated_interface_bytes | 112,503,808 |
| measured_hbm_bytes | `null` |
| predicted_kernel_seconds | `null` |

| b | a | 可放 | 接口 bytes | 块对更新 | 旧输出缩放乘法 |
| --- | --- | --- | ---: | ---: | ---: |
| 1 | 166 | True | 112503808 | 211542 | 4294443008 |
| 64 | 110 | True | 165871616 | 4934 | 66584576 |
| 128 | 76 | True | 236584960 | 3546 | 33030144 |
