...
输入：`{"baseline_packets_per_core_second": null, "cpu_target_utilization": "1", "encapsulation_bytes": 0, "link_bits_per_second": 40000000000, "link_utilization": "1", "packet_mix": [{"frame_bytes": 64, "packet_share": "1/2"}, {"frame_bytes": 1518, "packet_share": "1/2"}], "pcie": null, "retained_host_work": "1", "wire_overhead_bytes": 20}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| mean_wire_bytes_per_packet_exact | `"811"` |
| mean_work_multiplier_exact | `"1"` |
| packets_per_second_exact | `"5000000000/811"` |
| original_frame_bytes_per_second_exact | `"3955000000000/811"` |
| wire_bytes_per_second_exact | `"5000000000"` |
| retained_host_work_exact | `"1"` |
| dedicated_cpu_cores | `[1, 1]` |
| complete_virtualization_cpu_cores | `null` |

| 历史/声明每核包率 | 忙核秒/秒 | 留余量后的核当量 | 专用整数核 |
| --- | --- | --- | --- |
| 10000000 | 500/811 | 500/811 | 1 |
| 20000000 | 250/811 | 250/811 | 1 |

包数分布：`[{"frame_bytes": 64, "wire_bytes": 84, "packet_share_exact": "1/2", "work_multiplier_exact": "1", "packets_per_second_exact": "2500000000/811"}, {"frame_bytes": 1518, "wire_bytes": 1538, "packet_share_exact": "1/2", "work_multiplier_exact": "1", "packets_per_second_exact": "2500000000/811"}]`
