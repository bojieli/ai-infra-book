...
输入：`{"activation_bytes": 2, "batch": 64, "tokens": 1}`
...
| matrix_flops | 4,336,910,336 |
| scalar_flops | 1,163,917,760 |
| special_ops | `{"rsqrt": 5568, "sigmoid": 44288, "exp": 88064, "compare_max": 66048}` |
| residual_activation_tensor_bytes | 2,097,152 |
| one_sublayer_post_comb_fp32_bytes | 5,120 |
| embedding_repeat_output_bytes | 2,097,152 |

mHC 运算总数已乘出现次数；张量尺寸为单次出现。

| 操作 | 次数 | 形状 | 矩阵 FLOPs | 普通 FLOPs | 特殊原语 | 说明 |
| --- | ---: | --- | ---: | ---: | --- | --- |
| pre_rms_statistic | 86 | {'input': [64, 16384]} | 0 | 180,360,576 | {'rsqrt': 5504} | FP32 square, sum, mean division and epsilon. No learned RMS scale in hc_pre. |
| pre_mix_projection | 86 | {'A': [64, 16384], 'W_math': [16384, 24], 'Y': [64, 24]} | 4,328,521,728 | 0 | {} | FP32 source operands; accumulator and achievable matrix-unit peak require a separate backend match. |
| pre_mix_normalize | 86 | {'mixes': [64, 24]} | 0 | 132,096 | {} |  |
| split_sinkhorn | 86 | {'pre': [64, 4], 'post': [64, 4], 'comb': [64, 4, 4]} | 0 | 10,083,328 | {'sigmoid': 44032, 'exp': 88064, 'compare_max': 66048} | Initial row softmax, one column normalization, then 19 row/column pairs. Per-cell epsilon expressions are not hoisted. |
| pre_weighted_reduce | 86 | {'input': [64, 4, 4096], 'output': [64, 4096]} | 0 | 157,810,688 | {} | c multiplies and c-1 sum additions per output channel; output casts to activation dtype. |
| post_residual_mix | 86 | {'residual': [64, 4, 4096], 'comb': [64, 4, 4], 'output': [64, 4, 4096]} | 0 | 811,597,824 | {} | Literal broadcast/reduce: c²H residual multiplies, c(c-1)H reductions, cH post multiplies and cH final adds. |
| head_rms_statistic | 1 | {'input': [64, 16384]} | 0 | 2,097,216 | {'rsqrt': 64} |  |
| head_mix_projection | 1 | {'A': [64, 16384], 'W_math': [16384, 4], 'Y': [64, 4]} | 8,388,608 | 0 | {} |  |
| head_mix_and_gate | 1 | {'pre': [64, 4]} | 0 | 1,024 | {'sigmoid': 256} | Multiply RMS statistic, scale, add base, sigmoid, add epsilon. |
| head_weighted_reduce | 1 | {'input': [64, 4, 4096], 'output': [64, 4096]} | 0 | 1,835,008 | {} |  |
