...
输入：`{"dtype": "bf16", "encoder_cache_hits": 0, "images": null, "images_per_request": 4, "kv_dtype": "bf16", "output_tokens": 1024, "preprocessed_height": 640, "preprocessed_width": 640, "text_tokens": 400}`
...
| requested_output_tokens | 1,024 |
| decode_forward_calls | 1,023 |
| prefill_causal_pairs | 2,001,000 |
| decode_causal_pairs | 2,569,776 |
| vision_matrix_flops | 5,241,202,278,400 |
| language_matrix_flops | 25,459,563,167,744 |
| total_matrix_flops | 30,700,765,446,144 |
| language_scalar_flops | 32,029,319,335 |
...
| final_kv_positions | 3,023 |
| final_kv_bytes | 445,759,488 |
| decode_kv_new_write_bytes | 150,847,488 |
| decode_kv_unique_payload_reads_bytes | 378,928,889,856 |
| output_head_evaluations | 1,024 |

| 请求阶段 | 执行次数 | 已汇总矩阵FLOPs |
| --- | ---: | ---: |
| vision_encode | 4 | 5241202278400 |
| language_prefill | 1 | 15714279096320 |
| language_decode | 1023 | 9745284071424 |
...
| apply_rope | 36 | {'Q': [1, 32, 1, 128], 'K': [1, 8, 1, 128]} | 0 | 0 | 10752/10240 |
| kv_append | 36 | {'new_K_and_V_each': [1, 8, 1, 128]} | 0 | 0 | 4096/4096 |
| qk | 36 | {'Q': [1, 32, 1, 128], 'K_shared': [1, 8, 3023, 128], 'scores_rectangular': [1, 32, 1, 3023]} | 24764416 | 0 | 6199296/386944 |
| score_scale_mask_softmax | 36 | {'scores': [1, 32, 1, 3023]} | 0 | 0 | 386944/386944 |
| pv | 36 | {'P': [1, 32, 1, 3023], 'V_shared': [1, 8, 3023, 128], 'output': [1, 32, 1, 128]} | 24764416 | 0 | 6578048/8192 |
| o_proj | 36 | {'input': [1, 4096], 'weight_math': [4096, 2560], 'weight_storage': [2560, 4096], 'output': [1, 2560]} | 20971520 | 20971520 | 8192/5120 |
| attention_residual | 36 | {'inputs_each': [1, 2560], 'output': [1, 2560]} | 0 | 0 | 10240/5120 |
| post_attention_layernorm | 36 | {'input': [1, 2560], 'weight': [2560], 'output': [1, 2560]} | 0 | 5120 | 5120/5120 |
| gate_proj | 36 | {'input': [1, 2560], 'weight_math': [2560, 9728], 'weight_storage': [9728, 2560], 'output': [1, 9728]} | 49807360 | 49807360 | 5120/19456 |
