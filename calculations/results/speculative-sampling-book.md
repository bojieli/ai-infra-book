...
输入：`{"draft": ["1/6", "1/3", "1/2"], "target": ["1/2", "1/3", "1/6"]}`
...
| --- | ---: |
| vocabulary_size | 3 |
| acceptance_exact | `"2/3"` |
| rejection_exact | `"1/3"` |
| output_mass_exact | `"1"` |
| output_matches_target | `true` |
| total_variation_exact | `"0"` |
| wrong_total_variation_exact | `"1/6"` |

| token | 目标 p | 草稿 q | 条件接受 | 接受质量 | 拒绝修正分布 | 正确输出 | 错误输出 |
| ---: | --- | --- | --- | --- | --- | --- | --- |
| 0 | 1/2 | 1/6 | 1 | 1/6 | 1 | 1/2 | 1/3 |
| 1 | 1/3 | 1/3 | 1 | 1/3 | 0 | 1/3 | 4/9 |
| 2 | 1/6 | 1/2 | 1/3 | 1/6 | 0 | 1/6 | 2/9 |
