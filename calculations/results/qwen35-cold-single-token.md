...
| matrix_flops | 59868938432 |
| scalar_flops | 3285597423 |
| reference_integer_operations | 498125 |
| full_forward_exact | False |

特殊数学 primitive：`{"cos": 96, "exp": 12386400, "max_comparisons": 30660, "rsqrt": 9271, "sigmoid": 3382140, "sin": 96, "softplus": 2880, "topk_selections": 60}`。
...
```json
{
  ...
  "conv": {
    "input_positions": 4,
    "conv_output_positions_before_slice": 7,
    "silu_positions_before_final_crop": 4,
    "source_path": "padded_fn",
    "record_past_shape_known": true
  },
  "state": {
    "full_kv_before_bytes": 0,
    "full_kv_after_bytes": 30720,
...
| attention_matrix | 491520 | 0 |
| copy | 0 | 0 |
| depthwise_conv | 1105920 | 0 |
| elementwise | 0 | 94986240 |
| gate | 0 | 5760 |
| gather | 0 | 0 |
| linear | 32658391040 | 0 |
| normalization | 0 | 7066551 |
| reference_supplement | 29860032 | 202584672 |
| rotary | 0 | 97920 |
| router | 0 | 93240 |
| routing | 0 | 4915200 |
| softmax | 0 | 1440 |
| state_matrix | 27179089920 | 0 |
| triangular_solve | 0 | 2972712960 |
...
| --- | ---: | ---: | ---: |
| conv.additional_padded_and_discarded_products | 45 | 98304 | 172032 |
| conv.extra_silu_before_final_crop | 45 | 98304 | 98304 |
| conv.cache_concat_or_initial_pad | 45 | 24576 | 98304 |
| conv.cache_copy_last4 | 45 | 98304 | 98304 |
| conv.cache_initial_zero | 45 | 0 | 98304 |
| chunk.fp32_input_casts | 45 | 49536 | 98816 |
| chunk.pad_q_k_v_beta_g | 45 | 98816 | 6324224 |
| chunk.beta_K_V | 2880 | 65792 | 65536 |
| chunk.cumsum | 2880 | 256 | 256 |
| chunk.triu_mask_construction | 45 | 0 | 4096 |
| chunk.pairwise_decay_difference_mask_exp | 2880 | 4608 | 49152 |
| chunk.ut_and_intra_decay_multiply | 2880 | 65536 | 32768 |
| chunk.exp_cum_for_decayed_Kbeta | 2880 | 33024 | 33024 |
| chunk.exp_cum_for_Q | 2880 | 33024 | 33024 |
| chunk.last_minus_cum_exp_for_K | 2880 | 33028 | 33280 |
| chunk.exp_final_decay | 2880 | 4 | 4 |
| chunk.unit_triangular_solver_interfaces | 2880 | 98304 | 65536 |
| chunk.scan_vnew_subtract | 2880 | 65536 | 32768 |
| chunk.scan_output_add | 2880 | 65536 | 32768 |
| chunk.scan_state_decay_add | 2880 | 196612 | 131072 |
| chunk.initial_state_zeros | 45 | 0 | 4194304 |
| chunk.output_zeros_and_indexed_writes | 45 | 0 | 4194304 |
| chunk.crop_and_output_cast | 45 | 32768 | 16384 |
...
| full.repeat_kv_logical_materialization | 15 | 2048 | 32768 |
| full.QK_interfaces | 15 | 32768 | 64 |
| full.scale_mask_softmax_cast_interfaces | 15 | 320 | 320 |
| full.PV_interfaces | 15 | 16448 | 16384 |
| full.transpose_contiguous | 15 | 16384 | 16384 |
| mask.arange_offsets | 1 | 0 | 48 |
| mask.causal_compare_before_batch_expand | 1 | 16 | 1 |
| mask.bool_to_BF16_where | 1 | 1 | 2 |
