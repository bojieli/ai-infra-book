...
输入：`{"bandwidth_bytes_per_second": 50000000000, "batch": 1, "message_dtype": "BF16", "participants": 4, "root": 0, "segmentation": false, "startup_ns": 2000, "tokens": 1}`
...
| maximum_rank_send_bytes | 16,384 |
| maximum_rank_receive_bytes | 16,384 |
| all_reduce_startup_seconds | 8e-06 |
| all_reduce_bandwidth_seconds | 6.5536e-07 |
| all_reduce_modeled_seconds | 8.655359999999999e-06 |
| dense_tp_all_reduce_calls | 72 |
| dense_tp_serial_collective_seconds | 0.00062318592 |
| measured_collective_seconds | `null` |

| 阶段 | 轮次 | sender → receiver (bytes) |
| --- | ---: | --- |
| reduce | 0 | 1 → 0 (8192); 3 → 2 (8192) |
| reduce | 1 | 2 → 0 (8192) |
| broadcast | 0 | 0 → 2 (8192) |
| broadcast | 1 | 0 → 1 (8192); 2 → 3 (8192) |
