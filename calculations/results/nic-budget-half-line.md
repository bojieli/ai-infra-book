...
输入：`{"baseline_packets_per_core_second": null, "cpu_target_utilization": "1", "encapsulation_bytes": 0, "link_bits_per_second": 40000000000, "link_utilization": "1/2", "packet_mix": null, "pcie": null, "retained_host_work": "1", "wire_overhead_bytes": 20}`
...
| packets_per_second_exact | `"625000000/21"` |
| original_frame_bytes_per_second_exact | `"40000000000/21"` |
| wire_bytes_per_second_exact | `"2500000000"` |
| retained_host_work_exact | `"1"` |
| dedicated_cpu_cores | `[3, 2]` |
| complete_virtualization_cpu_cores | `null` |

| 历史/声明每核包率 | 忙核秒/秒 | 留余量后的核当量 | 专用整数核 |
| --- | --- | --- | --- |
| 10000000 | 125/42 | 125/42 | 3 |
| 20000000 | 125/84 | 125/84 | 2 |

包数分布：`[{"frame_bytes": 64, "wire_bytes": 84, "packet_share_exact": "1", "work_multiplier_exact": "1", "packets_per_second_exact": "625000000/21"}]`
