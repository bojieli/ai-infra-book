...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 1 | 312 | 437/125 | 437/125 | True |
| tp4-replicas2 | True | 1 | 350 | 19/5 | 19/5 | True |
| tp2-replicas4 | True | 1 | 410 | 107/25 | 107/25 | True |

选择：`{"required_valid_requests": 1, "eligible": ["tp8-replicas1", "tp4-replicas2", "tp2-replicas4"], "minimum_cost_per_valid_request_exact": "437/125", "winners": ["tp8-replicas1"]}`
...
```json
{
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "437/125",
        "missing_terms": [],
        "full_declared_cost_exact": "437/125",
        "cost_per_slo_valid_request_exact": "437/125",
    ...
    },
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "19/5",
        "missing_terms": [],
        "full_declared_cost_exact": "19/5",
        "cost_per_slo_valid_request_exact": "19/5",
        "observed_or_measured": false
      },
      "valid_requests": 1,
      "slo_eligible": true
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "107/25",
        "observed_or_measured": false
      },
      "valid_requests": 1,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "437/125",
    "winners": [
      "tp8-replicas1"
    ]
  },
