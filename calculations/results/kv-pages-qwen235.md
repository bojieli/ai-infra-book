...
输入：`{"capacity_bytes": null, "events": [{"id": "a", "op": "create", "tokens": 17}, {"id": "b", "op": "fork", "parent": "a"}, {"id": "c", "op": "fork", "parent": "a"}, {"id": "a", "op": "append", "tokens": 1}, {"id": "b", "op": "append", "tokens": 16}, {"id": "c", "op": "cancel"}], "model": "qwen3-235b-a22b", "page_tokens": 16, "reservation_tokens": 64}`
...
| page_bytes | 3,080,192 |
| capacity_pages | `null` |
| unusable_capacity_bytes | `null` |
| rejected_events | 0 |
| peak_allocated_page_bytes | 15,400,960 |
| final_allocated_page_bytes | 12,320,768 |
| final_logical_request_bytes | 9,818,112 |
| final_unique_live_bytes | 6,737,920 |
| final_unused_page_bytes | 5,582,848 |
| final_private_paged_bytes | 15,400,960 |
| final_fixed_reservation_bytes | 24,641,536 |
| total_copied_valid_bytes | 385,024 |

| 事件 | 操作 | 接纳 | 逻辑 bytes | 唯一有效 bytes | 分配 bytes | 空位 bytes | COW bytes |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: |
| 0 | {'op': 'create', 'id': 'a', 'tokens': 17} | True | 3272704 | 3272704 | 6160384 | 2887680 | 0 |
| 1 | {'op': 'fork', 'parent': 'a', 'id': 'b'} | True | 6545408 | 3272704 | 6160384 | 2887680 | 0 |
| 2 | {'op': 'fork', 'parent': 'a', 'id': 'c'} | True | 9818112 | 3272704 | 6160384 | 2887680 | 0 |
| 3 | {'op': 'append', 'id': 'a', 'tokens': 1} | True | 10010624 | 3657728 | 9240576 | 5582848 | 192512 |
| 4 | {'op': 'append', 'id': 'b', 'tokens': 16} | True | 13090816 | 6930432 | 15400960 | 8470528 | 192512 |
| 5 | {'op': 'cancel', 'id': 'c'} | True | 9818112 | 6737920 | 12320768 | 5582848 | 0 |
