...
输入：`{"bandwidth_bytes_per_second": 50000000000, "combine_element_bytes": 4, "participants": 8, "pattern": "spread", "routes": "Explicit per-token routes are preserved in the JSON result.", "startup_ns": 2000, "tokens_per_rank": 64}`
...
| deduplicated_dispatch_bytes | 29,360,128 |
| per_assignment_combine_bytes | 58,720,256 |
| destination_combined_return_bytes | 58,720,256 |
| dispatch_saved_bytes | 0 |
| combine_saved_bytes | 0 |
| original_source_reduction_adds | 14,680,064 |
| destination_reduction_adds | 0 |
| remaining_source_reduction_adds | 14,680,064 |
| assignment_pairwise_seconds | 0.00024820096 |
| dedup_pairwise_seconds | 0.00024820096 |
| metadata_bytes | `null` |
...
归约工作转移：`{"destination_adds_per_rank": [0, 0, 0, 0, 0, 0, 0, 0], "source_adds_per_rank": [1835008, 1835008, 1835008, 1835008, 1835008, 1835008, 1835008, 1835008]}`；逐 token 专家身份见 JSON。
