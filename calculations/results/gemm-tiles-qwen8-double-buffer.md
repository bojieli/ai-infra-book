...
输入：`{"capacity_bytes": 81920, "input_buffers": 2, "order": "output-stationary", "tile_k": 32, "tiles": [32, 64, 128], "tokens": 1024}`
...
| best_enumerated_tile | `[64, 32, 64]` |
| best_enumerated_next_level_bytes | 3,246,391,296 |
| measured_hbm_bytes | `null` |
| predicted_seconds | `null` |

| m/k/n | 容量 bytes | 下一层 bytes | partial 读+写 bytes | 可放 |
| --- | ---: | ---: | ---: | --- |
| 32/32/32 | 12288 | 6467616768 | 0 | True |
| 64/32/64 | 32768 | 3246391296 | 0 | True |
| 128/32/128 | 98304 | 1635778560 | 0 | False |
