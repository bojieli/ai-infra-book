...
输入：`{"append_encode_ns": 20000, "bandwidth_bytes_per_second": 1000000000000, "batch": 1, "decode_fixed_ns": 100000, "decode_ns_per_value": "1/1000", "length": 8192, "model": "qwen3-235b-a22b"}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| values_per_cached_position | 96,256 |
| bf16_history_bytes | 1,577,058,304 |
| bf16_next_token_append_bytes | 192,512 |
| baseline_read_append_ns_exact | `"197156352/125"` |

| 格式 | 历史bytes | scale bytes | 追加bytes | 融合总ns | 物化总ns | 融合省ns | 长历史持续获益起点 |
| --- | ---: | ---: | ---: | --- | --- | --- | --- |
| BF16 | 1577058304 | 0 | 192512 | 197156352/125 | 197156352/125 | 0 | None |
| Q8_0 | 837812224 | 49283072 | 102272 | 218305456/125 | 612570032/125 | -21149104/125 | None |
| Q4_0 | 443547648 | 49283072 | 54144 | 169016368/125 | 563280944/125 | 28139984/125 | 2847 |
