...
输入：`{"block_sizes": [2, 1], "scores": [0, 0.6931471805599453, 1.3862943611198906], "values": [[1], [3], [-2]]}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| direct_output | `[-0.14285714285714285]` |
| sequential_output | `[-0.14285714285714285]` |
| tree_output | `[-0.14285714285714285]` |
| naive_mean_of_block_outputs | `[0.16666666666666674]` |
| sequential_max_abs_error | 0.0 |
| tree_max_abs_error | 0.0 |
| naive_mean_max_abs_error | 0.3095238095238096 |
| nonempty_blocks | 2 |
| nontrivial_merges | 1 |
| merge_exp_calls | 2 |
| merge_subtractions | 2 |
| merge_weighted_sum_flops | 6 |
...
| --- | ---: | --- | --- | --- |
| 0 | 2 | True | [2.3333333333333335] | [2.3333333333333335] |
| 1 | 1 | True | [-2.0] | [-0.14285714285714285] |
