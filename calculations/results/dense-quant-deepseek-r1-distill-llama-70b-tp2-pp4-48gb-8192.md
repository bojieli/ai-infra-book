...
TP=2 / PP=4 / DP=1；保留长度 8,192 （含最后新 token）；每卡 48,000,000,000 bytes，workspace 条件预算 2,147,483,648 bytes。
...
|---:|---:|---:|---|
| 16 | 141,110,050,816 | 82 | True |
| 8 | 73,728,557,056 | 107 | True |
| 4 | 39,503,036,416 | 120 | True |
...
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 18,164,088,832 | 0 | 335,544,320 | 27,688,427,520 | 82 | True | 47,826,206,720 | 48,161,751,040 |
| 8 | 9,607,708,672 | 133,693,440 | 335,544,320 | 36,111,114,240 | 107 | True | 47,792,128,000 | 48,127,672,320 |
| 4 | 5,329,518,592 | 133,693,440 | 335,544,320 | 40,389,304,320 | 120 | True | 47,876,014,080 | 48,211,558,400 |
...
| bits | payload bytes | scale bytes | KV bytes/请求 | KV 可用 bytes | 最大请求 | 权重+workspace 可放入 | 最大请求常驻 bytes | 下一请求 bytes |
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 17,113,415,680 | 0 | 335,544,320 | 28,739,100,672 | 85 | True | 47,782,166,528 | 48,117,710,848 |
| 8 | 8,557,035,520 | 133,693,440 | 335,544,320 | 37,161,787,392 | 110 | True | 47,748,087,808 | 48,083,632,128 |
| 4 | 4,278,845,440 | 133,693,440 | 335,544,320 | 41,439,977,472 | 123 | True | 47,831,973,888 | 48,167,518,208 |
...
| bits | payload bytes | scale bytes | KV bytes/请求 | KV 可用 bytes | 最大请求 | 权重+workspace 可放入 | 最大请求常驻 bytes | 下一请求 bytes |
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 18,164,105,216 | 0 | 335,544,320 | 27,688,411,136 | 82 | True | 47,826,223,104 | 48,161,767,424 |
| 8 | 9,607,725,056 | 133,693,440 | 335,544,320 | 36,111,097,856 | 107 | True | 47,792,144,384 | 48,127,688,704 |
| 4 | 5,329,534,976 | 133,693,440 | 335,544,320 | 40,389,287,936 | 120 | True | 47,876,030,464 | 48,211,574,784 |
