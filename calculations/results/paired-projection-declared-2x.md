...
|---|---:|---:|---:|---:|
| 1/reused | 4.61074999e-08 | 2.3843402e-08 | 0.01327896 | 0.0171672495 |
| 1/rotating | 5.07363883e-08 | 2.88144818e-08 | 0.0146120798 | 0.0207464269 |
| 256/reused | 5.09826388e-07 | 1.81383317e-08 | 0.14683 | 0.0130595989 |
| 256/rotating | 5.09784426e-07 | 1.8598722e-08 | 0.146817915 | 0.0133910798 |
    ...
    },
    {
      ...
      "cost_per_call_proxy": {
        ...
        "cuda": {
          ...
          "denominator": 20000000000000000000000
        }
      },
      "joules_per_call_proxy": {
        "mps": {
    ...
    },
    {
      ...
      "cost_per_call_proxy": {
        ...
        "cuda": {
          ...
          "denominator": 60000000000000000000000
        }
      },
      "joules_per_call_proxy": {
        "mps": {
