...
输入：`{"capacity_bytes": null, "events": [{"id": "a", "op": "create", "tokens": 17}, {"id": "b", "op": "fork", "parent": "a"}, {"id": "c", "op": "fork", "parent": "a"}, {"id": "a", "op": "append", "tokens": 1}, {"id": "b", "op": "append", "tokens": 16}, {"id": "c", "op": "cancel"}], "model": "qwen3-8b", "page_tokens": 16, "reservation_tokens": 64}`
...
| final_allocated_page_bytes | 9,437,184 |
| final_logical_request_bytes | 7,520,256 |
| final_unique_live_bytes | 5,160,960 |
| final_unused_page_bytes | 4,276,224 |
| final_private_paged_bytes | 11,796,480 |
