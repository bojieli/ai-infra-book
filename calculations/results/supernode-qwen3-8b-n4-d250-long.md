...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 0 | 498 | 623/125 | None | False |
| tp4-replicas2 | True | 2 | 450 | 23/5 | 23/10 | False |
| tp2-replicas4 | True | 3 | 410 | 107/25 | 107/75 | True |

选择：`{"required_valid_requests": 3, "eligible": ["tp2-replicas4"], "minimum_cost_per_valid_request_exact": "107/75", "winners": ["tp2-replicas4"]}`
...
```json
{
  ...
  "candidates": [
    ...
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "23/10",
        "observed_or_measured": false
      },
      "valid_requests": 2,
      "slo_eligible": false
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "107/75",
        "observed_or_measured": false
      },
      "valid_requests": 3,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "107/75",
    "winners": [
      "tp2-replicas4"
    ]
  },
