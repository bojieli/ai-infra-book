...
输入：`{"accumulator_dtype": "FP32", "batch": 64, "history": 8192, "input_dtype": "BF16", "scale_dtype": "E8M0", "sparsity": "dense", "tokens": 1, "weight_dtype": "FP8 E4M3", "world_size": 1}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| valid_matrix_flops | 565,056,634,880 |
| padded_tile_matrix_flops | 565,056,634,880 |
| activation_quantization_scalar_flops | 78,068,736 |
| activation_abs_ops | 77,463,552 |
| activation_max_comparisons | 77,463,552 |
| activation_clamp_comparisons | 154,927,104 |
| activation_round_scale_calls | 605,184 |
| activation_fp8_cast_elements | 77,463,552 |
| activation_e8m0_cast_elements | 605,184 |
| scale_product_flops | 17,244,160 |
| scale_corrected_accumulation_flops | 4,414,504,960 |
| logical_scale_flops | 4,431,749,120 |
| padded_scale_flops | 4,431,749,120 |
| quantization_interface_bytes | 232,995,840 |
| gemm_interface_bytes | 4,771,305,600 |
| total_interface_bytes | 5,004,301,440 |
| resident_weight_bytes | 4,414,504,960 |
| resident_weight_scale_bytes | 269,440 |
| activation_fp8_bytes | 77,463,552 |
| activation_scale_bytes | 605,184 |
| output_bf16_bytes | 278,462,464 |
| linear_invocations | 322 |

| Linear | 调用数 | 权重shape | 有效矩阵FLOPs | tile矩阵FLOPs | scale FLOPs |
| --- | ---: | --- | ---: | ---: | ---: |
| wq_a | 43 | [1024, 4096] | 23085449216 | 23085449216 | 181059584 |
| wq_b | 43 | [32768, 1024] | 184683593728 | 184683593728 | 1448476672 |
| wkv_shared | 43 | [512, 4096] | 11542724608 | 11542724608 | 90529792 |
| wo_b | 43 | [4096, 8192] | 184683593728 | 184683593728 | 1448476672 |
| index_wq_b | 21 | [8192, 1024] | 22548578304 | 22548578304 | 176848896 |
| shared_gate | 43 | [2048, 4096] | 46170898432 | 46170898432 | 362119168 |
| shared_up | 43 | [2048, 4096] | 46170898432 | 46170898432 | 362119168 |
| shared_down | 43 | [4096, 2048] | 46170898432 | 46170898432 | 362119168 |
