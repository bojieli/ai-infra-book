...
模式：independent_blocks；完整成片 309/25 秒；预览 108/25 秒（None表示未声明）。
...
| preview_encode | server | 83/20 | 21/5 | process.0, encode.0 |
| process.1 | server | 161/20 | 163/20 | input_arrival.1, preview_encode |
...
| download.preview | downlink | 423/100 | 427/100 | preview_encode, download.final.0 |
| arrival.preview | None | 427/100 | 108/25 | download.preview |
| download.final.1 | downlink | 163/20 | 831/100 | encode.1, download.preview |
...
```json
{
  ...
  "events": [
    ...
    },
    {
      "id": "arrival.preview",
      "resource": null,
      "start_seconds_exact": "427/100",
      "duration_seconds_exact": "1/20",
      "end_seconds_exact": "108/25",
      "dependencies": [
        "download.preview"
      ]
    },
  ...
  "summary": {
    ...
    "preview_ready_seconds_exact": "108/25",
