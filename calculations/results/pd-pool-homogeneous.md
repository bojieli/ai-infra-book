...
输入：`{"arrival_requests_per_second": "4", "cached_prefix_tokens": 0, "model": "qwen3-8b", "network_bytes_per_second": 25000000000, "output_tokens": 129, "prompt_tokens": 8192, "workers": [{"count": 8, "decode_tokens_per_second": 128, "name": "same", "prefill_tokens_per_second": 8192}]}`
...
| assignments | 9 |
| best_prefill_workers | `{"same": 4}` |
| best_decode_workers | `{"same": 4}` |
| best_pd_bound_requests_per_second_exact | `"4"` |
| colocated_bound_requests_per_second_exact | `"4"` |
...
| --- | --- | --- | --- | --- | --- | --- |
| {'same': 0} | {'same': 8} | 0 | 8 | 0 | ['prefill'] | False |
| {'same': 1} | {'same': 7} | 1 | 7 | 1 | ['prefill'] | False |
| {'same': 2} | {'same': 6} | 2 | 6 | 2 | ['prefill'] | False |
| {'same': 3} | {'same': 5} | 3 | 5 | 3 | ['prefill'] | False |
| {'same': 4} | {'same': 4} | 4 | 4 | 4 | ['prefill', 'decode'] | False |
| {'same': 5} | {'same': 3} | 5 | 3 | 3 | ['decode'] | False |
| {'same': 6} | {'same': 2} | 6 | 2 | 2 | ['decode'] | False |
| {'same': 7} | {'same': 1} | 7 | 1 | 1 | ['decode'] | False |
| {'same': 8} | {'same': 0} | 8 | 0 | 0 | ['decode'] | False |
