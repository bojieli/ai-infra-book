...
TP=2 / PP=4 / DP=1；保留长度 32,768 （含最后新 token）；每卡 24,000,000,000 bytes，workspace 条件预算 2,147,483,648 bytes。
...
|---:|---:|---:|---|
| 16 | 141,110,050,816 | 2 | True |
| 8 | 73,728,557,056 | 9 | True |
| 4 | 39,503,036,416 | 12 | True |
...
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 18,164,088,832 | 0 | 1,342,177,280 | 3,688,427,520 | 2 | True | 22,995,927,040 | 24,338,104,320 |
| 8 | 9,607,708,672 | 133,693,440 | 1,342,177,280 | 12,111,114,240 | 9 | True | 23,968,481,280 | 25,310,658,560 |
| 4 | 5,329,518,592 | 133,693,440 | 1,342,177,280 | 16,389,304,320 | 12 | True | 23,716,823,040 | 25,059,000,320 |
...
| bits | payload bytes | scale bytes | KV bytes/请求 | KV 可用 bytes | 最大请求 | 权重+workspace 可放入 | 最大请求常驻 bytes | 下一请求 bytes |
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 17,113,415,680 | 0 | 1,342,177,280 | 4,739,100,672 | 3 | True | 23,287,431,168 | 24,629,608,448 |
| 8 | 8,557,035,520 | 133,693,440 | 1,342,177,280 | 13,161,787,392 | 9 | True | 22,917,808,128 | 24,259,985,408 |
| 4 | 4,278,845,440 | 133,693,440 | 1,342,177,280 | 17,439,977,472 | 12 | True | 22,666,149,888 | 24,008,327,168 |
...
| bits | payload bytes | scale bytes | KV bytes/请求 | KV 可用 bytes | 最大请求 | 权重+workspace 可放入 | 最大请求常驻 bytes | 下一请求 bytes |
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 18,164,105,216 | 0 | 1,342,177,280 | 3,688,411,136 | 2 | True | 22,995,943,424 | 24,338,120,704 |
| 8 | 9,607,725,056 | 133,693,440 | 1,342,177,280 | 12,111,097,856 | 9 | True | 23,968,497,664 | 25,310,674,944 |
| 4 | 5,329,534,976 | 133,693,440 | 1,342,177,280 | 16,389,287,936 | 12 | True | 23,716,839,424 | 25,059,016,704 |
