...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 5 | 746 | 871/125 | 871/625 | False |
| tp4-replicas2 | True | 7 | 650 | 31/5 | 31/35 | True |
| tp2-replicas4 | True | 8 | 570 | 139/25 | 139/200 | True |

选择：`{"required_valid_requests": 6, "eligible": ["tp4-replicas2", "tp2-replicas4"], "minimum_cost_per_valid_request_exact": "139/200", "winners": ["tp2-replicas4"]}`
...
```json
{
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "871/625",
    ...
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "31/35",
        "observed_or_measured": false
      },
      "valid_requests": 7,
      "slo_eligible": true
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "139/200",
        "observed_or_measured": false
      },
      "valid_requests": 8,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "139/200",
    "winners": [
      "tp2-replicas4"
    ]
  },
