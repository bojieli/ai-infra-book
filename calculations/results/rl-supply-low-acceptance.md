...
| accepted_samples | 16 |
| serial_component_batch_seconds | 29.39616626147328 |
| ideal_pipeline_interval_lower_seconds | 17.55701730869248 |
| limiting_pools | `["actor"]` |
| conditional_serial_accepted_samples_per_second | 0.5442886619188047 |
| ideal_pipeline_accepted_samples_per_second_upper | 0.9113165248221519 |
| actual_cycle_seconds | `null` |

| 阶段 | 资源池 | 稳态服务需求 s | 孤立批次 s |
| --- | --- | ---: | ---: |
| rollout_prefill | actor | 4.651429113 | 4.651429113 |
| rollout_decode | actor | 12.905588195 | 12.905588195 |
| reference_scoring | reference | 6.349439736 | 6.349439736 |
| teacher_scoring | teacher | 0.000000000 | 0.000000000 |
| policy_update | learner | 4.762079802 | 4.762079802 |
| verification | verifier | 0.400000000 | 0.400000000 |
| weight_sync | weight_link | 0.327629414 | 0.327629414 |

| 池 | 累积服务需求 s |
| --- | ---: |
| actor | 17.557017309 |
| reference | 6.349439736 |
| teacher | 0.000000000 |
| learner | 4.762079802 |
| verifier | 0.400000000 |
