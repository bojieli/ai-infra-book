...
输入：`{"card_capacity_bytes": 80000000000, "cards": 1, "link_bits_per_second": 400000000000, "link_efficiency": 1.0, "messages": 1, "metadata_bytes_per_card": 0, "parameters": 70000000000, "payload_bytes": 140000000000, "shard_parameters": [70000000000], "startup_seconds": 3e-06, "state_bytes_per_card": 0, "weight_bits": 16, "workspace_bytes_per_card": 0}`
...
| aggregate_capacity_bytes | 80,000,000,000 |
| aggregate_occupied_bytes | 140,000,000,000 |
| aggregate_capacity_sufficient | `false` |
| every_card_fits_declared_budget | `false` |
...
| ideal_payload_service_seconds | 2.8 |
| modeled_payload_service_seconds | 2.8 |
| modeled_startup_seconds | 3e-06 |
| modeled_serial_transfer_seconds | 2.800003 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 0 | 140,000,000,000 | 0 | 0 | 0 | 80,000,000,000 | -60,000,000,000 | False |
