...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 4 | 318 | 318/125 | 159/250 | True |
| tp4-replicas2 | True | 4 | 270 | 54/25 | 27/50 | True |
| tp2-replicas4 | True | 4 | 230 | 46/25 | 23/50 | True |

选择：`{"required_valid_requests": 3, "eligible": ["tp8-replicas1", "tp4-replicas2", "tp2-replicas4"], "minimum_cost_per_valid_request_exact": "23/50", "winners": ["tp2-replicas4"]}`
...
```json
{
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "318/125",
        "missing_terms": [],
        "full_declared_cost_exact": "318/125",
        "cost_per_slo_valid_request_exact": "159/250",
    ...
    },
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "54/25",
        "missing_terms": [],
        "full_declared_cost_exact": "54/25",
        "cost_per_slo_valid_request_exact": "27/50",
        "observed_or_measured": false
      },
      "valid_requests": 4,
      "slo_eligible": true
    },
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "46/25",
        "missing_terms": [],
        "full_declared_cost_exact": "46/25",
        "cost_per_slo_valid_request_exact": "23/50",
        "observed_or_measured": false
      },
      "valid_requests": 4,
      "slo_eligible": true
  ...
  "selection": {
    "required_valid_requests": 3,
    "eligible": [
      "tp8-replicas1",
      "tp4-replicas2",
      "tp2-replicas4"
    ],
    "minimum_cost_per_valid_request_exact": "23/50",
    "winners": [
      "tp2-replicas4"
    ]
  },
