...
输入：`{"capacity_bytes": 81920, "input_buffers": 1, "order": "output-stationary", "tile_k": 32, "tiles": [32, 64, 128], "tokens": 1025}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| valid_matrix_flops | 103,179,878,400 |
| one_read_write_payload_bytes | 134,250,496 |
| feasible_candidates | 3 |
| best_enumerated_tile | `[128, 32, 128]` |
| best_enumerated_next_level_bytes | 1,737,252,864 |
| measured_hbm_bytes | `null` |
| predicted_seconds | `null` |

| m/k/n | 容量 bytes | 下一层 bytes | partial 读+写 bytes | 可放 |
| --- | ---: | ---: | ---: | --- |
| 32/32/32 | 8192 | 6571450368 | 0 | True |
| 64/32/64 | 24576 | 3348652032 | 0 | True |
| 128/32/128 | 81920 | 1737252864 | 0 | True |
