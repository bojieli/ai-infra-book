...
输入：`{"rows": 1, "splits": 8, "width_multiplier": 16}`
...
| scalar_flops | 262,145 |
| rsqrt_calls | 1 |
| first_pass_groups | 8 |
| second_pass_groups | 1 |
| apply_groups | 8 |
| local_reduction_adds | 65,528 |
| merge_reduction_adds | 7 |
| partial_buffer_bytes | 32 |
| inverse_buffer_bytes | 4 |
| fused_interface_bytes | 393,216 |
| split_interface_bytes | 524,388 |
| additional_interface_bytes | 131,172 |
| fused_retained_fp32_row_bytes | 262,144 |
| split_max_partition_fp32_bytes | 32,768 |
| predicted_seconds | `null` |

| 策略 | 总组数 | launches | 接口 bytes | 辅助缓冲 bytes |
| --- | ---: | ---: | ---: | ---: |
| one_group_per_row | 1 | 1 | 393216 | 0 |
| three_pass_split | 17 | 3 | 524388 | 36 |
