...
输入：`{"host_capacity_bytes": 268435456, "model": "qwen3-8b", "next_use_ns": 5000000, "offload_bandwidth": 25000000000, "recompute_ns": 50000000, "restore_bandwidth": 25000000000, "tokens": 1024, "transfer_startup_ns": 10000}`
...
| prefetch_start_exact_ns | `"151244944/25"` |
| offload_return_stall_exact_ns | `"177489888/25"` |
| recompute_start_ns | 0 |
| recompute_stall_ns | 45,000,000 |
| host_snapshot_fits | `true` |

| 策略 | 容量可行 | 恢复等待 ns | KV释放时长 ns | 搬运 bytes | 重算矩阵 FLOPs |
| --- | --- | ---: | ---: | ---: | ---: |
| keep | True | 0 | 0 | 0 | 0 |
| offload_prefetch | True | 177489888/25 | 0 | 301989888 | 0 |
| drop_recompute | True | 45000000 | 0 | 0 | 14534471319552 |
