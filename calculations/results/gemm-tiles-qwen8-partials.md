# qwen-up-projection-tiles — qwen3-8b

输入：`{"capacity_bytes": 81920, "input_buffers": 1, "order": "k-outer", "tile_k": 32, "tiles": [32, 64, 128], "tokens": 1024}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| valid_matrix_flops | 103,079,215,104 |
| one_read_write_payload_bytes | 134,217,728 |
| feasible_candidates | 3 |
| best_enumerated_tile | `[128, 32, 128]` |
| best_enumerated_next_level_bytes | 14,420,017,152 |
| measured_hbm_bytes | `null` |
| predicted_seconds | `null` |

| m/k/n | 容量 bytes | 下一层 bytes | partial 读+写 bytes | 可放 |
| --- | ---: | ---: | ---: | --- |
| 32/32/32 | 8192 | 19251855360 | 12784238592 | True |
| 64/32/64 | 24576 | 16030629888 | 12784238592 | True |
| 128/32/128 | 81920 | 14420017152 | 12784238592 | True |
