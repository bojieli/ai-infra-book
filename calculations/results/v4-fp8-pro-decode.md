...
输入：`{"accumulator_dtype": "FP32", "batch": 1, "history": 8192, "input_dtype": "BF16", "scale_dtype": "E8M0", "sparsity": "dense", "tokens": 1, "weight_dtype": "FP8 E4M3", "world_size": 1}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| valid_matrix_flops | 37,213,962,240 |
| padded_tile_matrix_flops | 1,190,846,791,680 |
| activation_quantization_scalar_flops | 3,099,612 |
| activation_abs_ops | 3,075,584 |
| activation_max_comparisons | 3,075,584 |
| activation_clamp_comparisons | 6,151,168 |
| activation_round_scale_calls | 24,028 |
| activation_fp8_cast_elements | 3,075,584 |
| activation_e8m0_cast_elements | 24,028 |
| scale_product_flops | 1,135,680 |
| scale_corrected_accumulation_flops | 290,734,080 |
| logical_scale_flops | 291,869,760 |
| padded_scale_flops | 9,339,832,320 |
| quantization_interface_bytes | 9,250,780 |
| gemm_interface_bytes | 18,622,451,740 |
| total_interface_bytes | 18,631,702,520 |
| resident_weight_bytes | 18,606,981,120 |
| resident_weight_scale_bytes | 1,135,680 |
| activation_fp8_bytes | 3,075,584 |
| activation_scale_bytes | 24,028 |
| output_bf16_bytes | 11,235,328 |
| linear_invocations | 457 |

| Linear | 调用数 | 权重shape | 有效矩阵FLOPs | tile矩阵FLOPs | scale FLOPs |
| --- | ---: | --- | ---: | ---: | ---: |
| wq_a | 61 | [1536, 7168] | 1343225856 | 42983227392 | 10534944 |
| wq_b | 61 | [65536, 1536] | 12280922112 | 392989507584 | 96319488 |
| wkv_shared | 61 | [512, 7168] | 447741952 | 14327742464 | 3511648 |
| wo_b | 61 | [7168, 16384] | 14327742464 | 458487758848 | 112372736 |
| index_wq_b | 30 | [8192, 1536] | 754974720 | 24159191040 | 5921280 |
| shared_gate | 61 | [3072, 7168] | 2686451712 | 85966454784 | 21069888 |
| shared_up | 61 | [3072, 7168] | 2686451712 | 85966454784 | 21069888 |
| shared_down | 61 | [7168, 3072] | 2686451712 | 85966454784 | 21069888 |
