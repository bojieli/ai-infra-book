...
输入：`{"capacity_bytes": 81920, "input_buffers": 1, "order": "output-stationary", "tile_k": 32, "tiles": [32, 64, 128], "tokens": 1024}`
...
| best_enumerated_next_level_bytes | 1,635,778,560 |
| measured_hbm_bytes | `null` |
| predicted_seconds | `null` |

| m/k/n | 容量 bytes | 下一层 bytes | partial 读+写 bytes | 可放 |
| --- | ---: | ---: | ---: | --- |
| 32/32/32 | 8192 | 6467616768 | 0 | True |
| 64/32/64 | 24576 | 3246391296 | 0 | True |
| 128/32/128 | 81920 | 1635778560 | 0 | True |
