...
输入：`{"accepted_counts": [2, 1, 1, 2, 4], "baseline_token_ns": 50000, "commit_ns": 10000, "draft_ns": 100000, "draft_tokens": 4, "history": 1024, "model": "qwen3-8b", "remaining_output_tokens": null, "verify_ns": 100000}`
...
| accepted_draft_tokens | 25 |
| draft_acceptance_fraction_exact | `"5/8"` |
| mean_accepted_drafts_exact | `"5/2"` |
| mean_delivered_tokens_exact | `"7/2"` |
| delivered_tokens | 35 |
| total_speculative_ns | 2,100,000 |
| matched_baseline_ns | 1,750,000 |
| time_per_delivered_token_exact_ns | `"60000"` |
| unweighted_round_time_per_token_exact_ns | `"86800"` |
| matched_time_speedup_exact | `"5/6"` |
| target_verify_rows | 5 |
| target_verify_matrix_flops_per_round | 78,709,719,040 |
| target_verify_matrix_flops_total | 787,097,190,400 |
| matched_serial_matrix_flops_total | 550,959,775,744 |
| target_peak_kv_bytes | 151,732,224 |
| target_verify_new_kv_bytes | 737,280 |
| total_discarded_target_kv_bytes | 2,211,840 |

| 接受草稿 | 次数 | 实际交付 | 保留新增KV bytes | 丢弃新增KV bytes | 匹配串行FLOPs |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 2 | 1 | 147456 | 589824 | 15740764160 |
| 1 | 1 | 2 | 294912 | 442368 | 31482118144 |
| 2 | 1 | 3 | 442368 | 294912 | 47224061952 |
| 3 | 2 | 4 | 589824 | 147456 | 62966595584 |
| 4 | 4 | 5 | 737280 | 0 | 78709719040 |
