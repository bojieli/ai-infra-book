...
输入：`{"evaluations_per_step": 1, "frames": 120, "height": 768, "model": "minimax-h3", "negative_text_tokens": 128, "positive_text_tokens": 256, "reference_audio_tokens": 0, "reference_video_tokens": 0, "regeneration_height": 1536, "regeneration_steps": 15, "regeneration_width": 2688, "steps": 30, "text_tokens": 256, "unique_timestep_values": 30, "width": 1344}`
...
| layers | 50 |
| matrix_core_flops | 967,269,379,179,479,040 |
| stages | 2 |
...
| matrix_core_plus_conditioning_flops | 967,272,067,551,068,160 |
...
阶段：declared_regeneration；执行次数=15

| 矩阵 | A | B | C | copies | 每evaluation汇总FLOPs | 逻辑bytes |
| --- | --- | --- | --- | ---: | ---: | ---: |

实际调度条件化（完整逐步矩阵及缓存账见同名JSON）：`{"status": "accounted", "scheduler_grid_points": 16, "forward_evaluations": 15, "schedule_capture_torch_version": "2.14.0", "executed_conditioning_matrix_flops": 1148430581760, "executed_scalar_counts": {"ordinary_arithmetic": 13688756887002, "exp": 6268416, "negate": 6268416, "rsqrt": 283532250, "sinusoid_multiply": 13184, "sinusoid_divide": 1920, "sinusoid_exp": 1920, "sinusoid_log": 15, "sin": 5632, "cos": 5632}, "actual_unique_timestep_values": [0.0, 0.0059171319007873535, 0.012658298015594482, 0.020408153533935547, 0.023255884647369385, 0.029411733150482178, 0.04000002145767212, 0.04878050088882446, 0.05263155698776245, 0.06796115636825562, 0.07692301273345947, 0.08695650100708008, 0.10810810327529907, 0.11111116409301758, 0.14285719394683838, 0.1818181276321411, 0.18644064664840698, 0.22580647468566895, 0.2500000596046448, 0.27586203813552856, 0.3333333134651184, 0.3513513207435608, 0.40000003576278687, 0.4782608151435852, 0.5384615063667297, 0.5714285969734192, 0.684210479259491, 0.8235293626785278, 0.9990000128746033], "hypothetical_cache": {"unique_timestep_count": 29, "table_bytes": 281250816, "precompute_matrix_flops": 756920156160, "precompute_silu_elements": 4131456, "precompute_sinusoid_counts": {"multiply": 7552, "divide": 128, "exp": 128, "log": 1, "sin": 3712, "cos": 3712}, "precompute_bias_adds": 140859264, "matrix_work_saved_after_precompute": 391510425600, "table_write_bytes": 281250816, "table_reads_per_forward_sum_bytes": 426725376, "row_modulation_reads_sum_bytes": 9115432704000, "note": "Hypothetical persistent modulation cache: precompute and table IO are charged; per-token RMSNorm/modulation/gates remain. Pinned forward does not implement this cache."}, "assumptions": ["steps仍指旧core字段声明的forward次数；实际scheduler传入steps+1网格点，终点zero不forward。CPU float32原方法执行结果已封存；1..128范围外明确unavailable，不伪装理论数列等于真实舍入。", "每step distinct值严格由video/audio与存在的参考噪声集合构成：visual max(t,0.999)、audio1.0，再按FP32归并；文本沿video timestep。", "本项覆盖时间MLP、每block与final AdaLN投影、SiLU/bias、关联RMSNorm及逐token调制/gated残差。其他attention/FFN内部scalar、VAE和文本编码器不因本项自动完成。", "缓存单独收费整个unique集合的时间MLP和modulation投影、表写读；不会消除按token的norm/scale/shift/gate，也不代表当前代码已有缓存。跨stage缓存复用未假定。"]}`

| step | video time | audio time | distinct times | 每evaluation条件化矩阵FLOPs |
| --- | --- | --- | --- | --- |
| 0 | 0.0 | 0.0 | 2 | 52201390080 |
| 1 | 0.0059171319007873535 | 0.023255884647369385 | 3 | 78302085120 |
| 2 | 0.012658298015594482 | 0.04878050088882446 | 3 | 78302085120 |
| 3 | 0.020408153533935547 | 0.07692301273345947 | 3 | 78302085120 |
| 4 | 0.029411733150482178 | 0.10810810327529907 | 3 | 78302085120 |
| 5 | 0.04000002145767212 | 0.14285719394683838 | 3 | 78302085120 |
| 6 | 0.05263155698776245 | 0.1818181276321411 | 3 | 78302085120 |
| 7 | 0.06796115636825562 | 0.22580647468566895 | 3 | 78302085120 |
| 8 | 0.08695650100708008 | 0.27586203813552856 | 3 | 78302085120 |
| 9 | 0.11111116409301758 | 0.3333333134651184 | 3 | 78302085120 |
| 10 | 0.14285719394683838 | 0.40000003576278687 | 3 | 78302085120 |
| 11 | 0.18644064664840698 | 0.4782608151435852 | 3 | 78302085120 |
| 12 | 0.2500000596046448 | 0.5714285969734192 | 3 | 78302085120 |
| 13 | 0.3513513207435608 | 0.684210479259491 | 3 | 78302085120 |
| 14 | 0.5384615063667297 | 0.8235293626785278 | 3 | 78302085120 |
| joint.qkv | [187150, 5376] | [5376, 7168] | [187150, 7168] | 150 | 2163557007360000 | 715843430400 |
| joint.out | [187150, 7168] | [7168, 5376] | [187150, 5376] | 50 | 721185669120000 | 238614476800 |
| joint.ffn_up | [187150, 5376] | [5376, 14336] | [187150, 14336] | 100 | 2884742676480000 | 753234227200 |
| joint.ffn_down | [187150, 14336] | [14336, 5376] | [187150, 5376] | 50 | 1442371338240000 | 376617113600 |
| joint.qk | [187150, 128] | [128, 187150] | [187150, 187150] | 2800 | 25106007808000000 | 196408984240000 |
| joint.pv | [187150, 187150] | [187150, 128] | [187150, 128] | 2800 | 25106007808000000 | 196408984240000 |
| text_refiner.qkv | [256, 5376] | [5376, 7168] | [256, 7168] | 6 | 118380036096 | 500957184 |
| text_refiner.out | [256, 7168] | [7168, 5376] | [256, 5376] | 2 | 39460012032 | 166985728 |
| text_refiner.ffn_up | [256, 5376] | [5376, 14336] | [256, 14336] | 4 | 157840048128 | 656932864 |
| text_refiner.ffn_down | [256, 14336] | [14336, 5376] | [256, 5376] | 2 | 78920024064 | 328466432 |
| text_refiner.qk | [256, 128] | [128, 256] | [256, 256] | 112 | 1879048192 | 29360128 |
| text_refiner.pv | [256, 256] | [256, 128] | [256, 128] | 112 | 1879048192 | 29360128 |
| video_input | [186480, 96] | [96, 5376] | [186480, 5376] | 1 | 192483164160 | 4083738624 |
| audio_input | [414, 32] | [32, 5376] | [414, 5376] | 1 | 142442496 | 9643776 |
| text_input | [256, 5120] | [5120, 5376] | [256, 5376] | 1 | 14092861440 | 60424192 |
| video_output_all_rows | [187150, 5376] | [5376, 96] | [187150, 96] | 1 | 193174732800 | 4098403584 |
| audio_output_all_rows | [187150, 5376] | [5376, 32] | [187150, 32] | 1 | 64391577600 | 4049116928 |
