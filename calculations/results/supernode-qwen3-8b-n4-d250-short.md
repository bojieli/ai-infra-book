...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 2 | 318 | 318/125 | 159/125 | False |
| tp4-replicas2 | True | 3 | 270 | 54/25 | 18/25 | True |
| tp2-replicas4 | True | 4 | 230 | 46/25 | 23/50 | True |

选择：`{"required_valid_requests": 3, "eligible": ["tp4-replicas2", "tp2-replicas4"], "minimum_cost_per_valid_request_exact": "23/50", "winners": ["tp2-replicas4"]}`
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "159/125",
    ...
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "18/25",
        "observed_or_measured": false
      },
      "valid_requests": 3,
      "slo_eligible": true
