...
| server_flight_received | 11/2 |
| client_1rtt_keys_installed | 11/2 |
| server_address_validated | 8 |
| handshake_ack_received | 8 |
| client_finished_received | 9 |
| complete_request | 15 |
| application_execution | 15 |
| response_ready | 15 |
| complete_response | 35/2 |

## 有效业务与已建模字节

| 数量 | 值 |
| --- | ---: |
| early_payload_sent_bytes | 5840 |
| one_rtt_payload_sent_bytes | 7008 |
| request_payload_sent_bytes | 12848 |
| accepted_unique_request_bytes | 7008 |
| discarded_early_payload_bytes | 5840 |
| delivered_response_payload_bytes | 100 |
| application_execution_count | 1 |
| modeled_wire_bytes_by_direction.c2s | 17192 |
| modeled_wire_bytes_by_direction.s2c | 3684 |
| last_modeled_arrival | 35/2 |
