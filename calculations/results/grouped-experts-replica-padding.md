...
输入：`{"counts": null, "model": "qwen3-235b-a22b", "participants": 8, "placement": "contiguous", "replicas": [{"expert": 0, "rank": 4}], "routing": "concentrated", "tile_k": 32, "tile_m": 64, "tile_n": 128, "tokens": 33}`
...
| experts | 128 |
| active_experts | 8 |
| token_expert_tasks | 264 |
| additional_physical_copies | 1 |
| rerouted_token_expert_tasks | 16 |
| replica_weight_bytes | 37,748,736 |
| replica_weight_bytes_per_rank | `[0, 0, 0, 0, 37748736, 0, 0, 0]` |
| equivalent_full_model_kv_tokens_per_rank_floor | `[0, 0, 0, 0, 196, 0, 0, 0]` |
| baseline_max_rank_padded_flops | 19,327,352,832 |
| max_rank_padded_flops_reduction | 0 |
| added_padded_flops | 2,415,919,104 |
| padded_token_rows | 576 |
| valid_matrix_flops | 9,965,666,304 |
| padded_matrix_flops | 21,743,271,936 |
| padding_work_ratio_exact | `"24/11"` |
| max_rank_valid_flops | 9,361,686,528 |
| max_rank_padded_flops | 19,327,352,832 |
| valid_rank_imbalance_exact | `"248/33"` |
| padded_rank_imbalance_exact | `"64/9"` |
| distinct_expert_weight_bytes | 301,989,888 |
| tile_schedule_weight_read_bytes | 339,738,624 |
| tile_schedule_next_level_bytes | 421,380,096 |
| extra_weight_tile_reads_bytes | 37,748,736 |

| rank | 非空物理副本 | token—专家任务 | 有效FLOPs | 完全补齐FLOPs | 权重tile读取bytes | 接口总bytes |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 8 | 248 | 9361686528 | 19327352832 | 301989888 | 378683392 |
| 1 | 0 | 0 | 0 | 0 | 0 | 0 |
| 2 | 0 | 0 | 0 | 0 | 0 | 0 |
| 3 | 0 | 0 | 0 | 0 | 0 | 0 |
| 4 | 1 | 16 | 603979776 | 2415919104 | 37748736 | 42696704 |
| 5 | 0 | 0 | 0 | 0 | 0 | 0 |
| 6 | 0 | 0 | 0 | 0 | 0 | 0 |
| 7 | 0 | 0 | 0 | 0 | 0 | 0 |
