...
输入：`{"attention_path": "segmented_varlen", "element_bytes": 2, "mel_lengths": [100, 1, 101]}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| matrix_flops | 53,385,134,080 |
| scalar_flops | 38,082,844 |
| parameter_elements | 647,927,168 |
| weight_interface_bytes | 1,295,854,336 |
| activation_read_bytes | 85,993,524 |
| activation_write_bytes | 76,909,568 |
| output_embeddings_per_audio | `[13, 1, 14]` |
| output_embedding_elements | 57,344 |
| output_embedding_bytes | 114,688 |
| padded_cnn_positions | 52 |
| valid_encoder_positions | 28 |
| segmented_bidirectional_pairs | 366 |
| source_unmasked_eager_pairs | 784 |
...
组批：`{"padded_mel_width": 100, "after_cnn_width": 13, "attention_window_positions": 104, "convolution_chunk_batch_limit": 500, "convolution_groups": 1, "retained_cnn_group_outputs_bytes": 798720, "max_single_group_output_bytes": 798720}`

| 算子 | 类型 | 形状 | repeats | 矩阵FLOPs | 标量工作 | 特殊操作 |
| --- | --- | --- | --- | --- | --- | --- |
| mel_chunk_pad | copy | {'input': [128, 202], 'output': [4, 1, 128, 100]} | 1 | 0 | 0 | {} |
| conv2d_1 | conv2d | {'input': [4, 1, 128, 100], 'weight': [480, 1, 3, 3], 'output': [4, 480, 64, 50]} | 1 | 110592000 | 6144000 | {} |
| conv_gelu_1 | activation | {'elements': 6144000} | 1 | 0 | 0 | {'gelu': 6144000} |
| conv2d_2 | conv2d | {'input': [4, 480, 64, 50], 'weight': [480, 480, 3, 3], 'output': [4, 480, 32, 25]} | 1 | 13271040000 | 1536000 | {} |
| conv_gelu_2 | activation | {'elements': 1536000} | 1 | 0 | 0 | {'gelu': 1536000} |
| conv2d_3 | conv2d | {'input': [4, 480, 32, 25], 'weight': [480, 480, 3, 3], 'output': [4, 480, 16, 13]} | 1 | 3450470400 | 399360 | {} |
| conv_gelu_3 | activation | {'elements': 399360} | 1 | 0 | 0 | {'gelu': 399360} |
| concat_and_layout | copy | {'concat': [4, 480, 16, 13], 'flatten': [52, 7680]} | 1 | 0 | 0 | {} |
| conv_out | linear | {'input': [52, 7680], 'weight': [1280, 7680], 'output': [52, 1280]} | 1 | 1022361600 | 0 | {} |
| chunk_position_add | position | {'padded': [4, 13, 1280]} | 1 | 0 | 66560 | {} |
| remove_padding | gather | {'input': [4, 13, 1280], 'output': [28, 1280]} | 1 | 0 | 0 | {} |
| attention_norm | layernorm | {'input': [28, 1280]} | 32 | 0 | 250908 | {'rsqrt': 28} |
| q | linear | {'input': [28, 1280], 'weight': [1280, 1280], 'output': [28, 1280]} | 32 | 91750400 | 35840 | {} |
| k | linear | {'input': [28, 1280], 'weight': [1280, 1280], 'output': [28, 1280]} | 32 | 91750400 | 35840 | {} |
| v | linear | {'input': [28, 1280], 'weight': [1280, 1280], 'output': [28, 1280]} | 32 | 91750400 | 35840 | {} |
| qk | attention | {'heads': 20, 'head_dim': 64, 'positions': 28, 'accounted_pairs': 366} | 32 | 936960 | 0 | {} |
| scale_softmax | attention | {'heads': 20, 'pairs': 366} | 32 | 0 | 28720 | {'exp': 7320, 'max_compare': 6760} |
| pv | attention | {'heads': 20, 'head_dim': 64, 'positions': 28, 'accounted_pairs': 366} | 32 | 936960 | 0 | {} |
| attention_output | linear | {'input': [28, 1280], 'weight': [1280, 1280], 'output': [28, 1280]} | 32 | 91750400 | 35840 | {} |
| attention_residual | residual | {'input': [28, 1280]} | 32 | 0 | 35840 | {} |
| ffn_norm | layernorm | {'input': [28, 1280]} | 32 | 0 | 250908 | {'rsqrt': 28} |
| ffn_fc1 | linear | {'input': [28, 1280], 'weight': [5120, 1280], 'output': [28, 5120]} | 32 | 367001600 | 143360 | {} |
| ffn_gelu | activation | {'elements': 143360} | 32 | 0 | 0 | {'gelu': 143360} |
| ffn_fc2 | linear | {'input': [28, 5120], 'weight': [1280, 5120], 'output': [28, 1280]} | 32 | 367001600 | 35840 | {} |
| ffn_residual | residual | {'input': [28, 1280]} | 32 | 0 | 35840 | {} |
| post_norm | layernorm | {'input': [28, 1280]} | 1 | 0 | 250908 | {'rsqrt': 28} |
| proj1 | linear | {'input': [28, 1280], 'weight': [1280, 1280], 'output': [28, 1280]} | 1 | 91750400 | 35840 | {} |
| projection_gelu | activation | {'elements': 35840} | 1 | 0 | 0 | {'gelu': 35840} |
| proj2_to_thinker | linear | {'input': [28, 1280], 'weight': [2048, 1280], 'output': [28, 2048]} | 1 | 146800640 | 57344 | {} |
