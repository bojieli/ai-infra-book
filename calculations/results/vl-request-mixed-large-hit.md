...
输入：`{"dtype": "bf16", "images": [{"height": 256, "width": 256}, {"cache_hit": true, "height": 512, "width": 512}], "kv_dtype": "bf16", "output_tokens": 128, "text_tokens": 400}`
...
| vision_matrix_flops | 175,825,223,680 |
| language_matrix_flops | 6,466,232,123,392 |
| total_matrix_flops | 6,642,057,347,072 |
| language_scalar_flops | 4,726,719,527 |
| vision_scalar_counts | `{"add": 215764544, "multiply": 246465408, "cos": 8192, "sin": 8192, "rsqrt": 12736, "negate": 6291456, "comparison": 25067520, "subtract": 25165824, "exp": 25165824, "divide": 25165824, "tanh": 25165824, "erf": 1048576}` |
...
| 1 | True | [1, 32, 32] | 1024 | 256 | 0 | 5242880 |
...
| 1 | patch_embedding | [1024, 1536] | [1536, 1024] | 1 | 0 |
| 1 | block.qkv | [1024, 1024] | [1024, 3072] | 24 | 0 |
| 1 | block.qk | [1024, 64] | [64, 1024] | 384 | 0 |
| 1 | block.pv | [1024, 1024] | [1024, 64] | 384 | 0 |
| 1 | block.attention_output | [1024, 1024] | [1024, 1024] | 24 | 0 |
| 1 | block.mlp_up | [1024, 1024] | [1024, 4096] | 24 | 0 |
| 1 | block.mlp_down | [1024, 4096] | [4096, 1024] | 24 | 0 |
| 1 | merger_final.up | [256, 4096] | [4096, 4096] | 1 | 0 |
| 1 | merger_final.out | [256, 4096] | [4096, 2560] | 1 | 0 |
| 1 | merger_deepstack_5.up | [256, 4096] | [4096, 4096] | 1 | 0 |
| 1 | merger_deepstack_5.out | [256, 4096] | [4096, 2560] | 1 | 0 |
| 1 | merger_deepstack_11.up | [256, 4096] | [4096, 4096] | 1 | 0 |
| 1 | merger_deepstack_11.out | [256, 4096] | [4096, 2560] | 1 | 0 |
| 1 | merger_deepstack_17.up | [256, 4096] | [4096, 4096] | 1 | 0 |
| 1 | merger_deepstack_17.out | [256, 4096] | [4096, 2560] | 1 | 0 |

| 请求阶段 | 执行次数 | 已汇总矩阵FLOPs |
| --- | ---: | ---: |
| vision_encode | 1 | 175825223680 |
