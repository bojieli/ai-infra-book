...
输入：`{"kv_capacity_bytes": null, "requests": [{"arrival_ns": 0, "decode_ns": 1000000, "output_tokens": 128, "prefill_ns": 1024000, "prompt_tokens": 1024}, {"arrival_ns": 500000, "decode_ns": 1000000, "output_tokens": 128, "prefill_ns": 1024000, "prompt_tokens": 1024}, {"arrival_ns": 1000000, "decode_ns": 1000000, "output_tokens": 128, "prefill_ns": 1024000, "prompt_tokens": 1024}, {"arrival_ns": 1500000, "decode_ns": 1000000, "output_tokens": 128, "prefill_ns": 1024000, "prompt_tokens": 1024}], "workers": 2}`
...
| p95_prompt_tokens | 1,024 |
| p95_output_tokens | 128 |
| prefill_matrix_flops | 58,142,863,917,056 |
| decode_matrix_flops | 8,015,184,920,576 |
| mean_waiting_ns | 63,512,000.0 |
| p95_waiting_ns | 127,024,000 |
| p95_ttft_ns | 128,048,000 |
| p95_latency_ns | 255,048,000 |
| finish_ns | 256,548,000 |
| kv_bytes_per_token | 147,456 |
| kv_peak_bytes | 339,443,712 |
| kv_residency_byte_ns | 82,117,996,314,624,000 |
| kv_reservation_peak_bytes | `null` |
| kv_reservation_byte_ns | `null` |
| complete_device_peak_bytes | `null` |

| 请求 | worker | 开始 ns | 完成 ns | 等待 ns | TTFT ns | 最后 KV bytes |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| 0 | 0 | 0 | 128024000 | 0 | 1024000 | 169721856 |
| 1 | 1 | 500000 | 128524000 | 0 | 1024000 | 169721856 |
| 2 | 0 | 128024000 | 256048000 | 127024000 | 128048000 | 169721856 |
| 3 | 1 | 128524000 | 256548000 | 127024000 | 128048000 | 169721856 |
