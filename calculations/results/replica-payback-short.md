...
| baseline_window_ns_exact | `"2992111616/125"` |
| replicated_window_ns_exact | `"3008643544/125"` |
| window_saving_ns_exact | `"-16531928/125"` |
| selected_deployment | `"baseline"` |
| selected_window_ns_exact | `"2992111616/125"` |
