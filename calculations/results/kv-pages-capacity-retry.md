...
输入：`{"capacity_bytes": 4718592, "events": [{"id": "a", "op": "create", "tokens": 17}, {"id": "b", "op": "fork", "parent": "a"}, {"id": "b", "op": "append", "tokens": 1}, {"id": "a", "op": "cancel"}, {"id": "b", "op": "append", "tokens": 1}], "model": "qwen3-8b", "page_tokens": 16, "reservation_tokens": 64}`
...
| final_logical_request_bytes | 2,654,208 |
| final_unique_live_bytes | 2,654,208 |
| final_unused_page_bytes | 2,064,384 |
| final_private_paged_bytes | 4,718,592 |
| final_fixed_reservation_bytes | 9,437,184 |
...
| 1 | {'op': 'fork', 'id': 'b', 'parent': 'a'} | True | 5013504 | 2506752 | 4718592 | 2211840 | 0 |
| 2 | {'op': 'append', 'id': 'b', 'tokens': 1} | False | 5013504 | 2506752 | 4718592 | 2211840 | 0 |
| 3 | {'op': 'cancel', 'id': 'a'} | True | 2506752 | 2506752 | 4718592 | 2211840 | 0 |
| 4 | {'op': 'append', 'id': 'b', 'tokens': 1} | True | 2654208 | 2654208 | 4718592 | 2064384 | 0 |
