...
输入：`{"budget_bytes": 1048576, "endpoint_state_bytes": 256, "isolation_classes": 8, "peers": 128, "relation_state_bytes": 64, "relations": "Explicit active relations are preserved in the JSON result.", "threads": 64, "transport_state_bytes": 1024}`
...
| shared_transport_count | 1,024 |
| endpoint_bytes | 16,384 |
| relation_bytes | 524,288 |
| coupled_transport_bytes | 8,388,608 |
| shared_transport_bytes | 1,048,576 |
| coupled_total_bytes | 8,929,280 |
| shared_total_bytes | 1,589,248 |
| saved_bytes | 7,340,032 |
| coupled_fits_budget | `false` |
| shared_fits_budget | `false` |
| largest_shared_group_relations | 8 |
