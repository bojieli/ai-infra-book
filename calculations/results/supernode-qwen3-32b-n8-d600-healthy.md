...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 4 | 992 | 992/125 | 248/125 | False |
| tp4-replicas2 | True | 6 | 800 | 32/5 | 16/15 | True |
| tp2-replicas4 | False | None | None | None | None | False |

选择：`{"required_valid_requests": 6, "eligible": ["tp4-replicas2"], "minimum_cost_per_valid_request_exact": "16/15", "winners": ["tp4-replicas2"]}`
...
```json
{
  ...
  "candidates": [
    ...
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "16/15",
        "observed_or_measured": false
      },
      "valid_requests": 6,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "16/15",
    "winners": [
      "tp4-replicas2"
    ]
  },
