...
输入：`{"dtype": "bf16", "encoder_cache_hits": 0, "images": null, "images_per_request": 1, "kv_dtype": "bf16", "output_tokens": 128, "preprocessed_height": 640, "preprocessed_width": 640, "text_tokens": 400}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| visual_positions | 400 |
| non_image_prompt_positions | 400 |
| prompt_positions | 800 |
| requested_output_tokens | 128 |
| decode_forward_calls | 127 |
| prefill_causal_pairs | 320,400 |
| decode_causal_pairs | 109,728 |
| vision_matrix_flops | 1,310,300,569,600 |
| language_matrix_flops | 7,089,440,161,792 |
| total_matrix_flops | 8,399,740,731,392 |
| language_scalar_flops | 5,344,409,847 |
| vision_scalar_counts | `{"add": 2174282000, "multiply": 2366162400, "cos": 51200, "sin": 51200, "rsqrt": 79600, "negate": 39321600, "comparison": 982425600, "subtract": 983040000, "exp": 983040000, "divide": 983040000, "tanh": 157286400, "erf": 6553600}` |
| deepstack_language_layer_indices | `[0, 1, 2]` |
| deepstack_prefill_add_elements | 3,072,000 |
| language_parameters | 4,022,468,096 |
| language_weight_bytes | 8,044,936,192 |
| vision_weight_bytes | 830,695,424 |
| complete_encoder_bytes_per_request | 8,192,000 |
| kv_bytes_per_position | 147,456 |
| prefill_kv_bytes | 117,964,800 |
| final_kv_positions | 927 |
| final_kv_bytes | 136,691,712 |
| decode_kv_new_write_bytes | 18,726,912 |
| decode_kv_unique_payload_reads_bytes | 16,180,051,968 |
| output_head_evaluations | 128 |

| 请求阶段 | 执行次数 | 已汇总矩阵FLOPs |
| --- | ---: | ---: |
| vision_encode | 1 | 1310300569600 |
| language_prefill | 1 | 6003062865920 |
| language_decode | 127 | 1086377295872 |

language_prefill：每行成本乘repeats；完整decode等差和见JSON。

| 算子 | repeats | 形状 | 矩阵FLOPs | 读权重bytes | 读/写激活bytes |
| --- | ---: | --- | ---: | ---: | --- |
| embedding | 1 | {'indices': [1, 800], 'table': [151936, 2560], 'output': [800, 2560]} | 0 | 4096000 | 6400/4096000 |
| mrope_table | 1 | {'position_ids': [3, 1, 800], 'axis_frequencies': [3, 1, 800, 64], 'cos_sin_each': [1, 800, 128]} | 0 | 0 | 19456/409600 |
| input_layernorm | 36 | {'input': [800, 2560], 'weight': [2560], 'output': [800, 2560]} | 0 | 5120 | 4096000/4096000 |
| q_proj | 36 | {'input': [800, 2560], 'weight_math': [2560, 4096], 'weight_storage': [4096, 2560], 'output': [800, 4096]} | 16777216000 | 20971520 | 4096000/6553600 |
| k_proj | 36 | {'input': [800, 2560], 'weight_math': [2560, 1024], 'weight_storage': [1024, 2560], 'output': [800, 1024]} | 4194304000 | 5242880 | 4096000/1638400 |
| v_proj | 36 | {'input': [800, 2560], 'weight_math': [2560, 1024], 'weight_storage': [1024, 2560], 'output': [800, 1024]} | 4194304000 | 5242880 | 4096000/1638400 |
| q_norm | 36 | {'input': [25600, 128], 'weight': [128], 'output': [25600, 128]} | 0 | 256 | 6553600/6553600 |
| k_norm | 36 | {'input': [6400, 128], 'weight': [128], 'output': [6400, 128]} | 0 | 256 | 1638400/1638400 |
| apply_rope | 36 | {'Q': [1, 32, 800, 128], 'K': [1, 8, 800, 128]} | 0 | 0 | 8601600/8192000 |
| kv_append | 36 | {'new_K_and_V_each': [1, 8, 800, 128]} | 0 | 0 | 3276800/3276800 |
| qk | 36 | {'Q': [1, 32, 800, 128], 'K_shared': [1, 8, 800, 128], 'scores_rectangular': [1, 32, 800, 800]} | 2624716800 | 0 | 8192000/81920000 |
| score_scale_mask_softmax | 36 | {'scores': [1, 32, 800, 800]} | 0 | 0 | 81920000/81920000 |
| pv | 36 | {'P': [1, 32, 800, 800], 'V_shared': [1, 8, 800, 128], 'output': [1, 32, 800, 128]} | 2624716800 | 0 | 83558400/6553600 |
| o_proj | 36 | {'input': [800, 4096], 'weight_math': [4096, 2560], 'weight_storage': [2560, 4096], 'output': [800, 2560]} | 16777216000 | 20971520 | 6553600/4096000 |
| attention_residual | 36 | {'inputs_each': [800, 2560], 'output': [800, 2560]} | 0 | 0 | 8192000/4096000 |
| post_attention_layernorm | 36 | {'input': [800, 2560], 'weight': [2560], 'output': [800, 2560]} | 0 | 5120 | 4096000/4096000 |
| gate_proj | 36 | {'input': [800, 2560], 'weight_math': [2560, 9728], 'weight_storage': [9728, 2560], 'output': [800, 9728]} | 39845888000 | 49807360 | 4096000/15564800 |
| up_proj | 36 | {'input': [800, 2560], 'weight_math': [2560, 9728], 'weight_storage': [9728, 2560], 'output': [800, 9728]} | 39845888000 | 49807360 | 4096000/15564800 |
| silu_mul | 36 | {'gate': [800, 9728], 'up': [800, 9728], 'output': [800, 9728]} | 0 | 0 | 31129600/15564800 |
| down_proj | 36 | {'input': [800, 9728], 'weight_math': [9728, 2560], 'weight_storage': [2560, 9728], 'output': [800, 2560]} | 39845888000 | 49807360 | 15564800/4096000 |
| ffn_residual | 36 | {'inputs_each': [800, 2560], 'output': [800, 2560]} | 0 | 0 | 8192000/4096000 |
| final_norm | 1 | {'input': [800, 2560], 'weight': [2560], 'output': [800, 2560]} | 0 | 5120 | 4096000/4096000 |
...
| image_embedding_replace | 1 | {'prompt': [800, 2560], 'image_embeddings': [400, 2560]} | 0 | 0 | 6144800/4096000 |
| deepstack_prompt_clone | 3 | {'prompt': [800, 2560]} | 0 | 0 | 4096000/4096000 |
| deepstack_visual_add | 3 | {'selected_hidden': [400, 2560], 'deepstack_features': [400, 2560]} | 0 | 0 | 4096000/2048000 |
...
| qk | 36 | {'Q': [1, 32, 1, 128], 'K_shared': [1, 8, 801, 128], 'scores_rectangular': [1, 32, 1, 801]} | 6561792 | 0 | 1648640/102528 |
| score_scale_mask_softmax | 36 | {'scores': [1, 32, 1, 801]} | 0 | 0 | 102528/102528 |
| pv | 36 | {'P': [1, 32, 1, 801], 'V_shared': [1, 8, 801, 128], 'output': [1, 32, 1, 128]} | 6561792 | 0 | 1742976/8192 |
...
| apply_rope | 36 | {'Q': [1, 32, 1, 128], 'K': [1, 8, 1, 128]} | 0 | 0 | 10752/10240 |
| kv_append | 36 | {'new_K_and_V_each': [1, 8, 1, 128]} | 0 | 0 | 4096/4096 |
| qk | 36 | {'Q': [1, 32, 1, 128], 'K_shared': [1, 8, 927, 128], 'scores_rectangular': [1, 32, 1, 927]} | 7593984 | 0 | 1906688/118656 |
| score_scale_mask_softmax | 36 | {'scores': [1, 32, 1, 927]} | 0 | 0 | 118656/118656 |
| pv | 36 | {'P': [1, 32, 1, 927], 'V_shared': [1, 8, 927, 128], 'output': [1, 32, 1, 128]} | 7593984 | 0 | 2017152/8192 |
| o_proj | 36 | {'input': [1, 4096], 'weight_math': [4096, 2560], 'weight_storage': [2560, 4096], 'output': [1, 2560]} | 20971520 | 20971520 | 8192/5120 |
| attention_residual | 36 | {'inputs_each': [1, 2560], 'output': [1, 2560]} | 0 | 0 | 10240/5120 |
| post_attention_layernorm | 36 | {'input': [1, 2560], 'weight': [2560], 'output': [1, 2560]} | 0 | 5120 | 5120/5120 |
| gate_proj | 36 | {'input': [1, 2560], 'weight_math': [2560, 9728], 'weight_storage': [9728, 2560], 'output': [1, 9728]} | 49807360 | 49807360 | 5120/19456 |
