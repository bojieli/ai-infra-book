...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 1 | 194 | 194/125 | 194/125 | True |
| tp4-replicas2 | True | 1 | 270 | 54/25 | 54/25 | True |
| tp2-replicas4 | False | None | None | None | None | False |

选择：`{"required_valid_requests": 1, "eligible": ["tp8-replicas1", "tp4-replicas2"], "minimum_cost_per_valid_request_exact": "194/125", "winners": ["tp8-replicas1"]}`
...
```json
{
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "194/125",
        "missing_terms": [],
        "full_declared_cost_exact": "194/125",
        "cost_per_slo_valid_request_exact": "194/125",
    ...
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "54/25",
        "observed_or_measured": false
      },
      "valid_requests": 1,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "194/125",
    "winners": [
      "tp8-replicas1"
    ]
  },
