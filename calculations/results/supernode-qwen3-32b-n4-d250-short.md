...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 1 | 566 | 566/125 | 566/125 | False |
| tp4-replicas2 | True | 1 | 470 | 94/25 | 94/25 | False |
| tp2-replicas4 | False | None | None | None | None | False |

选择：`{"required_valid_requests": 3, "eligible": [], "minimum_cost_per_valid_request_exact": null, "winners": []}`
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "566/125",
    ...
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "94/25",
        "observed_or_measured": false
      },
      "valid_requests": 1,
      "slo_eligible": false
