...
输入：`{"first_tokens": 128, "full_c_ns": 800000, "full_n_ns": 400000, "joint_window_ns": 500000, "split_c_ns": [480000, 480000], "split_n_ns": [200000, 200000], "tokens": 256}`
...
| matrix_flops | 77,309,411,328 |
| split_matrix_flops | 77,309,411,328 |
| full_weight_read_once_bytes | 301,989,888 |
| split_cold_weight_read_bytes | 603,979,776 |
| split_compute_service_increase_ns | 160,000 |
| full_finish_ns | 1,200,000 |
| split_serial_finish_ns | 1,360,000 |
| ideal_finish_ns | 1,160,000 |
| paired_finish_ns | 1,180,000 |
| joint_window_strict_upper_bound_ns | 520,000 |
| positive_joint_window_can_win | `true` |
| paired_beats_full | `true` |
...
| N1 | N | 680000 | 880000 | C0 |
| C1 | C | 880000 | 1360000 | N1 |
...
| N0 | N | 0 | 200000 | None |
| C0 | C | 200000 | 680000 | N0 |
| N1 | N | 200000 | 400000 | N0 |
| C1 | C | 680000 | 1160000 | C0 |
...
| --- | --- | ---: | ---: | --- |
| N0 | N | 0 | 200000 | None |
| C0_and_N1 | paired-window | 200000 | 700000 | N0 |
| C1 | C | 700000 | 1180000 | C0_and_N1 |
