...
|---|---:|---:|---:|---:|
| 1/reused | 4.61074999e-08 | 1.1921701e-07 | 0.01327896 | 0.0343344989 |
| 1/rotating | 5.07363883e-08 | 1.44072409e-07 | 0.0146120798 | 0.0414928538 |
| 256/reused | 5.09826388e-07 | 9.06916587e-08 | 0.14683 | 0.0261191977 |
| 256/rotating | 5.09784426e-07 | 9.299361e-08 | 0.146817915 | 0.0267821597 |
  ...
  "rows": [
    {
      ...
      "cost_per_call_proxy": {
        "mps": {
          "numerator": 8299349974549841,
          "denominator": 180000000000000000000000
        },
        "cuda": {
          "numerator": 4291812365408987,
          "denominator": 36000000000000000000000
        }
      },
      "joules_per_call_proxy": {
        "mps": {
          "numerator": 8299349974549841,
          "denominator": 625000000000000000
        },
        "cuda": {
          "numerator": 4291812365408987,
    ...
    },
    {
      ...
      "cost_per_call_proxy": {
        "mps": {
          "numerator": 2029455532061143,
          "denominator": 40000000000000000000000
        },
        "cuda": {
          "numerator": 5186606722418219,
          "denominator": 36000000000000000000000
      ...
      "joules_per_call_proxy": {
        "mps": {
          "numerator": 18265099788550287,
          "denominator": 1250000000000000000
        },
        "cuda": {
          "numerator": 5186606722418219,
          "denominator": 125000000000000000
    ...
    },
    {
      ...
      "cost_per_call_proxy": {
        "mps": {
          "numerator": 9176874991680961,
          "denominator": 18000000000000000000000
        },
        "cuda": {
          "numerator": 362766634983321,
          "denominator": 4000000000000000000000
        }
      },
      "joules_per_call_proxy": {
        "mps": {
          "numerator": 9176874991680961,
          "denominator": 62500000000000000
        },
        "cuda": {
          "numerator": 3264899714849889,
          "denominator": 125000000000000000
    ...
    },
    {
      ...
      "cost_per_call_proxy": {
        "mps": {
          "numerator": 1223482623269471,
          "denominator": 2400000000000000000000
        },
        "cuda": {
          "numerator": 1115923320564131,
          "denominator": 12000000000000000000000
        }
      },
      "joules_per_call_proxy": {
        "mps": {
          "numerator": 3670447869808413,
          "denominator": 25000000000000000
        },
        "cuda": {
          "numerator": 3347769961692393,
          "denominator": 125000000000000000
