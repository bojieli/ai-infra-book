...
输入：`{"baseline_packets_per_core_second": null, "cpu_target_utilization": "1", "encapsulation_bytes": 0, "link_bits_per_second": 40000000000, "link_utilization": "1", "packet_mix": null, "pcie": null, "retained_host_work": "1", "wire_overhead_bytes": 20}`
...
| dedicated_cpu_cores | `[6, 3]` |
| complete_virtualization_cpu_cores | `null` |

| 历史/声明每核包率 | 忙核秒/秒 | 留余量后的核当量 | 专用整数核 |
| --- | --- | --- | --- |
| 10000000 | 125/21 | 125/21 | 6 |
| 20000000 | 125/42 | 125/42 | 3 |
