# qwen-rmsnorm-split-reduction — qwen3-8b

输入：`{"rows": 1024, "splits": 8, "width_multiplier": 1}`
...
| --- | ---: |
| width | 4,096 |
| official_hidden_size | 4,096 |
| scalar_flops | 16,778,240 |
| rsqrt_calls | 1,024 |
| first_pass_groups | 8,192 |
| second_pass_groups | 1,024 |
| apply_groups | 8,192 |
| local_reduction_adds | 4,186,112 |
| merge_reduction_adds | 7,168 |
| partial_buffer_bytes | 32,768 |
| inverse_buffer_bytes | 4,096 |
| fused_interface_bytes | 25,165,824 |
| split_interface_bytes | 33,656,832 |
| additional_interface_bytes | 8,491,008 |
| fused_retained_fp32_row_bytes | 16,384 |
| split_max_partition_fp32_bytes | 2,048 |
| predicted_seconds | `null` |

| 策略 | 总组数 | launches | 接口 bytes | 辅助缓冲 bytes |
| --- | ---: | ---: | ---: | ---: |
| one_group_per_row | 1024 | 1 | 25165824 | 0 |
| three_pass_split | 17408 | 3 | 33656832 | 36864 |
