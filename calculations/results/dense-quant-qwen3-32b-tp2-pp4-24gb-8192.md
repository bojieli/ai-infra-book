...
|---:|---:|---:|---|
| 16 | 65,525,600,256 | 49 | True |
| 8 | 34,807,566,336 | 63 | True |
| 4 | 19,204,755,456 | 71 | True |
...
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 8,579,653,632 | 0 | 268,435,456 | 13,272,862,720 | 49 | True | 23,880,474,624 | 24,148,910,080 |
| 8 | 4,678,950,912 | 60,948,480 | 268,435,456 | 17,112,616,960 | 63 | True | 23,798,816,768 | 24,067,252,224 |
| 4 | 2,728,599,552 | 60,948,480 | 268,435,456 | 19,062,968,320 | 71 | True | 23,995,949,056 | 24,264,384,512 |
...
| bits | payload bytes | scale bytes | KV bytes/请求 | KV 可用 bytes | 最大请求 | 权重+workspace 可放入 | 最大请求常驻 bytes | 下一请求 bytes |
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 7,801,741,312 | 0 | 268,435,456 | 14,050,775,040 | 52 | True | 23,907,868,672 | 24,176,304,128 |
| 8 | 3,901,038,592 | 60,948,480 | 268,435,456 | 17,890,529,280 | 66 | True | 23,826,210,816 | 24,094,646,272 |
| 4 | 1,950,687,232 | 60,948,480 | 268,435,456 | 19,840,880,640 | 73 | True | 23,754,907,648 | 24,023,343,104 |
...
| bits | payload bytes | scale bytes | KV bytes/请求 | KV 可用 bytes | 最大请求 | 权重+workspace 可放入 | 最大请求常驻 bytes | 下一请求 bytes |
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 8,579,663,872 | 0 | 268,435,456 | 13,272,852,480 | 49 | True | 23,880,484,864 | 24,148,920,320 |
| 8 | 4,678,961,152 | 60,948,480 | 268,435,456 | 17,112,606,720 | 63 | True | 23,798,827,008 | 24,067,262,464 |
| 4 | 2,728,609,792 | 60,948,480 | 268,435,456 | 19,062,958,080 | 71 | True | 23,995,959,296 | 24,264,394,752 |
