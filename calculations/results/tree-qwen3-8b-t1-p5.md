...
输入：`{"bandwidth_bytes_per_second": 50000000000, "batch": 1, "message_dtype": "BF16", "participants": 5, "root": 0, "segmentation": false, "startup_ns": 2000, "tokens": 1}`
...
| rounds_per_phase | 3 |
| all_reduce_rounds | 6 |
| all_reduce_network_send_bytes | 65,536 |
| all_reduce_global_reduction_adds | 16,384 |
...
| broadcast | 1 | 0 → 2 (8192) |
| broadcast | 2 | 0 → 1 (8192); 2 → 3 (8192) |
