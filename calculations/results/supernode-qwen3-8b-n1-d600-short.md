...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 1 | 132 | 132/125 | 132/125 | True |
| tp4-replicas2 | True | 1 | 170 | 34/25 | 34/25 | True |
| tp2-replicas4 | True | 1 | 230 | 46/25 | 46/25 | True |

选择：`{"required_valid_requests": 1, "eligible": ["tp8-replicas1", "tp4-replicas2", "tp2-replicas4"], "minimum_cost_per_valid_request_exact": "132/125", "winners": ["tp8-replicas1"]}`
...
```json
{
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "132/125",
        "missing_terms": [],
        "full_declared_cost_exact": "132/125",
        "cost_per_slo_valid_request_exact": "132/125",
    ...
    },
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "34/25",
        "missing_terms": [],
        "full_declared_cost_exact": "34/25",
        "cost_per_slo_valid_request_exact": "34/25",
        "observed_or_measured": false
      },
      "valid_requests": 1,
      "slo_eligible": true
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "46/25",
        "observed_or_measured": false
      },
      "valid_requests": 1,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "132/125",
    "winners": [
      "tp8-replicas1"
    ]
  },
