...
输入：`{"accumulator_dtype": "FP32", "batch": 1, "history": 0, "input_dtype": "BF16", "scale_dtype": "E8M0", "sparsity": "dense", "tokens": 33, "weight_dtype": "FP8 E4M3", "world_size": 1}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| valid_matrix_flops | 291,357,327,360 |
| padded_tile_matrix_flops | 565,056,634,880 |
| activation_quantization_scalar_flops | 40,254,192 |
| activation_abs_ops | 39,942,144 |
| activation_max_comparisons | 39,942,144 |
| activation_clamp_comparisons | 79,884,288 |
| activation_round_scale_calls | 312,048 |
| activation_fp8_cast_elements | 39,942,144 |
| activation_e8m0_cast_elements | 312,048 |
| scale_product_flops | 8,891,520 |
| scale_corrected_accumulation_flops | 2,276,229,120 |
| logical_scale_flops | 2,285,120,640 |
| padded_scale_flops | 4,431,749,120 |
| quantization_interface_bytes | 120,138,480 |
| gemm_interface_bytes | 4,598,610,800 |
| total_interface_bytes | 4,718,749,280 |
| resident_weight_bytes | 4,414,504,960 |
| resident_weight_scale_bytes | 269,440 |
| activation_fp8_bytes | 39,942,144 |
| activation_scale_bytes | 312,048 |
| output_bf16_bytes | 143,582,208 |
| linear_invocations | 322 |

| Linear | 调用数 | 权重shape | 有效矩阵FLOPs | tile矩阵FLOPs | scale FLOPs |
| --- | ---: | --- | ---: | ---: | ---: |
| wq_a | 43 | [1024, 4096] | 11903434752 | 23085449216 | 93358848 |
| wq_b | 43 | [32768, 1024] | 95227478016 | 184683593728 | 746870784 |
| wkv_shared | 43 | [512, 4096] | 5951717376 | 11542724608 | 46679424 |
| wo_b | 43 | [4096, 8192] | 95227478016 | 184683593728 | 746870784 |
| index_wq_b | 21 | [8192, 1024] | 11626610688 | 22548578304 | 91187712 |
| shared_gate | 43 | [2048, 4096] | 23806869504 | 46170898432 | 186717696 |
| shared_up | 43 | [2048, 4096] | 23806869504 | 46170898432 | 186717696 |
| shared_down | 43 | [4096, 2048] | 23806869504 | 46170898432 | 186717696 |
