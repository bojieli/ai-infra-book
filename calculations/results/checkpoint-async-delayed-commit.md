...
输入：`{"buffer_slots": 2, "durability_delay_ns": 20000000000, "failure_ns": 50000000000, "first_capture_ns": 20000000000, "interval_ns": 20000000000, "model": "qwen3-8b", "payload_bytes": 112000000000, "snapshots": 2, "staging_ns": 500000000, "upload_bytes_per_second": 8000000000}`
...
| final_durable_exact_seconds | `"149/2"` |
| completed_durable_at_failure | 0 |
| latest_recoverable_snapshot | `null` |
| recovery_capture_exact_seconds | `null` |
| elapsed_since_recovery_capture_exact_seconds | `null` |
...
| ---: | ---: | --- | --- | --- | --- | --- | --- |
| 0 | 0 | 20 | 20 | 41/2 | 41/2 | 69/2 | 109/2 |
| 1 | 1 | 40 | 40 | 81/2 | 81/2 | 109/2 | 149/2 |
