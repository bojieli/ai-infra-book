...
输入：`{"arrival_requests_per_second": "9375/1024", "compressed_image_bytes": 800000, "dtype": "bf16", "encoder_cache_hit_fraction": "3/4", "encoder_images_per_second": "12", "images_per_request": 4, "kv_dtype": "bf16", "network_bytes_per_second": 300000000, "pd_requests_per_second": "4", "preprocessed_height": 640, "preprocessed_width": 640, "text_tokens": 400, "total_workers": 4, "uplink_bits_per_second": 6400000}`
...
| one_request_ec_network_exact_seconds | `"1024/9375"` |
| ec_transfer_bytes_per_request | 32,768,000 |
| uncached_images_per_request_exact | `"1"` |
| best_known_bound_requests_per_second_exact | `"9375/1024"` |
| best_pool_splits | `[{"encoder_workers": 1, "pd_workers": 3}]` |
| arrival_strictly_below_best_known_bound | `false` |
| encoder_cache_service_capacity_known | `false` |

| E workers | PD workers | 编码上界req/s | PD上界req/s | 网络上界req/s | 已知最小界req/s |
| ---: | ---: | --- | --- | --- | --- |
| 1 | 3 | 12 | 12 | 9375/1024 | 9375/1024 |
| 2 | 2 | 24 | 8 | 9375/1024 | 8 |
| 3 | 1 | 36 | 4 | 9375/1024 | 4 |
