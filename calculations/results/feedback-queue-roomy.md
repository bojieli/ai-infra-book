...
输入：`{"after_feedback_ns": 100000, "buffer_bytes": 1048576, "capacity_bytes_per_second": 50000000000, "feedback_ns": 20000, "initial_queue_bytes": 262144, "offered_bytes_per_second": 80000000000, "reduced_bytes_per_second": 40000000000}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| average_offered_bytes_per_second | 46,666,666,666.666664 |
| peak_offered_bytes_per_second | 80,000,000,000 |
| arrived_exact_bytes | `"5600000"` |
| served_exact_bytes | `"5862144"` |
...
| queue_area_exact_byte_ns | `"242037469184/5"` |
| mean_queue_bytes | 403,395.78197333333 |
| compatibility_exact | `"9/10"` |
| compatibility | 0.9 |
| last_drain_exact_ns | `"531072/5"` |
...
| 0.020000 | 0.106214 | 40.000000 | 0.862144 | 0.000000 | 0 |
| 0.106214 | 0.120000 | 40.000000 | 0.000000 | 0.000000 | 0 |
