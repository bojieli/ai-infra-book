...
输入：`{"block_size": 16, "cached_context": 0, "new_context": 1024}`
...
| new_target_feature_bytes | 41,943,040 |
| fused_target_feature_bytes | 8,388,608 |
| noise_embedding_bytes | 131,072 |
| shared_head_weight_bytes | 1,244,659,712 |
| draft_candidates | 15 |
| draft_matrix_flops | 308,601,159,680 |
| target_verify_matrix_flops | 251,923,005,440 |
| draft_kv_bytes_per_context_token | 20,480 |
| draft_kv_peak_bytes | 21,299,200 |
| draft_kv_after_crop_bytes | 20,971,520 |
| draft_noise_kv_discarded_bytes | 327,680 |
| target_verify_peak_kv_bytes | 153,354,240 |

| 算子 | M | K | N | 实例数 | 矩阵FLOPs | 每实例BF16逻辑operand bytes |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| target_feature_fusion | 1024 | 20480 | 4096 | 1 | 171798691840 | 218103808 |
| draft_q | 16 | 4096 | 4096 | 5 | 2684354560 | 33816576 |
| context_and_noise_kv | 1040 | 4096 | 1024 | 10 | 87241523200 | 19038208 |
| draft_o | 16 | 4096 | 4096 | 5 | 2684354560 | 33816576 |
| draft_gate_up | 16 | 4096 | 12288 | 10 | 16106127360 | 101187584 |
| draft_down | 16 | 12288 | 4096 | 5 | 8053063680 | 101187584 |
| noncausal_qk | 16 | 128 | 1040 | 160 | 681574400 | 303616 |
| noncausal_pv | 16 | 1040 | 128 | 160 | 681574400 | 303616 |
| shared_target_head | 15 | 4096 | 151936 | 1 | 18669895680 | 1249340672 |
