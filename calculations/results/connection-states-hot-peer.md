...
| active_peers | 1 |
| coupled_transport_count | 64 |
| shared_transport_count | 1 |
| endpoint_bytes | 16,384 |
| relation_bytes | 4,096 |
| coupled_transport_bytes | 65,536 |
| shared_transport_bytes | 1,024 |
| coupled_total_bytes | 86,016 |
| shared_total_bytes | 21,504 |
| saved_bytes | 64,512 |
| coupled_fits_budget | `true` |
