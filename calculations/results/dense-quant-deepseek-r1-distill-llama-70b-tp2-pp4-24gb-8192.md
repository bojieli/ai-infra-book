...
TP=2 / PP=4 / DP=1；保留长度 8,192 （含最后新 token）；每卡 24,000,000,000 bytes，workspace 条件预算 2,147,483,648 bytes。
...
|---:|---:|---:|---|
| 16 | 141,110,050,816 | 10 | True |
| 8 | 73,728,557,056 | 36 | True |
| 4 | 39,503,036,416 | 48 | True |
...
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 18,164,088,832 | 0 | 335,544,320 | 3,688,427,520 | 10 | True | 23,667,015,680 | 24,002,560,000 |
| 8 | 9,607,708,672 | 133,693,440 | 335,544,320 | 12,111,114,240 | 36 | True | 23,968,481,280 | 24,304,025,600 |
| 4 | 5,329,518,592 | 133,693,440 | 335,544,320 | 16,389,304,320 | 48 | True | 23,716,823,040 | 24,052,367,360 |
...
| bits | payload bytes | scale bytes | KV bytes/请求 | KV 可用 bytes | 最大请求 | 权重+workspace 可放入 | 最大请求常驻 bytes | 下一请求 bytes |
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 17,113,415,680 | 0 | 335,544,320 | 4,739,100,672 | 14 | True | 23,958,519,808 | 24,294,064,128 |
| 8 | 8,557,035,520 | 133,693,440 | 335,544,320 | 13,161,787,392 | 39 | True | 23,924,441,088 | 24,259,985,408 |
| 4 | 4,278,845,440 | 133,693,440 | 335,544,320 | 17,439,977,472 | 51 | True | 23,672,782,848 | 24,008,327,168 |
...
| bits | payload bytes | scale bytes | KV bytes/请求 | KV 可用 bytes | 最大请求 | 权重+workspace 可放入 | 最大请求常驻 bytes | 下一请求 bytes |
|---:|---:|---:|---:|---:|---:|---|---:|---:|
| 16 | 18,164,105,216 | 0 | 335,544,320 | 3,688,411,136 | 10 | True | 23,667,032,064 | 24,002,576,384 |
| 8 | 9,607,725,056 | 133,693,440 | 335,544,320 | 12,111,097,856 | 36 | True | 23,968,497,664 | 24,304,041,984 |
| 4 | 5,329,534,976 | 133,693,440 | 335,544,320 | 16,389,287,936 | 48 | True | 23,716,839,424 | 24,052,383,744 |
