...
输入：`{"bandwidth_bytes_per_second": 1000000000, "encoding": "int32", "header_bytes": 128, "model": "qwen3-30b-a3b", "retained_copies": 1, "token_rate_per_second": 1000000, "tokens": 8192}`
...
| routed_id_bytes | 12,582,912 |
| complete_declared_payload_bytes | 12,780,672 |
| minimum_unsigned_bits_per_id | 7 |
| retained_payload_bytes | 12,780,672 |
| average_declared_bytes_per_token_exact | `"99849/64"` |
| required_transport_bytes_per_second_exact | `"1560140625"` |
| transport_has_strict_slack | `false` |
| one_payload_transfer_exact_seconds | `"99849/7812500"` |

| 声明载荷组成 | bytes |
| --- | ---: |
| routed_ids_bytes | 12582912 |
