...
输入：`{"baseline_server_equivalents": null, "effective_capacity_gain": null, "minutes_per_person_day": "3", "relative_peak_factor": "1", "relative_population": "1/2", "relative_work_per_audio_second": "1"}`
...
| requested_minutes_per_person_day_exact | `"3"` |
| incremental_conventional_capacity_exact | `"1/2"` |
| total_conventional_capacity_exact | `"3/2"` |
...
| --- | --- | --- | --- |
| conventional_reference | 1/2 | 3/2 | None |
| supplied_effective_gain | None | None | None |

逐因子推算：`[{"factor": "usage_minutes", "multiplier_exact": "1", "input_capacity_exact": "1", "output_capacity_exact": "1"}, {"factor": "population", "multiplier_exact": "1/2", "input_capacity_exact": "1", "output_capacity_exact": "1/2"}, {"factor": "work_per_audio_second", "multiplier_exact": "1", "input_capacity_exact": "1/2", "output_capacity_exact": "1/2"}, {"factor": "peak_requirement", "multiplier_exact": "1", "input_capacity_exact": "1/2", "output_capacity_exact": "1/2"}]`；服务器当量只在显式给出教学基准时计算，不是历史实际数量。
