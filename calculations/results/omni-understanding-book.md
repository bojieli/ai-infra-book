...
输入：`{"audio_cache_hits": [false], "dtype": "bf16", "image_cache_hits": [false], "image_grids": [[1, 40, 40]], "mel_lengths": [1000], "output_tokens": 32, "routing": "balanced", "text_tokens": 128, "video_cache_hits": [], "video_grids": []}`
...
| accounted_interface_bytes | 305,338,328,118 |
