...
| selected_policy | `"bucket"` |
| actual_gpu_seconds | `null` |

| 策略 | 准备 ms | 每频数组 ms | 含准备总计 ms | 补齐 FLOPs | 回退调用数 |
| --- | ---: | ---: | ---: | ---: | ---: |
| generic | 100.0 | 17.00807049216 | 1290.5649344512 | 0 | 0 |
| bucket | 400.0 | 12.36950581248 | 1265.8654068736 | 773094113280 | 0 |
| specialized | 900.0 | 6.803228196864 | 1376.22597378048 | 0 | 0 |
