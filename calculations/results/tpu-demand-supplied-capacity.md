...
输入：`{"baseline_server_equivalents": 1000, "effective_capacity_gain": 4, "minutes_per_person_day": "1", "relative_peak_factor": "1", "relative_population": "1", "relative_work_per_audio_second": "1"}`
...
| requested_minutes_per_person_day_exact | `"1"` |
| incremental_conventional_capacity_exact | `"1/3"` |
| total_conventional_capacity_exact | `"4/3"` |
| supplied_effective_capacity_gain_exact | `"4"` |
...
| --- | --- | --- | --- |
| conventional_reference | 1/3 | 4/3 | 334 |
| supplied_effective_gain | 1/12 | 13/12 | 84 |

逐因子推算：`[{"factor": "usage_minutes", "multiplier_exact": "1/3", "input_capacity_exact": "1", "output_capacity_exact": "1/3"}, {"factor": "population", "multiplier_exact": "1", "input_capacity_exact": "1/3", "output_capacity_exact": "1/3"}, {"factor": "work_per_audio_second", "multiplier_exact": "1", "input_capacity_exact": "1/3", "output_capacity_exact": "1/3"}, {"factor": "peak_requirement", "multiplier_exact": "1", "input_capacity_exact": "1/3", "output_capacity_exact": "1/3"}]`；服务器当量只在显式给出教学基准时计算，不是历史实际数量。
