...
输入：`{"bandwidth_bytes_per_second": 50000000000, "batch": 1, "message_dtype": "BF16", "participants": 8, "root": 0, "segmentation": false, "startup_ns": 2000, "tokens": 16}`
...
| maximum_rank_send_bytes | 393,216 |
| maximum_rank_receive_bytes | 393,216 |
| all_reduce_startup_seconds | 1.2e-05 |
| all_reduce_bandwidth_seconds | 1.572864e-05 |
| all_reduce_modeled_seconds | 2.772864e-05 |
| dense_tp_all_reduce_calls | 72 |
| dense_tp_serial_collective_seconds | 0.00199646208 |
| measured_collective_seconds | `null` |

| 阶段 | 轮次 | sender → receiver (bytes) |
| --- | ---: | --- |
| reduce | 0 | 1 → 0 (131072); 3 → 2 (131072); 5 → 4 (131072); 7 → 6 (131072) |
| reduce | 1 | 2 → 0 (131072); 6 → 4 (131072) |
| reduce | 2 | 4 → 0 (131072) |
| broadcast | 0 | 0 → 4 (131072) |
| broadcast | 1 | 0 → 2 (131072); 4 → 6 (131072) |
| broadcast | 2 | 0 → 1 (131072); 2 → 3 (131072); 4 → 5 (131072); 6 → 7 (131072) |

| Rank | 发送 bytes | 接收 bytes | 标量归约加法 |
| --- | ---: | ---: | ---: |
| 0 | 393216 | 393216 | 196608 |
| 1 | 131072 | 131072 | 0 |
| 2 | 262144 | 262144 | 65536 |
| 3 | 131072 | 131072 | 0 |
| 4 | 393216 | 393216 | 131072 |
| 5 | 131072 | 131072 | 0 |
| 6 | 262144 | 262144 | 65536 |
| 7 | 131072 | 131072 | 0 |
