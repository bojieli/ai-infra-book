...
输入：`{"capacity_bytes": null, "events": [{"id": "a", "op": "create", "tokens": 16}, {"id": "b", "op": "fork", "parent": "a"}, {"id": "c", "op": "fork", "parent": "a"}, {"id": "a", "op": "append", "tokens": 1}, {"id": "b", "op": "append", "tokens": 16}, {"id": "c", "op": "cancel"}], "model": "qwen3-8b", "page_tokens": 16, "reservation_tokens": 64}`
...
| rejected_events | 0 |
| peak_allocated_page_bytes | 7,077,888 |
| final_allocated_page_bytes | 7,077,888 |
| final_logical_request_bytes | 7,225,344 |
| final_unique_live_bytes | 4,866,048 |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: |
| 0 | {'op': 'create', 'id': 'a', 'tokens': 16} | True | 2359296 | 2359296 | 2359296 | 0 | 0 |
| 1 | {'op': 'fork', 'parent': 'a', 'id': 'b'} | True | 4718592 | 2359296 | 2359296 | 0 | 0 |
| 2 | {'op': 'fork', 'parent': 'a', 'id': 'c'} | True | 7077888 | 2359296 | 2359296 | 0 | 0 |
| 3 | {'op': 'append', 'id': 'a', 'tokens': 1} | True | 7225344 | 2506752 | 4718592 | 2211840 | 0 |
| 4 | {'op': 'append', 'id': 'b', 'tokens': 16} | True | 9584640 | 4866048 | 7077888 | 2211840 | 0 |
| 5 | {'op': 'cancel', 'id': 'c'} | True | 7225344 | 4866048 | 7077888 | 2211840 | 0 |
