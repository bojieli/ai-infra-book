...
输入：`{"dtype": "bf16", "images": [{"cache_hit": false, "height": 640, "width": 640}, {"cache_hit": false, "height": 640, "width": 640}, {"cache_hit": false, "height": 640, "width": 640}, {"cache_hit": false, "height": 640, "width": 640}], "kv_dtype": "bf16", "output_tokens": 128, "position_segments": [{"kind": "text", "tokens": 100}, {"kind": "image", "preprocessed_height": 640, "preprocessed_width": 640}, {"kind": "text", "tokens": 100}, {"kind": "image", "preprocessed_height": 640, "preprocessed_width": 640}, {"kind": "text", "tokens": 100}, {"kind": "image", "preprocessed_height": 640, "preprocessed_width": 640}, {"kind": "text", "tokens": 100}, {"kind": "image", "preprocessed_height": 640, "preprocessed_width": 640}], "text_tokens": 400}`
...
| vision_matrix_flops | 5,241,202,278,400 |
| language_matrix_flops | 16,890,545,569,792 |
| total_matrix_flops | 22,131,747,848,192 |
| language_scalar_flops | 18,148,708,647 |
| vision_scalar_counts | `{"add": 8697128000, "multiply": 9464649600, "cos": 204800, "sin": 204800, "rsqrt": 318400, "negate": 157286400, "comparison": 3929702400, "subtract": 3932160000, "exp": 3932160000, "divide": 3932160000, "tanh": 629145600, "erf": 26214400}` |
...
| --- | --- | --- | --- | --- | --- | --- |
| 0 | False | [1, 40, 40] | 1600 | 400 | 1310300569600 | 8192000 |
| 1 | False | [1, 40, 40] | 1600 | 400 | 1310300569600 | 8192000 |
| 2 | False | [1, 40, 40] | 1600 | 400 | 1310300569600 | 8192000 |
| 3 | False | [1, 40, 40] | 1600 | 400 | 1310300569600 | 8192000 |

逐图视觉矩阵：本次工作已乘该图是否未命中；copies仍表示模型内部重复。

| 图片 | 算子 | A | B | copies | 本次矩阵FLOPs |
| --- | --- | --- | --- | --- | --- |
| 0 | patch_embedding | [1600, 1536] | [1536, 1024] | 1 | 5033164800 |
| 0 | block.qkv | [1600, 1024] | [1024, 3072] | 24 | 241591910400 |
| 0 | block.qk | [1600, 64] | [64, 1600] | 384 | 125829120000 |
| 0 | block.pv | [1600, 1600] | [1600, 64] | 384 | 125829120000 |
| 0 | block.attention_output | [1600, 1024] | [1024, 1024] | 24 | 80530636800 |
| 0 | block.mlp_up | [1600, 1024] | [1024, 4096] | 24 | 322122547200 |
| 0 | block.mlp_down | [1600, 4096] | [4096, 1024] | 24 | 322122547200 |
| 0 | merger_final.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 0 | merger_final.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 0 | merger_deepstack_5.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 0 | merger_deepstack_5.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 0 | merger_deepstack_11.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 0 | merger_deepstack_11.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 0 | merger_deepstack_17.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 0 | merger_deepstack_17.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 1 | patch_embedding | [1600, 1536] | [1536, 1024] | 1 | 5033164800 |
| 1 | block.qkv | [1600, 1024] | [1024, 3072] | 24 | 241591910400 |
| 1 | block.qk | [1600, 64] | [64, 1600] | 384 | 125829120000 |
| 1 | block.pv | [1600, 1600] | [1600, 64] | 384 | 125829120000 |
| 1 | block.attention_output | [1600, 1024] | [1024, 1024] | 24 | 80530636800 |
| 1 | block.mlp_up | [1600, 1024] | [1024, 4096] | 24 | 322122547200 |
| 1 | block.mlp_down | [1600, 4096] | [4096, 1024] | 24 | 322122547200 |
| 1 | merger_final.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 1 | merger_final.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 1 | merger_deepstack_5.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 1 | merger_deepstack_5.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 1 | merger_deepstack_11.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 1 | merger_deepstack_11.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 1 | merger_deepstack_17.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 1 | merger_deepstack_17.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 2 | patch_embedding | [1600, 1536] | [1536, 1024] | 1 | 5033164800 |
| 2 | block.qkv | [1600, 1024] | [1024, 3072] | 24 | 241591910400 |
| 2 | block.qk | [1600, 64] | [64, 1600] | 384 | 125829120000 |
| 2 | block.pv | [1600, 1600] | [1600, 64] | 384 | 125829120000 |
| 2 | block.attention_output | [1600, 1024] | [1024, 1024] | 24 | 80530636800 |
| 2 | block.mlp_up | [1600, 1024] | [1024, 4096] | 24 | 322122547200 |
| 2 | block.mlp_down | [1600, 4096] | [4096, 1024] | 24 | 322122547200 |
| 2 | merger_final.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 2 | merger_final.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 2 | merger_deepstack_5.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 2 | merger_deepstack_5.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 2 | merger_deepstack_11.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 2 | merger_deepstack_11.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 2 | merger_deepstack_17.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 2 | merger_deepstack_17.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 3 | patch_embedding | [1600, 1536] | [1536, 1024] | 1 | 5033164800 |
| 3 | block.qkv | [1600, 1024] | [1024, 3072] | 24 | 241591910400 |
| 3 | block.qk | [1600, 64] | [64, 1600] | 384 | 125829120000 |
| 3 | block.pv | [1600, 1600] | [1600, 64] | 384 | 125829120000 |
| 3 | block.attention_output | [1600, 1024] | [1024, 1024] | 24 | 80530636800 |
| 3 | block.mlp_up | [1600, 1024] | [1024, 4096] | 24 | 322122547200 |
| 3 | block.mlp_down | [1600, 4096] | [4096, 1024] | 24 | 322122547200 |
| 3 | merger_final.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 3 | merger_final.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 3 | merger_deepstack_5.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 3 | merger_deepstack_5.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 3 | merger_deepstack_11.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 3 | merger_deepstack_11.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
| 3 | merger_deepstack_17.up | [400, 4096] | [4096, 4096] | 1 | 13421772800 |
| 3 | merger_deepstack_17.out | [400, 4096] | [4096, 2560] | 1 | 8388608000 |
...
| 指标 | 值 |
| --- | --- |
| prompt_positions | `2000` |
| image_positions | `1600` |
| next_rotary_position | `480` |
| rope_delta | `-1520` |
| decode_rotary_positions | `[480, 481, 482, 483, 484, 485, 486, 487, 488, 489, 490, 491, 492, 493, 494, 495, 496, 497, 498, 499, 500, 501, 502, 503, 504, 505, 506, 507, 508, 509, 510, 511, 512, 513, 514, 515, 516, 517, 518, 519, 520, 521, 522, 523, 524, 525, 526, 527, 528, 529, 530, 531, 532, 533, 534, 535, 536, 537, 538, 539, 540, 541, 542, 543, 544, 545, 546, 547, 548, 549, 550, 551, 552, 553, 554, 555, 556, 557, 558, 559, 560, 561, 562, 563, 564, 565, 566, 567, 568, 569, 570, 571, 572, 573, 574, 575, 576, 577, 578, 579, 580, 581, 582, 583, 584, 585, 586, 587, 588, 589, 590, 591, 592, 593, 594, 595, 596, 597, 598, 599, 600, 601, 602, 603, 604, 605, 606]` |
| final_kv_positions | `2127` |
| position_ids_bytes | `48000` |
| rope_delta_bytes | `8` |
| rope_delta_cached | `true` |

| 源码步骤 | 声明工作与接口 |
| --- | --- |
| text_arange_expand_add | `{"integer_additions": 300, "materialized_output_bytes": 2400, "arange_output_bytes": 800}` |
| image_arange_meshgrid_stack_offset | `{"integer_additions": 440, "integer_multiplications": 1, "materialized_output_bytes": 9600, "arange_output_bytes": 328, "grid_offset_output_bytes": 328, "temporal_inplace_read_write_bytes": 6400, "note": "meshgrid/reshape are views; stack materializes; scalar grid/control operations excluded"}` |
| text_arange_expand_add | `{"integer_additions": 300, "materialized_output_bytes": 2400, "arange_output_bytes": 800}` |
| image_arange_meshgrid_stack_offset | `{"integer_additions": 440, "integer_multiplications": 1, "materialized_output_bytes": 9600, "arange_output_bytes": 328, "grid_offset_output_bytes": 328, "temporal_inplace_read_write_bytes": 6400, "note": "meshgrid/reshape are views; stack materializes; scalar grid/control operations excluded"}` |
| text_arange_expand_add | `{"integer_additions": 300, "materialized_output_bytes": 2400, "arange_output_bytes": 800}` |
| image_arange_meshgrid_stack_offset | `{"integer_additions": 440, "integer_multiplications": 1, "materialized_output_bytes": 9600, "arange_output_bytes": 328, "grid_offset_output_bytes": 328, "temporal_inplace_read_write_bytes": 6400, "note": "meshgrid/reshape are views; stack materializes; scalar grid/control operations excluded"}` |
| text_arange_expand_add | `{"integer_additions": 300, "materialized_output_bytes": 2400, "arange_output_bytes": 800}` |
| image_arange_meshgrid_stack_offset | `{"integer_additions": 440, "integer_multiplications": 1, "materialized_output_bytes": 9600, "arange_output_bytes": 328, "grid_offset_output_bytes": 328, "temporal_inplace_read_write_bytes": 6400, "note": "meshgrid/reshape are views; stack materializes; scalar grid/control operations excluded"}` |
| position_ids_zero_init | `{"materialized_output_bytes": 48000}` |
| segment_cat | `{"operand_read_bytes": 48000, "materialized_output_bytes": 48000}` |
| position_ids_assign | `{"operand_read_bytes": 48000, "materialized_output_bytes": 48000}` |
| position_max_and_delta | `{"reduction_input_elements": 6000, "logical_reduction_comparisons": 5999, "integer_additions": 1, "integer_subtractions": 1, "materialized_output_bytes": 8, "note": "logical comparisons, not a backend reduction instruction count"}` |
| direct_model_decode_position_add | `{"integer_additions": 381, "materialized_output_bytes": 3048, "note": "explicit no-mask direct-model path; generation wrapper preparation separate"}` |
| direct_model_decode_arange | `{"executions": 127, "materialized_output_bytes": 1016, "note": "One int64 arange element per decode call; internal arange algorithm unspecified."}` |
| direct_model_decode_delta_repeat_interleave | `{"executions": 127, "operand_read_bytes": 1016, "materialized_output_bytes": 1016, "note": "Batch1 repeat_interleave(1) materializes the saved int64 delta before broadcast addition."}` |
