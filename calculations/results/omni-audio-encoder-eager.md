...
输入：`{"attention_path": "source_unmasked_eager", "element_bytes": 2, "mel_lengths": [801]}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| matrix_flops | 174,994,022,400 |
| scalar_flops | 155,302,185 |
| parameter_elements | 647,927,168 |
| weight_interface_bytes | 1,295,854,336 |
| activation_read_bytes | 295,880,053 |
| activation_write_bytes | 261,696,000 |
...
| qk | attention | {'heads': 20, 'head_dim': 64, 'positions': 105, 'accounted_pairs': 11025} | 32 | 28224000 | 0 | {} |
| scale_softmax | attention | {'heads': 20, 'pairs': 11025} | 32 | 0 | 879900 | {'exp': 220500, 'max_compare': 218400} |
| pv | attention | {'heads': 20, 'head_dim': 64, 'positions': 105, 'accounted_pairs': 11025} | 32 | 28224000 | 0 | {} |
