...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 4 | 566 | 566/125 | 283/250 | True |
| tp4-replicas2 | True | 4 | 470 | 94/25 | 47/50 | True |
| tp2-replicas4 | False | None | None | None | None | False |

选择：`{"required_valid_requests": 3, "eligible": ["tp8-replicas1", "tp4-replicas2"], "minimum_cost_per_valid_request_exact": "47/50", "winners": ["tp4-replicas2"]}`

| 部署 | 请求 | 副本 | 完成ms | 尝试次数 |
|---|---:|---:|---:|---:|
| tp8-replicas1 | 0 | 0 | 194 | 2 |
| tp8-replicas1 | 1 | 0 | 318 | 1 |
| tp8-replicas1 | 2 | 0 | 442 | 1 |
| tp8-replicas1 | 3 | 0 | 566 | 1 |
| tp4-replicas2 | 0 | 0 | 270 | 2 |
| tp4-replicas2 | 1 | 1 | 200 | 1 |
| tp4-replicas2 | 2 | 0 | 470 | 1 |
...
```json
{
  ...
  "candidates": [
    {
      ...
      "schedule": {
        ...
        "attempts": [
          {
            ...
            "completed_stage_matrix_flops": 16047822077952
          },
          {
            "request": 0,
            "replica": 0,
        ...
        "horizon_ms": 566,
        "fault_used": true,
        "abandoned_completed_stage_matrix_flops": 16047822077952,
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "283/250",
    ...
    },
    {
        ...
        "attempts": [
          {
            ...
            "completed_stage_matrix_flops": 0
          },
          {
            "request": 0,
            "replica": 0,
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "47/50",
        "observed_or_measured": false
      },
      "valid_requests": 4,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "47/50",
    "winners": [
      "tp4-replicas2"
    ]
  },
