...
| matrix_flops | 59855667392 |
| scalar_flops | 3283938543 |
| reference_integer_operations | 498125 |
| full_forward_exact | False |

特殊数学 primitive：`{"cos": 96, "exp": 12386400, "max_comparisons": 30660, "rsqrt": 9271, "sigmoid": 1723260, "sin": 96, "softplus": 2880, "topk_selections": 60}`。
...
```json
{
  ...
  "conv": {
    "input_positions": 1,
    "conv_output_positions_before_slice": 4,
  ...
  "state": {
    ...
    "record_past_retained_conv_bytes": 1105920
  }
}
```
...
| reference_supplement | 16588992 | 200925792 |
| rotary | 0 | 97920 |
| router | 0 | 93240 |
| routing | 0 | 4915200 |
| softmax | 0 | 1440 |
...
| --- | ---: | ---: | ---: |
| conv.additional_padded_and_discarded_products | 45 | 24576 | 98304 |
| conv.extra_silu_before_final_crop | 45 | 24576 | 24576 |
| conv.cache_concat_or_initial_pad | 45 | 0 | 0 |
| conv.record_past_assign_alias | 45 | 0 | 0 |
