...
完成时间：5118；首次向量开工：1536；声明交接容量：98304 bytes（通过：True）。

跨单元载荷：98304 bytes；所选路径服务字节：196608。

| 任务 | 资源 | 开始 | 结束 | 服务时间 |
|---|---|---:|---:|---:|
| g0.qk | matrix | 0 | 512 | 512 |
| g0.scores | handoff | 512 | 1536 | 1024 |
| g0.softmax | vector | 1536 | 4094 | 2558 |
| g0.probabilities | handoff | 4094 | 4606 | 512 |
| g0.pv | matrix | 4606 | 5118 | 512 |
...
```json
{
  ...
  "work": [
    {
      ...
      "qk_flops": 4194304,
      "pv_flops": 4194304,
      "basic_scalar_ops": 49024,
      "maximum_comparisons": 16256,
      "exponential_ops": 16384,
      "division_ops": 16384,
      "masked_score_elements": 8128,
      "score_handoff_bytes": 65536,
      "probability_handoff_bytes": 32768,
  ...
  "summary": {
    "groups": 1,
    "fp32_score_bytes_per_slot": 65536,
    "bf16_probability_bytes_per_slot": 32768,
    ...
    "served_handoff_bytes": 196608,
    "finish_tick": 5118,
    "capacity_qualified_finish_tick": 5118,
    "first_vector_start_tick": 1536,
