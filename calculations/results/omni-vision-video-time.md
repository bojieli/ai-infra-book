...
输入：`{"cache_hits": [false], "dtype": "bf16", "grid_thw": [[4, 20, 30]], "seconds_per_grid": ["1/2"]}`
...
| executed_patches | 2,400 |
| executed_merged_positions | 600 |
| delivered_visual_positions | 600 |
| executed_bidirectional_pairs | 1,440,000 |
| matrix_flops | 2,308,010,803,200 |
| scalar_flops | 7,161,043,140 |
| logical_vision_parameters | 538,631,408 |
| parameter_bytes_declared_dtype | 1,077,262,816 |
| complete_encoder_feature_bytes | 9,830,400 |
| feature_components | 4 |
| component_width | 2,048 |
| interface_read_bytes | 9,159,306,592 |
| interface_write_bytes | 7,131,419,760 |
...
| --- | --- | --- | --- | --- | --- |
| patch_embedding | [2400, 1536] | [1536, 1152] | 1 | 8493465600 | 10911744/5529600 |
| block_qkv | [2400, 1152] | [1152, 3456] | 27 | 515978035200 | 364290048/447897600 |
| item_0_qk | [600, 72] | [72, 600] | 1728 | 89579520000 | 298598400/1244160000 |
| item_0_pv | [600, 600] | [600, 72] | 1728 | 89579520000 | 1393459200/149299200 |
| block_attention_output | [2400, 1152] | [1152, 1152] | 27 | 171992678400 | 220962816/149299200 |
| block_mlp_up | [2400, 1152] | [1152, 4304] | 27 | 642583756800 | 417042432/557798400 |
| block_mlp_down | [2400, 4304] | [4304, 1152] | 27 | 642583756800 | 825541632/149299200 |
| final_up | [600, 4608] | [4608, 4608] | 1 | 25480396800 | 47996928/5529600 |
| final_out | [600, 4608] | [4608, 2048] | 1 | 11324620800 | 24403968/2457600 |
| deepstack_8_up | [600, 4608] | [4608, 4608] | 1 | 25480396800 | 47996928/5529600 |
| deepstack_8_out | [600, 4608] | [4608, 2048] | 1 | 11324620800 | 24403968/2457600 |
| deepstack_16_up | [600, 4608] | [4608, 4608] | 1 | 25480396800 | 47996928/5529600 |
| deepstack_16_out | [600, 4608] | [4608, 2048] | 1 | 11324620800 | 24403968/2457600 |
| deepstack_24_up | [600, 4608] | [4608, 4608] | 1 | 25480396800 | 47996928/5529600 |
| deepstack_24_out | [600, 4608] | [4608, 2048] | 1 | 11324620800 | 24403968/2457600 |

| 非矩阵步骤 | 元素数 | repeats | 已汇总标量工作 | 已汇总特殊函数 |
| --- | --- | --- | --- | --- |
| patch_embedding_bias | 2764800 | 1 | 2764800 | {} |
| position_interpolate | 691200 | 1 | 4838400 | {} |
| position_temporal_repeat_layout | 2764800 | 1 | 0 | {} |
| position_add | 2764800 | 1 | 2764800 | {} |
| rope_frequency_outer | 540 | 1 | 540 | {} |
| rope_gather_duplicate_trig | 172800 | 1 | 0 | {'cos': 172800, 'sin': 172800} |
| block_norm1 | 2764800 | 27 | 522612000 | {'rsqrt': 64800} |
| block_qkv_bias | 8294400 | 27 | 223948800 | {} |
| block_rope_qk | 5529600 | 27 | 447897600 | {'sign_negation': 74649600} |
| item_0_scale_softmax | 360000 | 1728 | 2487283200 | {'exp': 622080000, 'max_compare': 621043200} |
| block_attention_output_bias | 2764800 | 27 | 74649600 | {} |
| block_residual1 | 2764800 | 27 | 74649600 | {} |
| block_norm2 | 2764800 | 27 | 522612000 | {'rsqrt': 64800} |
| block_mlp_up_bias | 10329600 | 27 | 278899200 | {} |
| block_gelu_tanh | 10329600 | 27 | 2231193600 | {'tanh': 278899200} |
| block_mlp_down_bias | 2764800 | 27 | 74649600 | {} |
| block_residual2 | 2764800 | 27 | 74649600 | {} |
| final_norm | 2764800 | 1 | 19356000 | {'rsqrt': 2400} |
| final_up_bias | 2764800 | 1 | 2764800 | {} |
| final_gelu_erf | 2764800 | 1 | 11059200 | {'erf': 2764800} |
| final_out_bias | 1228800 | 1 | 1228800 | {} |
| deepstack_8_norm | 2764800 | 1 | 19354200 | {'rsqrt': 600} |
| deepstack_8_up_bias | 2764800 | 1 | 2764800 | {} |
| deepstack_8_gelu_erf | 2764800 | 1 | 11059200 | {'erf': 2764800} |
| deepstack_8_out_bias | 1228800 | 1 | 1228800 | {} |
| deepstack_16_norm | 2764800 | 1 | 19354200 | {'rsqrt': 600} |
| deepstack_16_up_bias | 2764800 | 1 | 2764800 | {} |
| deepstack_16_gelu_erf | 2764800 | 1 | 11059200 | {'erf': 2764800} |
| deepstack_16_out_bias | 1228800 | 1 | 1228800 | {} |
| deepstack_24_norm | 2764800 | 1 | 19354200 | {'rsqrt': 600} |
| deepstack_24_up_bias | 2764800 | 1 | 2764800 | {} |
| deepstack_24_gelu_erf | 2764800 | 1 | 11059200 | {'erf': 2764800} |
| deepstack_24_out_bias | 1228800 | 1 | 1228800 | {} |

逐项grid/时间/命中：`[{"index": 0, "grid_thw": [4, 20, 30], "cache_hit": false, "premerge_patches": 2400, "merged_positions": 600, "attention_pairs_executed": 1440000, "feature_components": 4, "feature_bytes": 9830400, "temporal_position_ids": [0, 6, 13, 19], "temporal_position_note": "Thinker time scale times explicit seconds; does not change vision attention or patch count."}]`

独立Thinker注入接口：`{"visual_encoder_layers": [8, 16, 24], "thinker_destination_layers": [0, 1, 2], "injected_feature_bytes": 7372800, "injection_adds": 3686400, "injection_gather_clone_add_scatter_interface_bytes": 66355200, "note": "Separate consumer-side source gather→clone→add→scatter: 9 operand transfers per element; excluded from encoder totals. Final features fill the original visual positions; DeepStack does not multiply their count."}`
