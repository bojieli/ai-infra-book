...
输入：`{"dispatch_ns": 0, "extra_setup_ns": 600000000000, "repetitions": 1, "shapes": [{"baseline_ns": 100000, "candidates": {"A": {"ns": 10000, "valid": true}, "B": {"ns": 50000, "valid": true}}, "count": 9, "name": "x"}, {"baseline_ns": 100000, "candidates": {"A": {"ns": 200000, "valid": true}, "B": {"ns": 50000, "valid": true}}, "count": 1, "name": "y"}]}`
...
| cohort_calls | 10 |
| best_uniform | `"A"` |
| best_uniform_cohort_ns | 290,000 |
| mixed_cohort_ns | 140,000 |
| mixed_mean_ns | 14,000.0 |
| mixed_saving_per_call_exact_ns | `"15000"` |
| mixed_lifetime_total_ns | 600,000,140,000 |
| uniform_lifetime_total_ns | 290,000 |
| break_even_calls | 40,000,000 |
| strictly_faster_calls | 40,000,001 |
| whole_cohort_thresholds | `{"break_even_calls": 4000000, "strictly_faster_calls": 4000001}` |
