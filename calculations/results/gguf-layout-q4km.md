...
| file_bytes | 142,154,075,488 |
| tensor_payload_bytes | 142,148,069,376 |
| code_or_float_bytes | 127,162,824,704 |
| quantization_scale_metadata_bytes | 14,985,244,672 |
| file_header_and_padding_bytes | 6,006,112 |
| payload_bits_per_parameter_exact | `"2221063584/459167255"` |
| file_bits_per_parameter_exact | `"4442314859/918334510"` |
| storage_types | `["F32", "Q4_K", "Q6_K"]` |

| 实际类型 | 张量数 | 元素数 | 块元素／bytes | 码值或浮点bytes | 块尺度元数据bytes | 总载荷bytes |
| --- | ---: | ---: | --- | ---: | ---: | ---: |
| Q6_K | 93 | 37762891776 | 256/210 | 28322168832 | 2655203328 | 30977372160 |
| F32 | 471 | 50081280 | 1/4 | 200325120 | 0 | 200325120 |
| Q4_K | 567 | 197280661504 | 256/144 | 98640330752 | 12330041344 | 110970372096 |

| 分片 | 文件bytes | header bytes | header对齐bytes | 张量载荷bytes | 张量padding bytes |
| --- | ---: | ---: | ---: | ---: | ---: |
| Q4_K_M/Qwen3-235B-A22B-Q4_K_M-00001-of-00003.gguf | 49944699648 | 5959419 | 5 | 49938740224 | 0 |
| Q4_K_M/Qwen3-235B-A22B-Q4_K_M-00002-of-00003.gguf | 49930349824 | 25844 | 12 | 49930323968 | 0 |
| Q4_K_M/Qwen3-235B-A22B-Q4_K_M-00003-of-00003.gguf | 42279026016 | 20813 | 19 | 42279005184 | 0 |
