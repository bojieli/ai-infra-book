...
输入：`{"capacity_bytes": 7077888, "events": [{"id": "a", "op": "create", "tokens": 17}, {"id": "b", "op": "fork", "parent": "a"}, {"id": "c", "op": "fork", "parent": "a"}, {"id": "a", "op": "append", "tokens": 1}, {"id": "b", "op": "append", "tokens": 16}, {"id": "c", "op": "cancel"}], "model": "qwen3-8b", "page_tokens": 16, "reservation_tokens": 64}`
...
| 4 | {'op': 'append', 'id': 'b', 'tokens': 16} | False | 7667712 | 2801664 | 7077888 | 4276224 | 0 |
| 5 | {'op': 'cancel', 'id': 'c'} | True | 5160960 | 2801664 | 7077888 | 4276224 | 0 |
