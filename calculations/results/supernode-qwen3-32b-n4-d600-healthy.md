...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 4 | 496 | 496/125 | 124/125 | True |
| tp4-replicas2 | True | 4 | 400 | 16/5 | 4/5 | True |
| tp2-replicas4 | False | None | None | None | None | False |

选择：`{"required_valid_requests": 3, "eligible": ["tp8-replicas1", "tp4-replicas2"], "minimum_cost_per_valid_request_exact": "4/5", "winners": ["tp4-replicas2"]}`
...
```json
{
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "4/5",
    "winners": [
      "tp4-replicas2"
    ]
  },
