...
输入：`{"arrival_requests_per_second": "0", "compressed_image_bytes": 800000, "dtype": "bf16", "encoder_cache_hit_fraction": "0", "encoder_images_per_second": "12", "images_per_request": 1, "kv_dtype": "bf16", "network_bytes_per_second": 300000000, "pd_requests_per_second": "4", "preprocessed_height": 640, "preprocessed_width": 640, "text_tokens": 0, "total_workers": 4, "uplink_bits_per_second": 6400000}`
...
| final_embedding_bytes_per_image | 2,048,000 |
| deepstack_bytes_per_image | 6,144,000 |
| complete_encoder_bytes_per_image | 8,192,000 |
| complete_encoder_bytes_per_request | 8,192,000 |
| visual_positions_per_request | 400 |
| declared_input_positions | 400 |
| kv_bytes_per_position | 147,456 |
| visual_kv_bytes_per_image | 58,982,400 |
| visual_kv_bytes_per_request | 58,982,400 |
| text_kv_bytes_per_request | 0 |
| declared_input_kv_bytes | 58,982,400 |
| compressed_image_uplink_exact_seconds | `"1"` |
| complete_encoder_uplink_exact_seconds | `"256/25"` |
| encoder_to_compressed_bytes_ratio_exact | `"256/25"` |
| one_image_ec_network_exact_seconds | `"256/9375"` |
| one_request_ec_network_exact_seconds | `"256/9375"` |
| ec_transfer_bytes_per_request | 8,192,000 |
| uncached_images_per_request_exact | `"1"` |
| best_known_bound_requests_per_second_exact | `"12"` |
| best_pool_splits | `[{"encoder_workers": 1, "pd_workers": 3}]` |
