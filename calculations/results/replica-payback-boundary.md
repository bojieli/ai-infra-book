...
| baseline_window_ns_exact | `"3107192832/125"` |
| replicated_window_ns_exact | `"3073376728/125"` |
| window_saving_ns_exact | `"33816104/125"` |
| selected_deployment | `"replicated"` |
| selected_window_ns_exact | `"3073376728/125"` |
