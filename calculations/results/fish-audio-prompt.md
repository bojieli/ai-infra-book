...
输入：`{"audio_history": 32, "batch": 1, "fish_prompt_tokens": 16, "frames": 12, "kv_element_bytes": 2, "operand_element_bytes": 2, "text_history": 128, "text_tokens": 16}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| accounted_transformer_and_bridge_matrix_flops | 305,950,752,768 |
| full_model_parameters | `null` |
| full_generation_flops | `null` |
| full_codec_flops | `null` |
| predicted_latency_seconds | `null` |

音频阶段供给：`{"effective_rates": {"matrix": null, "interface": null, "scalar": null}, "accounted_work_totals": {"matrix_flops": 387123953664, "accounted_interface_bytes": 197952430220, "accounted_scalar_flops": 517899696}, "accounted_serial_critical_path_lower_bound_seconds_exact": null, "full_request_latency_seconds": null, "first_audio_latency_seconds": null, "prompt_scope": "Fish optional already-tokenized text-only prompt included; text/audio tokenizer and reference-audio encoder excluded.", "duration_basis_seconds_exact": "2048/3675", "required_matrix_flops_per_second_exact": "694668227400", "required_accounted_interface_bytes_per_second_exact": "181868795264625/512", "required_accounted_scalar_flops_per_second_exact": "118955086425/128", "interpretation": "Necessary average aggregate supply to emit this batch within one request audio duration; not sufficient for latency. Node max(F/P,bytes/BW,scalar/S) uses only supplied rates and declared interfaces, permits within-node overlap, and excludes special-op/launch costs. Sum follows strict node dependencies."}`
...
| --- | ---: | ---: | ---: | ---: | ---: |
| q | 27 | 2560 | 4096 | 36 | 20384317440 |
| k | 27 | 2560 | 1024 | 36 | 5096079360 |
| v | 27 | 2560 | 1024 | 36 | 5096079360 |
| o | 27 | 4096 | 2560 | 36 | 20384317440 |
| ffn_gate | 27 | 2560 | 9728 | 36 | 48412753920 |
| ffn_up | 27 | 2560 | 9728 | 36 | 48412753920 |
| ffn_down | 27 | 9728 | 2560 | 36 | 48412753920 |
| output_head | 12 | 2560 | 155776 | 1 | 9570877440 |

本阶段QK/PV与KV：`{"projection_and_ffn_matrix_flops": 205769932800, "qk_matrix_flops": 366280704, "pv_matrix_flops": 366280704, "matrix_flops": 206502494208, "matrix_weight_elements": 4032102400, "kv_bytes_per_position_per_request": 147456, "kv_retained_logical_bytes": 8699904, "processed_rows": 27, "valid_attention_pairs_all_invocations": 1242, "invocations": 12, "accounted_scalar_flops": 84486660, "special_ops": {"rsqrt": 40836, "rope_sign_negation": 2488320, "attention_exp": 1430784, "attention_max_compare": 1399680, "sigmoid": 9455616}, "matrix_weight_interface_bytes": 96770457600, "matrix_activation_read_bytes": 51818496, "matrix_activation_write_bytes": 63458304, "attention_logical_interface_bytes": 204788736, "accounted_nonmatrix_interface_bytes": 195185664, "accounted_interface_bytes": 97285708800}`
