...
输入：`{"bandwidth_bytes_per_second": 25769803776, "batch": 1, "buffer_slots": 1, "history": 0, "kv_length": 8192, "layer_compute_ns": 1000000, "model": "qwen3-8b", "offloaded_layers": [3, 7, 11, 15, 19, 23, 27, 31, 35], "passes": 1, "tokens": 2048}`
...
| copy_service_per_input_token_ns_exact | `"52734375/1024"` |
| copy_only_decode_throughput_upper_tokens_per_s | `null` |
| baseline_compute_ns | 36,000,000 |
| scheduled_finish_ns_exact | `"114468750"` |
| exposed_wait_ns_exact | `"78468750"` |
| selected_ffn_matrix_flops_per_forward | 5,566,277,615,616 |
| target_matrix_flops_per_forward | 29,688,662,589,440 |
