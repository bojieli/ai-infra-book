...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 8 | 496 | 496/125 | 62/125 | True |
| tp4-replicas2 | True | 8 | 400 | 16/5 | 2/5 | True |
| tp2-replicas4 | True | 8 | 320 | 64/25 | 8/25 | True |

选择：`{"required_valid_requests": 6, "eligible": ["tp8-replicas1", "tp4-replicas2", "tp2-replicas4"], "minimum_cost_per_valid_request_exact": "8/25", "winners": ["tp2-replicas4"]}`

| 部署 | 请求 | 副本 | 完成ms | 尝试次数 |
|---|---:|---:|---:|---:|
| tp8-replicas1 | 0 | 0 | 62 | 1 |
| tp8-replicas1 | 1 | 0 | 124 | 1 |
| tp8-replicas1 | 2 | 0 | 186 | 1 |
| tp8-replicas1 | 3 | 0 | 248 | 1 |
| tp8-replicas1 | 4 | 0 | 310 | 1 |
| tp8-replicas1 | 5 | 0 | 372 | 1 |
| tp8-replicas1 | 6 | 0 | 434 | 1 |
| tp8-replicas1 | 7 | 0 | 496 | 1 |
| tp4-replicas2 | 0 | 0 | 100 | 1 |
| tp4-replicas2 | 1 | 1 | 100 | 1 |
| tp4-replicas2 | 2 | 0 | 200 | 1 |
| tp4-replicas2 | 3 | 1 | 200 | 1 |
| tp4-replicas2 | 4 | 0 | 300 | 1 |
| tp4-replicas2 | 5 | 1 | 300 | 1 |
| tp4-replicas2 | 6 | 0 | 400 | 1 |
| tp4-replicas2 | 7 | 1 | 400 | 1 |
| tp2-replicas4 | 0 | 0 | 160 | 1 |
| tp2-replicas4 | 1 | 1 | 160 | 1 |
| tp2-replicas4 | 2 | 2 | 160 | 1 |
| tp2-replicas4 | 3 | 3 | 160 | 1 |
| tp2-replicas4 | 4 | 0 | 320 | 1 |
...
```json
{
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "496/125",
        "missing_terms": [],
        "full_declared_cost_exact": "496/125",
    ...
    },
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "16/5",
        "missing_terms": [],
        "full_declared_cost_exact": "16/5",
        "cost_per_slo_valid_request_exact": "2/5",
        "observed_or_measured": false
      },
      "valid_requests": 8,
      "slo_eligible": true
    },
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "64/25",
        "missing_terms": [],
        "full_declared_cost_exact": "64/25",
        "cost_per_slo_valid_request_exact": "8/25",
        "observed_or_measured": false
      },
      "valid_requests": 8,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "8/25",
    "winners": [
      "tp2-replicas4"
    ]
  },
