...
输入：`{"dtype": "bf16", "images": [{"height": 256, "width": 256}, {"height": 512, "width": 512}], "kv_dtype": "bf16", "output_tokens": 128, "text_tokens": 400}`
...
| vision_matrix_flops | 956,435,529,728 |
| language_matrix_flops | 6,466,232,123,392 |
| total_matrix_flops | 7,422,667,653,120 |
| language_scalar_flops | 4,726,719,527 |
| vision_scalar_counts | `{"add": 1380812608, "multiply": 1534316928, "cos": 40960, "sin": 40960, "rsqrt": 63680, "negate": 31457280, "comparison": 427327488, "subtract": 427819008, "exp": 427819008, "divide": 427819008, "tanh": 125829120, "erf": 5242880}` |
...
| --- | --- | --- | --- | --- | --- | --- |
| 0 | False | [1, 16, 16] | 256 | 64 | 175825223680 | 1310720 |
| 1 | False | [1, 32, 32] | 1024 | 256 | 780610306048 | 5242880 |

逐图视觉矩阵：本次工作已乘该图是否未命中；copies仍表示模型内部重复。

| 图片 | 算子 | A | B | copies | 本次矩阵FLOPs |
| --- | --- | --- | --- | --- | --- |
| 0 | patch_embedding | [256, 1536] | [1536, 1024] | 1 | 805306368 |
| 0 | block.qkv | [256, 1024] | [1024, 3072] | 24 | 38654705664 |
| 0 | block.qk | [256, 64] | [64, 256] | 384 | 3221225472 |
| 0 | block.pv | [256, 256] | [256, 64] | 384 | 3221225472 |
| 0 | block.attention_output | [256, 1024] | [1024, 1024] | 24 | 12884901888 |
| 0 | block.mlp_up | [256, 1024] | [1024, 4096] | 24 | 51539607552 |
| 0 | block.mlp_down | [256, 4096] | [4096, 1024] | 24 | 51539607552 |
| 0 | merger_final.up | [64, 4096] | [4096, 4096] | 1 | 2147483648 |
| 0 | merger_final.out | [64, 4096] | [4096, 2560] | 1 | 1342177280 |
| 0 | merger_deepstack_5.up | [64, 4096] | [4096, 4096] | 1 | 2147483648 |
| 0 | merger_deepstack_5.out | [64, 4096] | [4096, 2560] | 1 | 1342177280 |
| 0 | merger_deepstack_11.up | [64, 4096] | [4096, 4096] | 1 | 2147483648 |
| 0 | merger_deepstack_11.out | [64, 4096] | [4096, 2560] | 1 | 1342177280 |
| 0 | merger_deepstack_17.up | [64, 4096] | [4096, 4096] | 1 | 2147483648 |
| 0 | merger_deepstack_17.out | [64, 4096] | [4096, 2560] | 1 | 1342177280 |
| 1 | patch_embedding | [1024, 1536] | [1536, 1024] | 1 | 3221225472 |
| 1 | block.qkv | [1024, 1024] | [1024, 3072] | 24 | 154618822656 |
| 1 | block.qk | [1024, 64] | [64, 1024] | 384 | 51539607552 |
| 1 | block.pv | [1024, 1024] | [1024, 64] | 384 | 51539607552 |
| 1 | block.attention_output | [1024, 1024] | [1024, 1024] | 24 | 51539607552 |
| 1 | block.mlp_up | [1024, 1024] | [1024, 4096] | 24 | 206158430208 |
| 1 | block.mlp_down | [1024, 4096] | [4096, 1024] | 24 | 206158430208 |
| 1 | merger_final.up | [256, 4096] | [4096, 4096] | 1 | 8589934592 |
| 1 | merger_final.out | [256, 4096] | [4096, 2560] | 1 | 5368709120 |
| 1 | merger_deepstack_5.up | [256, 4096] | [4096, 4096] | 1 | 8589934592 |
| 1 | merger_deepstack_5.out | [256, 4096] | [4096, 2560] | 1 | 5368709120 |
| 1 | merger_deepstack_11.up | [256, 4096] | [4096, 4096] | 1 | 8589934592 |
| 1 | merger_deepstack_11.out | [256, 4096] | [4096, 2560] | 1 | 5368709120 |
| 1 | merger_deepstack_17.up | [256, 4096] | [4096, 4096] | 1 | 8589934592 |
| 1 | merger_deepstack_17.out | [256, 4096] | [4096, 2560] | 1 | 5368709120 |

| 请求阶段 | 执行次数 | 已汇总矩阵FLOPs |
| --- | ---: | ---: |
| vision_encode | 2 | 956435529728 |
