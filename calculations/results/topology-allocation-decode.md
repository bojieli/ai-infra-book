...
输入：`{"calls": 256, "cut_capacity_bytes_per_second": 50000000000, "extra_setup_ns": 100000000, "flow_demand_bytes_per_second": 25000000000, "flows": 4, "new_bandwidth_bytes_per_second": 75000000000, "old_bandwidth_bytes_per_second": 25000000000, "participants": 8, "startup_ns": 5000, "tokens": 1}`
...
| message_bytes | 8,192 |
| rounds | 14 |
| per_rank_send_bytes | 14,336 |
| startup_ns | 70,000 |
| before_exact_ns | `"1764336/25"` |
| after_exact_ns | `"5264336/75"` |
| before_ns | 70,573.44 |
| after_ns | 70,191.14666666667 |
| saving_exact_ns | `"28672/75"` |
| call_speedup | 1.0054464608642002 |
| before_lifetime_exact_ns | `"451670016/25"` |
| after_lifetime_exact_ns | `"8847670016/75"` |
| new_path_wins_within_lifetime | `false` |
| break_even_calls | 261,580 |
| strictly_faster_calls | 261,580 |
