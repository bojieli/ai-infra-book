...
输入：`{"tile_k": 128, "tile_m": 128, "tile_n": 127, "tokens": 4097}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| matrix_flops | 51,552,190,464 |
| fully_padded_matrix_flops | 57,129,566,208 |
| output_tiles | 429 |
| m_blocks | 33 |
| n_blocks | 13 |
| k_blocks | 32 |
| fp16_activation_bytes | 33,562,624 |
| fp8_activation_bytes | 16,781,312 |
| fp8_weight_bytes | 6,291,456 |
| fp16_output_bytes | 12,585,984 |
| retained_fp16_input_per_quantization_row_bytes | 8,192 |
| global_fp32_row_scales_bytes | 16,388 |
| separate_main_bytes | 488,705,024 |
| full_scale_fused_main_bytes | 690,080,768 |
| prefix_scale_fused_main_bytes | 656,518,144 |
| full_scale_fusion_extra_main_bytes | 201,375,744 |
...
| --- | ---: | ---: | ---: | --- |
| separate_full_row_quantization | 488705024 | 16388 | 213044 | True |
| full_row_scale_fused_cast | 690080768 | 16388 | 213044 | True |
| prefix_scale_fused_cast | 656518144 | 0 | 0 | False |
