...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 0 | 132 | 132/125 | None | False |
| tp4-replicas2 | True | 0 | 170 | 34/25 | None | False |
| tp2-replicas4 | True | 0 | 230 | 46/25 | None | False |

选择：`{"required_valid_requests": 1, "eligible": [], "minimum_cost_per_valid_request_exact": null, "winners": []}`
