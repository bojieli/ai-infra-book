...
输入：`{"bandwidth_bytes_per_second": 50000000000, "batch": 1, "message_dtype": "BF16", "participants": 8, "root": 0, "segmentation": false, "startup_ns": 2000, "tokens": 8192}`
...
| maximum_rank_send_bytes | 201,326,592 |
| maximum_rank_receive_bytes | 201,326,592 |
| all_reduce_startup_seconds | 1.2e-05 |
| all_reduce_bandwidth_seconds | 0.00805306368 |
| all_reduce_modeled_seconds | 0.00806506368 |
| dense_tp_all_reduce_calls | 72 |
| dense_tp_serial_collective_seconds | 0.58068458496 |
| measured_collective_seconds | `null` |

| 阶段 | 轮次 | sender → receiver (bytes) |
| --- | ---: | --- |
| reduce | 0 | 1 → 0 (67108864); 3 → 2 (67108864); 5 → 4 (67108864); 7 → 6 (67108864) |
| reduce | 1 | 2 → 0 (67108864); 6 → 4 (67108864) |
| reduce | 2 | 4 → 0 (67108864) |
| broadcast | 0 | 0 → 4 (67108864) |
| broadcast | 1 | 0 → 2 (67108864); 4 → 6 (67108864) |
| broadcast | 2 | 0 → 1 (67108864); 2 → 3 (67108864); 4 → 5 (67108864); 6 → 7 (67108864) |

| Rank | 发送 bytes | 接收 bytes | 标量归约加法 |
| --- | ---: | ---: | ---: |
| 0 | 201326592 | 201326592 | 100663296 |
| 1 | 67108864 | 67108864 | 0 |
| 2 | 134217728 | 134217728 | 33554432 |
| 3 | 67108864 | 67108864 | 0 |
| 4 | 201326592 | 201326592 | 67108864 |
| 5 | 67108864 | 67108864 | 0 |
| 6 | 134217728 | 134217728 | 33554432 |
| 7 | 67108864 | 67108864 | 0 |
