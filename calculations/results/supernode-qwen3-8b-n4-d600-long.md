...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 4 | 498 | 623/125 | 623/500 | True |
| tp4-replicas2 | True | 4 | 450 | 23/5 | 23/20 | True |
| tp2-replicas4 | True | 4 | 410 | 107/25 | 107/100 | True |

选择：`{"required_valid_requests": 3, "eligible": ["tp8-replicas1", "tp4-replicas2", "tp2-replicas4"], "minimum_cost_per_valid_request_exact": "107/100", "winners": ["tp2-replicas4"]}`
...
```json
{
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "623/125",
        "missing_terms": [],
        "full_declared_cost_exact": "623/125",
        "cost_per_slo_valid_request_exact": "623/500",
    ...
    },
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "23/5",
        "missing_terms": [],
        "full_declared_cost_exact": "23/5",
        "cost_per_slo_valid_request_exact": "23/20",
        "observed_or_measured": false
      },
      "valid_requests": 4,
      "slo_eligible": true
    },
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "107/25",
        "missing_terms": [],
        "full_declared_cost_exact": "107/25",
        "cost_per_slo_valid_request_exact": "107/100",
        "observed_or_measured": false
      },
      "valid_requests": 4,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "107/100",
    "winners": [
      "tp2-replicas4"
    ]
  },
