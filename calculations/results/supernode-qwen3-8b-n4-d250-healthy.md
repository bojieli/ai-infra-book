...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 4 | 248 | 248/125 | 62/125 | True |
| tp4-replicas2 | True | 4 | 200 | 8/5 | 2/5 | True |
| tp2-replicas4 | True | 4 | 160 | 32/25 | 8/25 | True |

选择：`{"required_valid_requests": 3, "eligible": ["tp8-replicas1", "tp4-replicas2", "tp2-replicas4"], "minimum_cost_per_valid_request_exact": "8/25", "winners": ["tp2-replicas4"]}`
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "248/125",
        "missing_terms": [],
        "full_declared_cost_exact": "248/125",
    ...
    },
    {
      ...
      "cost": {
        ...
        "known_subtotal_exact": "8/5",
        "missing_terms": [],
        "full_declared_cost_exact": "8/5",
