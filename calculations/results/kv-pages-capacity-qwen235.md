...
输入：`{"capacity_bytes": 4718592, "events": [{"id": "a", "op": "create", "tokens": 17}], "model": "qwen3-235b-a22b", "page_tokens": 16, "reservation_tokens": 64}`
...
| capacity_pages | 1 |
| unusable_capacity_bytes | 1,638,400 |
| rejected_events | 1 |
| peak_allocated_page_bytes | 0 |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: |
| 0 | {'op': 'create', 'id': 'a', 'tokens': 17} | False | 0 | 0 | 0 | 0 | 0 |
