...
输入：`{"bandwidth_bytes_per_second": 50000000000, "batch": 1, "message_dtype": "BF16", "message_scope": "full activation per rank for all-reduce", "participants": 4, "startup_ns": 2000, "tokens": 1}`
...
| chunk_bytes | 2,048 |
| all_reduce_rounds | 6 |
| all_reduce_send_bytes_per_rank | 12,288 |
| all_reduce_receive_bytes_per_rank | 12,288 |
| all_reduce_network_send_bytes | 49,152 |
| all_reduce_global_reduction_adds | 12,288 |
| all_reduce_startup_seconds | 1.2e-05 |
| all_reduce_bandwidth_seconds | 2.4576e-07 |
| all_reduce_modeled_seconds | 1.2245760000000001e-05 |
| dense_tp_all_reduce_calls | 72 |
| dense_tp_serial_collective_seconds | 0.0008816947200000001 |
| measured_collective_seconds | `null` |

| 阶段 | 轮次 | sender → receiver : chunk (bytes) |
| --- | ---: | --- |
| reduce_scatter | 0 | 0 → 1 : 0 (2048); 1 → 2 : 1 (2048); 2 → 3 : 2 (2048); 3 → 0 : 3 (2048) |
| reduce_scatter | 1 | 0 → 1 : 3 (2048); 1 → 2 : 0 (2048); 2 → 3 : 1 (2048); 3 → 0 : 2 (2048) |
| reduce_scatter | 2 | 0 → 1 : 2 (2048); 1 → 2 : 3 (2048); 2 → 3 : 0 (2048); 3 → 0 : 1 (2048) |
| all_gather | 0 | 0 → 1 : 1 (2048); 1 → 2 : 2 (2048); 2 → 3 : 3 (2048); 3 → 0 : 0 (2048) |
| all_gather | 1 | 0 → 1 : 0 (2048); 1 → 2 : 1 (2048); 2 → 3 : 2 (2048); 3 → 0 : 3 (2048) |
| all_gather | 2 | 0 → 1 : 3 (2048); 1 → 2 : 0 (2048); 2 → 3 : 1 (2048); 3 → 0 : 2 (2048) |
