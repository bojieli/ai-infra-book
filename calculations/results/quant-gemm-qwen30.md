# qwen-expert-quantized-gemm-interface — qwen3-30b-a3b
...
| 结果 | 值 |
| --- | ---: |
| matrix_flops | 12,884,901,888 |
| fully_padded_matrix_flops | 12,884,901,888 |
| output_tiles | 192 |
| m_blocks | 32 |
| n_blocks | 6 |
| k_blocks | 16 |
| fp16_activation_bytes | 16,777,216 |
| fp8_activation_bytes | 8,388,608 |
| fp8_weight_bytes | 1,572,864 |
| fp16_output_bytes | 6,291,456 |
| retained_fp16_input_per_quantization_row_bytes | 4,096 |
| global_fp32_row_scales_bytes | 16,384 |
| separate_main_bytes | 132,120,576 |
| full_scale_fused_main_bytes | 174,063,616 |
| prefix_scale_fused_main_bytes | 157,286,400 |
| full_scale_fusion_extra_main_bytes | 41,943,040 |
...
| --- | ---: | ---: | ---: | --- |
| separate_full_row_quantization | 132120576 | 16384 | 98304 | True |
| full_row_scale_fused_cast | 174063616 | 16384 | 98304 | True |
| prefix_scale_fused_cast | 157286400 | 0 | 0 | False |
