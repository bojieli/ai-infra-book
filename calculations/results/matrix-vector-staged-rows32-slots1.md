...
完成时间：5120；首次向量开工：384；声明交接容量：24576 bytes（通过：True）。

跨单元载荷：98304 bytes；所选路径服务字节：196608。

| 任务 | 资源 | 开始 | 结束 | 服务时间 |
|---|---|---:|---:|---:|
| g0.qk | matrix | 0 | 128 | 128 |
| g0.scores | handoff | 128 | 384 | 256 |
| g0.softmax | vector | 384 | 1024 | 640 |
| g0.probabilities | handoff | 1024 | 1152 | 128 |
| g0.pv | matrix | 1152 | 1280 | 128 |
| g1.qk | matrix | 1280 | 1408 | 128 |
| g1.scores | handoff | 1408 | 1664 | 256 |
| g1.softmax | vector | 1664 | 2304 | 640 |
| g1.probabilities | handoff | 2304 | 2432 | 128 |
| g1.pv | matrix | 2432 | 2560 | 128 |
| g2.qk | matrix | 2560 | 2688 | 128 |
| g2.scores | handoff | 2688 | 2944 | 256 |
| g2.softmax | vector | 2944 | 3584 | 640 |
| g2.probabilities | handoff | 3584 | 3712 | 128 |
| g2.pv | matrix | 3712 | 3840 | 128 |
| g3.qk | matrix | 3840 | 3968 | 128 |
| g3.scores | handoff | 3968 | 4224 | 256 |
| g3.softmax | vector | 4224 | 4864 | 640 |
| g3.probabilities | handoff | 4864 | 4992 | 128 |
| g3.pv | matrix | 4992 | 5120 | 128 |
...
```json
{
  ...
  "timeline": [
    ...
    },
    {
      ...
      "end_tick": 2304,
      "duration_ticks": 640,
      "critical_predecessor": "g1.scores",
      "scheduled_predecessors": [
        "g1.scores",
        "g0.softmax"
      ]
    ...
    },
    {
      ...
      "end_tick": 3584,
      "duration_ticks": 640,
      "critical_predecessor": "g2.scores",
      "scheduled_predecessors": [
        "g2.scores",
        "g1.softmax"
      ]
    ...
    },
    {
      ...
      "end_tick": 4864,
      "duration_ticks": 640,
      "critical_predecessor": "g3.scores",
      "scheduled_predecessors": [
        "g3.scores",
        "g2.softmax"
      ]
  ...
  "summary": {
    ...
    "reserved_handoff_bytes": 24576,
    "passes_declared_handoff_capacity": true,
    "total_matrix_flops": 8388608,
    "crossing_payload_bytes": 98304,
    "served_handoff_bytes": 196608,
    "finish_tick": 5120,
    "capacity_qualified_finish_tick": 5120,
    "first_vector_start_tick": 384,
