...
输入：`{"batches": 128, "compute_flops_per_second": 100000000000000, "copy_bytes_per_second": 25000000000, "copy_startup_ns": 5000, "extra_budget_bytes_per_rank": 67108864, "interface_bytes_per_second": 1000000000000000, "workload": {"replicas": [{"expert": 0, "rank": 4}], "routing": "concentrated", "tokens": 33}}`
...
| extra_weight_bytes_per_rank | `[0, 0, 0, 0, 37748736, 0, 0, 0]` |
| capacity_feasible | `true` |
| over_budget_ranks | `[]` |
| serialized_copy_setup_ns_exact | `"37873736/25"` |
| baseline_batch_ns_exact | `"603979776/3125"` |
| replicated_batch_ns_exact | `"603979776/3125"` |
| per_batch_saving_ns_exact | `"0"` |
| algebraic_strict_payback_batches | `null` |
| feasible_strict_payback_batches | `null` |
| baseline_window_ns_exact | `"77309411328/3125"` |
| replicated_window_ns_exact | `"82043628328/3125"` |
| window_saving_ns_exact | `"-37873736/25"` |
| selected_deployment | `"baseline"` |
| selected_window_ns_exact | `"77309411328/3125"` |

| 部署 | rank | 矩阵服务ns | 指定接口服务ns | rank服务ns |
| --- | ---: | --- | --- | --- |
| baseline | 0 | 603979776/3125 | 1198848/3125 | 603979776/3125 |
| baseline | 1 | 0 | 0 | 0 |
| baseline | 2 | 0 | 0 | 0 |
| baseline | 3 | 0 | 0 | 0 |
| baseline | 4 | 0 | 0 | 0 |
...
| baseline | 6 | 0 | 0 | 0 |
| baseline | 7 | 0 | 0 | 0 |
| replicated | 0 | 603979776/3125 | 5916928/15625 | 603979776/3125 |
| replicated | 1 | 0 | 0 | 0 |
| replicated | 2 | 0 | 0 | 0 |
| replicated | 3 | 0 | 0 | 0 |
| replicated | 4 | 75497472/3125 | 667136/15625 | 75497472/3125 |
| replicated | 5 | 0 | 0 | 0 |
| replicated | 6 | 0 | 0 | 0 |
| replicated | 7 | 0 | 0 | 0 |
