...
输入：`{"bandwidth_bytes_per_second": 1000000000, "chunk_tokens": 256, "dtype": "bf16", "head_flops_per_second": 100000000000000, "model": "qwen3-8b", "replays": 1, "tokens": 8192}`
...
| full_logits_cache_bytes | 2,489,319,424 |
| logits_to_hidden_ratio_exact | `"1187/32"` |
| head_weight_bytes | 1,244,659,712 |
| one_head_gemm_flops | 10,196,252,360,704 |
| hidden_total_cache_io_bytes | 134,217,728 |
| logits_total_cache_io_bytes | 4,978,638,848 |
| hidden_total_head_flops | 10,196,252,360,704 |
| logits_total_head_flops | 10,196,252,360,704 |
| head_chunk_count | 32 |
| head_tail_tokens | 256 |
| head_live_tensor_bytes | 1,324,548,096 |
| hidden_serial_budget_exact_seconds | `"1441529856/6103515625"` |
| logits_serial_budget_exact_seconds | `"31009529856/6103515625"` |
| hidden_serial_budget_is_lower | `true` |
| serial_budget_difference_hidden_minus_logits_exact_seconds | `"-1892352/390625"` |
