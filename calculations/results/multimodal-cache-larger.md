...
输入：`{"arrival_requests_per_second": "0", "compressed_image_bytes": 800000, "dtype": "bf16", "encoder_cache_hit_fraction": "0", "encoder_images_per_second": "12", "images_per_request": 4, "kv_dtype": "bf16", "network_bytes_per_second": 300000000, "pd_requests_per_second": "4", "preprocessed_height": 640, "preprocessed_width": 672, "text_tokens": 400, "total_workers": 4, "uplink_bits_per_second": 6400000}`
...
| pre_merge_patch_count | 1,680 |
| image_visual_positions | 420 |
| deepstack_visual_blocks | `[5, 11, 17]` |
| final_embedding_shape | `[420, 2560]` |
| complete_encoder_shape | `[420, 10240]` |
| final_embedding_bytes_per_image | 2,150,400 |
| deepstack_bytes_per_image | 6,451,200 |
| complete_encoder_bytes_per_image | 8,601,600 |
| complete_encoder_bytes_per_request | 34,406,400 |
| visual_positions_per_request | 1,680 |
| declared_input_positions | 2,080 |
| kv_bytes_per_position | 147,456 |
| visual_kv_bytes_per_image | 61,931,520 |
| visual_kv_bytes_per_request | 247,726,080 |
| text_kv_bytes_per_request | 58,982,400 |
| declared_input_kv_bytes | 306,708,480 |
| compressed_image_uplink_exact_seconds | `"1"` |
| complete_encoder_uplink_exact_seconds | `"1344/125"` |
| encoder_to_compressed_bytes_ratio_exact | `"1344/125"` |
| one_image_ec_network_exact_seconds | `"448/15625"` |
| one_request_ec_network_exact_seconds | `"1792/15625"` |
| ec_transfer_bytes_per_request | 34,406,400 |
| uncached_images_per_request_exact | `"4"` |
| best_known_bound_requests_per_second_exact | `"6"` |
...
| ---: | ---: | --- | --- | --- | --- |
| 1 | 3 | 3 | 12 | 15625/1792 | 3 |
| 2 | 2 | 6 | 8 | 15625/1792 | 6 |
| 3 | 1 | 9 | 4 | 15625/1792 | 4 |
