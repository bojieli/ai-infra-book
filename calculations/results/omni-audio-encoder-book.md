...
输入：`{"attention_path": "segmented_varlen", "element_bytes": 2, "mel_lengths": [1000]}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| matrix_flops | 211,204,423,680 |
| scalar_flops | 184,427,010 |
| parameter_elements | 647,927,168 |
| weight_interface_bytes | 1,295,854,336 |
| activation_read_bytes | 351,040,130 |
| activation_write_bytes | 308,684,800 |
| output_embeddings_per_audio | `[130]` |
| output_embedding_elements | 266,240 |
| output_embedding_bytes | 532,480 |
| padded_cnn_positions | 130 |
| valid_encoder_positions | 130 |
| segmented_bidirectional_pairs | 11,492 |
| source_unmasked_eager_pairs | 16,900 |
...
组批：`{"padded_mel_width": 100, "after_cnn_width": 13, "attention_window_positions": 104, "convolution_chunk_batch_limit": 500, "convolution_groups": 1, "retained_cnn_group_outputs_bytes": 1996800, "max_single_group_output_bytes": 1996800}`

| 算子 | 类型 | 形状 | repeats | 矩阵FLOPs | 标量工作 | 特殊操作 |
| --- | --- | --- | --- | --- | --- | --- |
| mel_chunk_pad | copy | {'input': [128, 1000], 'output': [10, 1, 128, 100]} | 1 | 0 | 0 | {} |
| conv2d_1 | conv2d | {'input': [10, 1, 128, 100], 'weight': [480, 1, 3, 3], 'output': [10, 480, 64, 50]} | 1 | 276480000 | 15360000 | {} |
| conv_gelu_1 | activation | {'elements': 15360000} | 1 | 0 | 0 | {'gelu': 15360000} |
| conv2d_2 | conv2d | {'input': [10, 480, 64, 50], 'weight': [480, 480, 3, 3], 'output': [10, 480, 32, 25]} | 1 | 33177600000 | 3840000 | {} |
| conv_gelu_2 | activation | {'elements': 3840000} | 1 | 0 | 0 | {'gelu': 3840000} |
| conv2d_3 | conv2d | {'input': [10, 480, 32, 25], 'weight': [480, 480, 3, 3], 'output': [10, 480, 16, 13]} | 1 | 8626176000 | 998400 | {} |
| conv_gelu_3 | activation | {'elements': 998400} | 1 | 0 | 0 | {'gelu': 998400} |
| concat_and_layout | copy | {'concat': [10, 480, 16, 13], 'flatten': [130, 7680]} | 1 | 0 | 0 | {} |
| conv_out | linear | {'input': [130, 7680], 'weight': [1280, 7680], 'output': [130, 1280]} | 1 | 2555904000 | 0 | {} |
| chunk_position_add | position | {'padded': [10, 13, 1280]} | 1 | 0 | 166400 | {} |
| remove_padding | gather | {'input': [10, 13, 1280], 'output': [130, 1280]} | 1 | 0 | 0 | {} |
| attention_norm | layernorm | {'input': [130, 1280]} | 32 | 0 | 1164930 | {'rsqrt': 130} |
| q | linear | {'input': [130, 1280], 'weight': [1280, 1280], 'output': [130, 1280]} | 32 | 425984000 | 166400 | {} |
| k | linear | {'input': [130, 1280], 'weight': [1280, 1280], 'output': [130, 1280]} | 32 | 425984000 | 166400 | {} |
| v | linear | {'input': [130, 1280], 'weight': [1280, 1280], 'output': [130, 1280]} | 32 | 425984000 | 166400 | {} |
| qk | attention | {'heads': 20, 'head_dim': 64, 'positions': 130, 'accounted_pairs': 11492} | 32 | 29419520 | 0 | {} |
| scale_softmax | attention | {'heads': 20, 'pairs': 11492} | 32 | 0 | 916760 | {'exp': 229840, 'max_compare': 227240} |
| pv | attention | {'heads': 20, 'head_dim': 64, 'positions': 130, 'accounted_pairs': 11492} | 32 | 29419520 | 0 | {} |
| attention_output | linear | {'input': [130, 1280], 'weight': [1280, 1280], 'output': [130, 1280]} | 32 | 425984000 | 166400 | {} |
| attention_residual | residual | {'input': [130, 1280]} | 32 | 0 | 166400 | {} |
| ffn_norm | layernorm | {'input': [130, 1280]} | 32 | 0 | 1164930 | {'rsqrt': 130} |
| ffn_fc1 | linear | {'input': [130, 1280], 'weight': [5120, 1280], 'output': [130, 5120]} | 32 | 1703936000 | 665600 | {} |
| ffn_gelu | activation | {'elements': 665600} | 32 | 0 | 0 | {'gelu': 665600} |
| ffn_fc2 | linear | {'input': [130, 5120], 'weight': [1280, 5120], 'output': [130, 1280]} | 32 | 1703936000 | 166400 | {} |
| ffn_residual | residual | {'input': [130, 1280]} | 32 | 0 | 166400 | {} |
| post_norm | layernorm | {'input': [130, 1280]} | 1 | 0 | 1164930 | {'rsqrt': 130} |
| proj1 | linear | {'input': [130, 1280], 'weight': [1280, 1280], 'output': [130, 1280]} | 1 | 425984000 | 166400 | {} |
| projection_gelu | activation | {'elements': 166400} | 1 | 0 | 0 | {'gelu': 166400} |
| proj2_to_thinker | linear | {'input': [130, 1280], 'weight': [2048, 1280], 'output': [130, 2048]} | 1 | 681574400 | 266240 | {} |
