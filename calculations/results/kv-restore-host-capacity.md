...
输入：`{"host_capacity_bytes": 134217728, "model": "qwen3-8b", "next_use_ns": 20000000, "offload_bandwidth": 25000000000, "recompute_ns": 50000000, "restore_bandwidth": 25000000000, "tokens": 1024, "transfer_startup_ns": 10000}`
...
| prefetch_start_exact_ns | `"348755056/25"` |
| offload_return_stall_exact_ns | `"0"` |
| recompute_start_ns | 0 |
| recompute_stall_ns | 30,000,000 |
| host_snapshot_fits | `false` |

| 策略 | 容量可行 | 恢复等待 ns | KV释放时长 ns | 搬运 bytes | 重算矩阵 FLOPs |
| --- | --- | ---: | ---: | ---: | ---: |
| keep | True | 0 | 0 | 0 | 0 |
| offload_prefetch | False | 0 | 197510112/25 | 301989888 | 0 |
| drop_recompute | True | 30000000 | 0 | 0 | 14534471319552 |
