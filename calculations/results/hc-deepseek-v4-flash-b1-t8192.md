# v4-hyper-connections — deepseek-v4-flash

输入：`{"activation_bytes": 2, "batch": 1, "tokens": 8192}`
...
| hc_mult | 4 |
| hidden_size | 4,096 |
| sublayer_occurrences | 86 |
| sinkhorn_iterations | 20 |
| sinkhorn_normalizations_per_sublayer | 39 |
| hc_parameters | 33,884,439 |
| hc_fp32_parameter_bytes | 135,537,756 |
| matrix_flops | 555,124,523,008 |
| scalar_flops | 148,981,473,280 |
| special_ops | `{"rsqrt": 712704, "sigmoid": 5668864, "exp": 11272192, "compare_max": 8454144}` |
| residual_activation_tensor_bytes | 268,435,456 |
| one_sublayer_post_comb_fp32_bytes | 655,360 |
| embedding_repeat_output_bytes | 268,435,456 |

mHC 运算总数已乘出现次数；张量尺寸为单次出现。

| 操作 | 次数 | 形状 | 矩阵 FLOPs | 普通 FLOPs | 特殊原语 | 说明 |
| --- | ---: | --- | ---: | ---: | --- | --- |
| pre_rms_statistic | 86 | {'input': [8192, 16384]} | 0 | 23,086,153,728 | {'rsqrt': 704512} | FP32 square, sum, mean division and epsilon. No learned RMS scale in hc_pre. |
| pre_mix_projection | 86 | {'A': [8192, 16384], 'W_math': [16384, 24], 'Y': [8192, 24]} | 554,050,781,184 | 0 | {} | FP32 source operands; accumulator and achievable matrix-unit peak require a separate backend match. |
| pre_mix_normalize | 86 | {'mixes': [8192, 24]} | 0 | 16,908,288 | {} |  |
| split_sinkhorn | 86 | {'pre': [8192, 4], 'post': [8192, 4], 'comb': [8192, 4, 4]} | 0 | 1,290,665,984 | {'sigmoid': 5636096, 'exp': 11272192, 'compare_max': 8454144} | Initial row softmax, one column normalization, then 19 row/column pairs. Per-cell epsilon expressions are not hoisted. |
| pre_weighted_reduce | 86 | {'input': [8192, 4, 4096], 'output': [8192, 4096]} | 0 | 20,199,768,064 | {} | c multiplies and c-1 sum additions per output channel; output casts to activation dtype. |
| post_residual_mix | 86 | {'residual': [8192, 4, 4096], 'comb': [8192, 4, 4], 'output': [8192, 4, 4096]} | 0 | 103,884,521,472 | {} | Literal broadcast/reduce: c²H residual multiplies, c(c-1)H reductions, cH post multiplies and cH final adds. |
| head_rms_statistic | 1 | {'input': [8192, 16384]} | 0 | 268,443,648 | {'rsqrt': 8192} |  |
| head_mix_projection | 1 | {'A': [8192, 16384], 'W_math': [16384, 4], 'Y': [8192, 4]} | 1,073,741,824 | 0 | {} |  |
| head_mix_and_gate | 1 | {'pre': [8192, 4]} | 0 | 131,072 | {'sigmoid': 32768} | Multiply RMS statistic, scale, add base, sigmoid, add epsilon. |
| head_weighted_reduce | 1 | {'input': [8192, 4, 4096], 'output': [8192, 4096]} | 0 | 234,881,024 | {} |  |
