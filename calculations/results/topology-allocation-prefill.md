...
输入：`{"calls": 256, "cut_capacity_bytes_per_second": 50000000000, "extra_setup_ns": 100000000, "flow_demand_bytes_per_second": 25000000000, "flows": 4, "new_bandwidth_bytes_per_second": 75000000000, "old_bandwidth_bytes_per_second": 25000000000, "participants": 8, "startup_ns": 5000, "tokens": 1024}`
...
| after_exact_ns | `"19930064/75"` |
| before_ns | 657,202.56 |
| after_ns | 265,734.18666666665 |
| saving_exact_ns | `"29360128/75"` |
| call_speedup | 2.473157737978162 |
| before_lifetime_exact_ns | `"4206096384/25"` |
| after_lifetime_exact_ns | `"12602096384/75"` |
| new_path_wins_within_lifetime | `true` |
| break_even_calls | 256 |
| strictly_faster_calls | 256 |
