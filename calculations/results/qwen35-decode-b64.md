...
| matrix_flops | 2366552158208 |
| scalar_flops | 5314147584 |
| reference_integer_operations | 39900740 |
| full_forward_exact | False |

特殊数学 primitive：`{"cos": 6144, "exp": 253842240, "max_comparisons": 253620480, "rsqrt": 593344, "sigmoid": 110288640, "sin": 6144, "softplus": 184320, "topk_selections": 3840}`。
...
```json
{
  ...
  "state": {
    "full_kv_before_bytes": 16106127360,
    "full_kv_after_bytes": 16108093440,
    "full_kv_append_bytes": 1966080,
    "linear_recurrent_fp32_bytes": 12079595520,
    "linear_conv_slot_elements": 141557760,
    "linear_conv_dtype": "input activation dtype; declared BF16 path",
    "linear_conv_slot_bytes": 283115520,
    "record_past_extra_allocation_bytes": 0,
    "record_past_retained_conv_bytes": 283115520
  }
}
```
...
| --- | ---: | ---: |
| activation | 0 | 200540160 |
| attention_matrix | 257729495040 | 0 |
| copy | 0 | 0 |
| depthwise_conv | 283115520 | 0 |
| elementwise | 0 | 3106406400 |
| gate | 0 | 368640 |
| gather | 0 | 0 |
| linear | 2090137026560 | 0 |
| normalization | 0 | 420551616 |
| reference_supplement | 283127808 | 252748608 |
| rotary | 0 | 6266880 |
| router | 0 | 5967360 |
| routing | 0 | 314572800 |
| softmax | 0 | 1006725120 |
...
| --- | ---: | ---: | ---: |
| conv.additional_padded_and_discarded_products | 45 | 7864320 | 3145728 |
| conv.extra_silu_before_final_crop | 45 | 1572864 | 1572864 |
| conv.cache_concat_or_initial_pad | 45 | 7864320 | 7864320 |
| conv.cache_copy_last4 | 45 | 6291456 | 6291456 |
| recurrent.fp32_casts | 45 | 3170304 | 6324224 |
| recurrent.decay_exp_interface | 45 | 16384 | 16384 |
| recurrent.decay_state_interface | 45 | 268451840 | 268435456 |
| recurrent.K_state_products_and_reduce | 45 | 270532608 | 270532608 |
| recurrent.delta_subtract_beta_multiply | 45 | 8404992 | 4194304 |
| recurrent.outer_product_and_state_add | 45 | 541065216 | 536870912 |
| recurrent.Q_state_products_and_reduce | 45 | 270532608 | 270532608 |
| recurrent.output_zero_assignment_cast | 45 | 2097152 | 5242880 |
| linear.cache_update_recurrent_copy | 45 | 268435456 | 268435456 |
...
| rope.rotate_half_negation | 15 | 139264 | 139264 |
| rope.concat_rotated_and_passthrough | 15 | 1114112 | 1114112 |
| full.eager_masked_matrix_slots | 15 | 0 | 0 |
| full.eager_additional_softmax_and_mask | 15 | 0 | 0 |
| full.kv_cache_concat | 15 | 1073872896 | 1073872896 |
| full.repeat_kv_logical_materialization | 15 | 1073872896 | 17181966336 |
| full.QK_interfaces | 15 | 8592031744 | 33558528 |
| full.scale_mask_softmax_cast_interfaces | 15 | 167792640 | 167792640 |
| full.PV_interfaces | 15 | 8624541696 | 1048576 |
| full.transpose_contiguous | 15 | 1048576 | 1048576 |
...
| router.logits_cast_softmax | 60 | 196608 | 262144 |
| router.topk_primitive_interfaces | 60 | 131072 | 7680 |
| router.probability_cast_and_selected_renorm | 60 | 7936 | 4096 |
| router.one_hot_initialize_scatter | 60 | 5120 | 2626560 |
| router.expert_hit_reduce_compare_nonzero | 60 | 2626048 | 8704 |
| router.where_per_active_expert | 60 | 2621440 | 10240 |
| router.input_gather | 60 | 5248000 | 5242880 |
| router.probability_gather | 60 | 11520 | 1280 |
| router.destination_zero_fill | 60 | 0 | 524288 |
| router.index_add_destination_interfaces | 60 | 10490880 | 5242880 |
| norm.layer_input_and_post.input_fp32_cast | 120 | 524288 | 1048576 |
| norm.layer_input_and_post.square_mean_epsilon_rsqrt | 120 | 2097664 | 1049344 |
| norm.layer_input_and_post.normalize_multiply | 120 | 1048832 | 1048576 |
| norm.layer_input_and_post.weight_cast_plus_one | 120 | 24576 | 32768 |
| norm.layer_input_and_post.weight_multiply_output_cast | 120 | 2113536 | 1572864 |
| norm.full_Q.input_fp32_cast | 15 | 1048576 | 2097152 |
| norm.full_Q.square_mean_epsilon_rsqrt | 15 | 4210688 | 2121728 |
| norm.full_Q.normalize_multiply | 15 | 2105344 | 2097152 |
| norm.full_Q.weight_cast_plus_one | 15 | 1536 | 2048 |
| norm.full_Q.weight_multiply_output_cast | 15 | 4195328 | 3145728 |
| norm.full_K.input_fp32_cast | 15 | 65536 | 131072 |
| norm.full_K.square_mean_epsilon_rsqrt | 15 | 263168 | 132608 |
| norm.full_K.normalize_multiply | 15 | 131584 | 131072 |
| norm.full_K.weight_cast_plus_one | 15 | 1536 | 2048 |
| norm.full_K.weight_multiply_output_cast | 15 | 263168 | 196608 |
| norm.final.input_fp32_cast | 1 | 524288 | 1048576 |
| norm.final.square_mean_epsilon_rsqrt | 1 | 2097664 | 1049344 |
| norm.final.normalize_multiply | 1 | 1048832 | 1048576 |
| norm.final.weight_cast_plus_one | 1 | 24576 | 32768 |
| norm.final.weight_multiply_output_cast | 1 | 2113536 | 1572864 |
| norm.linear_gated.input_fp32_cast | 45 | 1048576 | 2097152 |
| norm.linear_gated.square_mean_epsilon_rsqrt | 45 | 4227072 | 2146304 |
| norm.linear_gated.normalize_multiply | 45 | 2113536 | 2097152 |
| norm.linear_gated.normalized_cast_weight_multiply | 45 | 3145984 | 2097152 |
| norm.linear_gated.z_cast_silu | 45 | 3145728 | 4194304 |
| norm.linear_gated.gate_multiply_final_cast | 45 | 5242880 | 3145728 |
| linear.A_exp_negation | 45 | 512 | 512 |
| linear.a_dt_softplus_decay_multiply | 45 | 57728 | 65536 |
| linear.b_sigmoid | 45 | 8192 | 8192 |
| linear.qk_norm_internal | 45 | 12681216 | 8486912 |
| linear.query_scale_interface | 45 | 2097152 | 2097152 |
| moe.routed_silu_and_up_multiply | 60 | 3932160 | 2621440 |
| moe.routed_probability_multiply | 60 | 5244160 | 5242880 |
| moe.shared_silu_and_up_multiply | 60 | 393216 | 262144 |
| moe.shared_gate_sigmoid_multiply_combine | 60 | 1573120 | 1048704 |
| full.output_gate_sigmoid_multiply | 15 | 3145728 | 2097152 |
