...
|---|---|---:|---:|---:|---:|---|
| tp8-replicas1 | True | 2 | 746 | 871/125 | 871/250 | False |
| tp4-replicas2 | True | 3 | 650 | 31/5 | 31/15 | True |
| tp2-replicas4 | False | None | None | None | None | False |

选择：`{"required_valid_requests": 3, "eligible": ["tp4-replicas2"], "minimum_cost_per_valid_request_exact": "31/15", "winners": ["tp4-replicas2"]}`
...
```json
{
  ...
  "candidates": [
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "871/250",
    ...
    },
    {
      ...
      "cost": {
        ...
        "cost_per_slo_valid_request_exact": "31/15",
        "observed_or_measured": false
      },
      "valid_requests": 3,
      "slo_eligible": true
  ...
  "selection": {
    ...
    "minimum_cost_per_valid_request_exact": "31/15",
    "winners": [
      "tp4-replicas2"
    ]
  },
