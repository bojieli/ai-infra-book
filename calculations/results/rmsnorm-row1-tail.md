...
输入：`{"rows": 1, "splits": 7, "width_multiplier": 1}`
...
| apply_groups | 7 |
| local_reduction_adds | 4,089 |
| merge_reduction_adds | 6 |
| partial_buffer_bytes | 28 |
| inverse_buffer_bytes | 4 |
| fused_interface_bytes | 24,576 |
| split_interface_bytes | 32,856 |
| additional_interface_bytes | 8,280 |
| fused_retained_fp32_row_bytes | 16,384 |
| split_max_partition_fp32_bytes | 2,344 |
| predicted_seconds | `null` |

| 策略 | 总组数 | launches | 接口 bytes | 辅助缓冲 bytes |
| --- | ---: | ---: | ---: | ---: |
| one_group_per_row | 1 | 1 | 24576 | 0 |
| three_pass_split | 15 | 3 | 32856 | 32 |
