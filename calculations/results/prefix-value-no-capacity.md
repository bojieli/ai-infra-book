...
输入：`{"budget_bytes": 0, "candidates": [{"expected_reuses": "1", "id": "512", "prefix_tokens": 512, "suffix_tokens": 1}, {"expected_reuses": "1", "id": "768", "prefix_tokens": 768, "suffix_tokens": 1}, {"expected_reuses": "1", "id": "1024", "prefix_tokens": 1024, "suffix_tokens": 1}], "model": "qwen3-8b", "page_tokens": 16}`
...
| optimal_selected | `[]` |
| optimal_resident_bytes | 0 |
| optimal_expected_saved_matrix_flops_exact | `"0"` |
| density_greedy_selected | `[]` |
| density_greedy_resident_bytes | 0 |
| density_greedy_expected_saved_matrix_flops_exact | `"0"` |
