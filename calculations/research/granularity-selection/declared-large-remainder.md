...
| fine256-k16 | 67,855,997,952 | 20.538885 | 0.100000 | True |
...
满足必要容量条件后的条件最快方案：['coarse64']（null表示剩余输入不足；空列表表示两者均未通过容量条件）。
...
```json
{
  ...
  "variants": [
    ...
    },
    {
      ...
      "full_runtime_seconds": null,
      "quality": null,
      "declared_remaining_seconds_exact": "1/10000",
      "conditional_extended_seconds_exact": "1007758073/48828125000"
    }
  ],
