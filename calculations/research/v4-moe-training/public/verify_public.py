...
from infra_calc.topics import v4_moe_training as module
...
def main():
    ...
    deps += [
        ROOT / "calculations/src/infra_calc/topics" / name
        for name in ("v4_training_primitives.py", "v4_attention_projections.py")
    ]
    deps += [
        ROOT / "calculations/src/infra_calc/models/qwen3_moe.py",
