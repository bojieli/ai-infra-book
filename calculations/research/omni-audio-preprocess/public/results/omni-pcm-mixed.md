...
```json
{
  ...
  "geometry": {
    ...
    "stft_frames_per_audio": 6,
    "kept_frames_per_audio": 5,
    "valid_mel_lengths": [
      3,
      5
    ],
  ...
  "stages": [
    ...
    },
    {
      ...
      "special_ops": {},
      "integer_ops": 0,
      "discarded_complex_elements": 402,
  ...
  "summary": {
    "matrix_flops": 514560,
    "known_scalar_flops": 10577,
    "source_operand_read_bytes": 477318,
    "source_operand_write_bytes": 242486,
    "encoder_input_bytes": 4096,
  ...
  "optional_reference_fft": {
    ...
    "all_transforms": {
      "real_multiplications": 345600,
      "real_additions": 288000,
      "complex_products": 86400
    },
