...
sys.path.insert(0, '/Users/boj/book/ai-infra-book/calculations/src')
import unittest
from copy import deepcopy
from fractions import Fraction
from reconfiguration import (calculate, intervals, transfer_plan, amortization,
...
class ReconfigurationTests(unittest.TestCase):
    ...
    def test_bounds_capacity_and_replay(self):
        ...
        self.assertGreaterEqual(Fraction(replay['summary']['declared_serial_switch_seconds_exact']),5)
