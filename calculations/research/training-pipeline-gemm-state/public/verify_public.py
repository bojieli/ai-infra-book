...
from infra_calc.topics import training_pipeline_gemm_state as module
...
def main():
    ...
    deps += [
        ...
        for name in (
            "training_pipeline_schedule.py",
            "training_matrix.py",
            "training_nonmatrix.py",
        )
    ]
    deps += [ROOT / "calculations/src/infra_calc/models/qwen3.py"]
