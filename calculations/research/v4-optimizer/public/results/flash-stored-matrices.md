...
| layers.{i}.attn.wo_a.weight | muon | [8192, 4096] | 43 | [8192, 4096] | 1 | 1442840576 | 295493749964800 | 66370666496 |
...
| hc_head_fn | muon | [4, 16384] | 1 | [4, 16384] | 1 | 65536 | 10487040 | 2032096 |
...
```json
{
  ...
  "groups": [
    ...
    },
    {
      ...
      "per_matrix_reference": {
        ...
        "matrix_flops": 10487040,
        "ordinary_scalar_operations": 2032096,
        "scalar_detail": {
          "momentum_and_nesterov": 262144,
          "frobenius_square_sum_epsilon_divide": 196608,
          "polynomial_combine": 1311200,
          "rescale_decay_update": 262144
        },
        "special_operations": {
          "sqrt": 1
        ...
        "fp32_gradient_input_bytes": 262144,
        "tensor_interfaces_per_iteration_bytes": {
          "gemm_operand_reads": 786624,
          "gemm_outputs": 262272,
          "scalar_combine_reads": 524416,
          "scalar_combine_writes": 262208
        },
        "individual_temporary_bytes": {
          "X": 262144,
          "A": 64,
  ...
  "summary": {
    "muon_parameters": 283272720064,
    "adamw_parameters": 1059510167,
    "unresolved_parameters": 0,
    "external_router_bias_parameters": 10240,
    "ordinary_scalar_operations": 13016706405940,
    "adam_sqrt": 1059510167,
    "matrix_flops": 29158097681635420,
    "normalization_sqrt": 33769,
    "shared_step_scalar_operations": 8,
    "shape_setup_scalar_multiply": 16,
    "shape_setup_sqrt": 16
  },
  "inventory": {
  ...
  "state_interfaces": {
    "declared_fp32_master_weights_bytes": 1137328920924,
    "declared_fp32_muon_momentum_bytes": 1133090880256,
    "declared_fp32_adam_m_v_bytes": 8476081336,
    "declared_fp32_gradient_input_bytes": 1137328920924,
