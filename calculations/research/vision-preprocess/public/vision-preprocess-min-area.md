...
已解码单张 32×32 HWC RGB uint8 → 256×256；grid=[1, 16, 16]，FP32 pixel_values=[256, 1536]。

处理器输出 1572864 B；bf16 视觉入口 786432 B。语义读/写 9114648 / 5000776 B；矩阵FLOPs=0。整数resize、FP32标量与转换各按原类别列示。

| 阶段 | 次数 | 语义读B | 语义写B | 实际列出的操作 |
|---|---:|---:|---:|---|
| smart_resize_geometry | 1 | 0 | 0 | {"python_round": 2, "python_sqrt": 1} |
| numpy_to_torch_alias | 1 | 0 | 0 | {} |
| HWC_to_CHW_contiguous | 1 | 3072 | 3072 | {"element_copy": 3072} |
| CPU_group_unsqueeze_before_resize | 1 | 0 | 0 | {} |
| width_coefficient_setup | 1 | 26112 | 28928 | {"fp64_axis_scale_divide": 1, "fp64_support_multiply": 1, "fp64_axis_support_ceil": 1, "fp64_per_coordinate_inverse_scale_divide": 0, "fp64_range_add_sub": 1024, "fp64_range_to_int64": 512, "fp64_weight_max_compare": 1248, "fp64_precision_scale_multiply": 15, "fp64_precision_round_add": 15, "fp64_quantize_sign_compare": 1280, "int64_index_array_store": 1024, "fp64_center_multiply": 256, "fp64_center_add": 256, "fp64_filter_argument_subtract": 992, "fp64_filter_argument_add": 992, "fp64_filter_argument_multiply": 992, "fp64_abs": 992, "fp64_cubic_multiply": 2976, "fp64_cubic_add_sub": 2472, "fp64_weight_sum_add": 992, "fp64_weight_normalize_divide": 992, "fp64_quantize_multiply": 1280, "fp64_quantize_add": 1280, "float_to_integer_cast": 1280} |
| width_uint8_separable_convolution | 1 | 285696 | 24576 | {"int32_multiply": 95232, "int32_add": 95232, "int32_rounding_bias_init": 24576, "int32_right_shift": 24576, "int32_clamp": 24576, "uint8_store": 24576} |
| height_coefficient_setup | 1 | 26112 | 28928 | {"fp64_axis_scale_divide": 1, "fp64_support_multiply": 1, "fp64_axis_support_ceil": 1, "fp64_per_coordinate_inverse_scale_divide": 0, "fp64_range_add_sub": 1024, "fp64_range_to_int64": 512, "fp64_weight_max_compare": 1248, "fp64_precision_scale_multiply": 15, "fp64_precision_round_add": 15, "fp64_quantize_sign_compare": 1280, "int64_index_array_store": 1024, "fp64_center_multiply": 256, "fp64_center_add": 256, "fp64_filter_argument_subtract": 992, "fp64_filter_argument_add": 992, "fp64_filter_argument_multiply": 992, "fp64_abs": 992, "fp64_cubic_multiply": 2976, "fp64_cubic_add_sub": 2472, "fp64_weight_sum_add": 992, "fp64_weight_normalize_divide": 992, "fp64_quantize_multiply": 1280, "fp64_quantize_add": 1280, "float_to_integer_cast": 1280} |
| height_uint8_separable_convolution | 1 | 2285568 | 196608 | {"int32_multiply": 761856, "int32_add": 761856, "int32_rounding_bias_init": 196608, "int32_right_shift": 196608, "int32_clamp": 196608, "uint8_store": 196608} |
| CPU_reorder_and_regroup_alias | 1 | 0 | 0 | {} |
| fused_mean_std_cache_initialization | 1 | 24 | 48 | {"fp64_python_reciprocal": 2, "fp32_multiply": 6} |
| uint8_to_FP32 | 1 | 196608 | 786432 | {"uint8_to_fp32_cast": 196608} |
| normalize_subtract | 1 | 1572864 | 786432 | {"fp32_subtract": 196608} |
| normalize_divide_in_place | 1 | 1572864 | 786432 | {"fp32_divide": 196608} |
| patch_reshape_permute_expand_alias | 1 | 0 | 0 | {} |
| patch_flatten_materialization | 1 | 1572864 | 1572864 | {"fp32_element_copy": 393216} |
| grid_thw_tensor | 1 | 0 | 24 | {"int64_constant_store": 3} |
| vision_entry_FP32_to_BF16 | 1 | 1572864 | 786432 | {"fp32_to_bf16_cast": 393216} |
...
|---|---|---:|---:|---:|---:|---:|
| width | 32→256 | 5 | 992 | 14 | 10240 | 8192 |
| height | 32→256 | 5 | 992 | 14 | 10240 | 8192 |

## 独立状态与边界

- smart_resize_geometry: {"branch": "enlarge_min_area", "output_height": 256, "output_width": 256, "scope": "Named geometry special operations; integer shape/control arithmetic is not a machine-instruction claim"}
...
- width_coefficient_setup: {"coefficient_dtype": "FP64 then INT16 packed into same FP64 allocation", "allocated_buffer_bytes": 18432, "logical_buffer_traffic_status": "semantic totals include coefficient initialization, normalization and in-place INT16 repack; subfields explain included accesses", "coefficient_internal_reads_bytes": 26112, "coefficient_internal_rewrites_bytes": 7936}
- width_uint8_separable_convolution: {"input_pixel_reads_bytes": 95232, "int16_weight_reads_bytes": 190464, "input_dtype": "uint8", "weight_dtype": "int16", "accumulator_dtype": "int32", "output_dtype": "uint8", "intermediate_axis_order": "width then height; each pass rounds and clamps", "index_metadata_allocated_bytes": 8192, "metadata_load_count_status": "TensorIterator chunking-dependent; no guessed per-output HBM loads"}
- height_coefficient_setup: {"coefficient_dtype": "FP64 then INT16 packed into same FP64 allocation", "allocated_buffer_bytes": 18432, "logical_buffer_traffic_status": "semantic totals include coefficient initialization, normalization and in-place INT16 repack; subfields explain included accesses", "coefficient_internal_reads_bytes": 26112, "coefficient_internal_rewrites_bytes": 7936}
- height_uint8_separable_convolution: {"input_pixel_reads_bytes": 761856, "int16_weight_reads_bytes": 1523712, "input_dtype": "uint8", "weight_dtype": "int16", "accumulator_dtype": "int32", "output_dtype": "uint8", "intermediate_axis_order": "width then height; each pass rounds and clamps", "index_metadata_allocated_bytes": 8192, "metadata_load_count_status": "TensorIterator chunking-dependent; no guessed per-output HBM loads"}
...
- patch_flatten_materialization: {"unique_input_bytes": 786432, "materialized": true}
- grid_thw_tensor: {"output": [1, 16, 16]}
