...
已解码单张 4608×4608 HWC RGB uint8 → 4096×4096；grid=[1, 256, 256]，FP32 pixel_values=[65536, 1536]。

处理器输出 402653184 B；bf16 视觉入口 201326592 B。语义读/写 3169112920 / 1379745768 B；矩阵FLOPs=0。整数resize、FP32标量与转换各按原类别列示。

| 阶段 | 次数 | 语义读B | 语义写B | 实际列出的操作 |
|---|---:|---:|---:|---|
| smart_resize_geometry | 1 | 0 | 0 | {"python_round": 2, "python_sqrt": 1} |
| numpy_to_torch_alias | 1 | 0 | 0 | {} |
| HWC_to_CHW_contiguous | 1 | 63700992 | 63700992 | {"element_copy": 63700992} |
| CPU_group_unsqueeze_before_resize | 1 | 0 | 0 | {} |
| width_coefficient_setup | 1 | 524192 | 565200 | {"fp64_axis_scale_divide": 1, "fp64_support_multiply": 1, "fp64_axis_support_ceil": 1, "fp64_per_coordinate_inverse_scale_divide": 4096, "fp64_range_add_sub": 16384, "fp64_range_to_int64": 8192, "fp64_weight_max_compare": 22522, "fp64_precision_scale_multiply": 16, "fp64_precision_round_add": 16, "fp64_quantize_sign_compare": 28672, "int64_index_array_store": 16384, "fp64_center_multiply": 4096, "fp64_center_add": 4096, "fp64_filter_argument_subtract": 18426, "fp64_filter_argument_add": 18426, "fp64_filter_argument_multiply": 18426, "fp64_abs": 18426, "fp64_cubic_multiply": 55278, "fp64_cubic_add_sub": 46064, "fp64_weight_sum_add": 18426, "fp64_weight_normalize_divide": 18426, "fp64_quantize_multiply": 28672, "fp64_quantize_add": 28672, "float_to_integer_cast": 28672} |
| width_uint8_separable_convolution | 1 | 764163072 | 56623104 | {"int32_multiply": 254721024, "int32_add": 254721024, "int32_rounding_bias_init": 56623104, "int32_right_shift": 56623104, "int32_clamp": 56623104, "uint8_store": 56623104} |
| height_coefficient_setup | 1 | 524192 | 565200 | {"fp64_axis_scale_divide": 1, "fp64_support_multiply": 1, "fp64_axis_support_ceil": 1, "fp64_per_coordinate_inverse_scale_divide": 4096, "fp64_range_add_sub": 16384, "fp64_range_to_int64": 8192, "fp64_weight_max_compare": 22522, "fp64_precision_scale_multiply": 16, "fp64_precision_round_add": 16, "fp64_quantize_sign_compare": 28672, "int64_index_array_store": 16384, "fp64_center_multiply": 4096, "fp64_center_add": 4096, "fp64_filter_argument_subtract": 18426, "fp64_filter_argument_add": 18426, "fp64_filter_argument_multiply": 18426, "fp64_abs": 18426, "fp64_cubic_multiply": 55278, "fp64_cubic_add_sub": 46064, "fp64_weight_sum_add": 18426, "fp64_weight_normalize_divide": 18426, "fp64_quantize_multiply": 28672, "fp64_quantize_add": 28672, "float_to_integer_cast": 28672} |
| height_uint8_separable_convolution | 1 | 679256064 | 50331648 | {"int32_multiply": 226418688, "int32_add": 226418688, "int32_rounding_bias_init": 50331648, "int32_right_shift": 50331648, "int32_clamp": 50331648, "uint8_store": 50331648} |
| CPU_reorder_and_regroup_alias | 1 | 0 | 0 | {} |
| fused_mean_std_cache_initialization | 1 | 24 | 48 | {"fp64_python_reciprocal": 2, "fp32_multiply": 6} |
| uint8_to_FP32 | 1 | 50331648 | 201326592 | {"uint8_to_fp32_cast": 50331648} |
| normalize_subtract | 1 | 402653184 | 201326592 | {"fp32_subtract": 50331648} |
| normalize_divide_in_place | 1 | 402653184 | 201326592 | {"fp32_divide": 50331648} |
| patch_reshape_permute_expand_alias | 1 | 0 | 0 | {} |
| patch_flatten_materialization | 1 | 402653184 | 402653184 | {"fp32_element_copy": 100663296} |
| grid_thw_tensor | 1 | 0 | 24 | {"int64_constant_store": 3} |
| vision_entry_FP32_to_BF16 | 1 | 402653184 | 201326592 | {"fp32_to_bf16_cast": 100663296} |
...
|---|---|---:|---:|---:|---:|---:|
| width | 4608→4096 | 7 | 18426 | 15 | 229376 | 131072 |
| height | 4608→4096 | 7 | 18426 | 15 | 229376 | 131072 |

## 独立状态与边界

- smart_resize_geometry: {"branch": "shrink_max_area", "output_height": 4096, "output_width": 4096, "scope": "Named geometry special operations; integer shape/control arithmetic is not a machine-instruction claim"}
...
- width_coefficient_setup: {"coefficient_dtype": "FP64 then INT16 packed into same FP64 allocation", "allocated_buffer_bytes": 360448, "logical_buffer_traffic_status": "semantic totals include coefficient initialization, normalization and in-place INT16 repack; subfields explain included accesses", "coefficient_internal_reads_bytes": 524192, "coefficient_internal_rewrites_bytes": 147408}
- width_uint8_separable_convolution: {"input_pixel_reads_bytes": 254721024, "int16_weight_reads_bytes": 509442048, "input_dtype": "uint8", "weight_dtype": "int16", "accumulator_dtype": "int32", "output_dtype": "uint8", "intermediate_axis_order": "width then height; each pass rounds and clamps", "index_metadata_allocated_bytes": 131072, "metadata_load_count_status": "TensorIterator chunking-dependent; no guessed per-output HBM loads"}
- height_coefficient_setup: {"coefficient_dtype": "FP64 then INT16 packed into same FP64 allocation", "allocated_buffer_bytes": 360448, "logical_buffer_traffic_status": "semantic totals include coefficient initialization, normalization and in-place INT16 repack; subfields explain included accesses", "coefficient_internal_reads_bytes": 524192, "coefficient_internal_rewrites_bytes": 147408}
- height_uint8_separable_convolution: {"input_pixel_reads_bytes": 226418688, "int16_weight_reads_bytes": 452837376, "input_dtype": "uint8", "weight_dtype": "int16", "accumulator_dtype": "int32", "output_dtype": "uint8", "intermediate_axis_order": "width then height; each pass rounds and clamps", "index_metadata_allocated_bytes": 131072, "metadata_load_count_status": "TensorIterator chunking-dependent; no guessed per-output HBM loads"}
...
- patch_flatten_materialization: {"unique_input_bytes": 201326592, "materialized": true}
- grid_thw_tensor: {"output": [1, 256, 256]}
