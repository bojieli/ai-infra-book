...
已解码单张 640×640 HWC RGB uint8 → 640×640；grid=[1, 40, 40]，FP32 pixel_values=[1600, 1536]。

处理器输出 9830400 B；bf16 视觉入口 4915200 B。语义读/写 41779224 / 30720072 B；矩阵FLOPs=0。整数resize、FP32标量与转换各按原类别列示。

| 阶段 | 次数 | 语义读B | 语义写B | 实际列出的操作 |
|---|---:|---:|---:|---|
| smart_resize_geometry | 1 | 0 | 0 | {"python_round": 2, "python_sqrt": 0} |
| numpy_to_torch_alias | 1 | 0 | 0 | {} |
| HWC_to_CHW_contiguous | 1 | 1228800 | 1228800 | {"element_copy": 1228800} |
| CPU_group_unsqueeze_before_resize | 1 | 0 | 0 | {} |
| resize_identity_alias | 1 | 0 | 0 | {} |
| CPU_reorder_and_regroup_alias | 1 | 0 | 0 | {} |
| fused_mean_std_cache_initialization | 1 | 24 | 48 | {"fp64_python_reciprocal": 2, "fp32_multiply": 6} |
| uint8_to_FP32 | 1 | 1228800 | 4915200 | {"uint8_to_fp32_cast": 1228800} |
| normalize_subtract | 1 | 9830400 | 4915200 | {"fp32_subtract": 1228800} |
| normalize_divide_in_place | 1 | 9830400 | 4915200 | {"fp32_divide": 1228800} |
| patch_reshape_permute_expand_alias | 1 | 0 | 0 | {} |
| patch_flatten_materialization | 1 | 9830400 | 9830400 | {"fp32_element_copy": 2457600} |
| grid_thw_tensor | 1 | 0 | 24 | {"int64_constant_store": 3} |
| vision_entry_FP32_to_BF16 | 1 | 9830400 | 4915200 | {"fp32_to_bf16_cast": 2457600} |
...
|---|---|---:|---:|---:|---:|---:|
| identity | 尺寸相同，返回alias | 0 | 0 | — | 0 | 0 |

## 独立状态与边界

- smart_resize_geometry: {"branch": "round_to_factor", "output_height": 640, "output_width": 640, "scope": "Named geometry special operations; integer shape/control arithmetic is not a machine-instruction claim"}
...
- resize_identity_alias: {"materialized": false}
...
- patch_flatten_materialization: {"unique_input_bytes": 4915200, "materialized": true}
- grid_thw_tensor: {"output": [1, 40, 40]}
