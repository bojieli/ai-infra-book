...
|---|---:|---:|---:|---:|---:|---|
| 0 → 1 | 112 | 16,515,072 | 1.000898 | 0.330301 | 3.643316 | 是 |
| 1 → 2 | 164 | 24,182,784 | 0.711117 | 0.483656 | 5.330212 | 是 |
| 2 → 3 | 213 | 31,408,128 | 0.747389 | 0.628163 | 6.919788 | 是 |

保留策略只覆盖上次应用完成到下次发送之间的复用前缀。其 byte-seconds 不代表完整请求峰值或观测页寿命。取回要求预先知道下一次复用前缀；判断使用精确分数，表格小数仅用于展示。
...
```json
{
  "calculation": "sealed-trace-cache-lifecycle",
  "scenario": {
    "host_bytes_per_second": 50000000000,
    "remote_bytes_per_second": 5000000000,
    "lookup_ns": 10000
  },
  "trace_sources": [
    {
  ...
  "transitions": [
    {
      "previous_request": 0,
      "request": 1,
      "longest_common_token_prefix": 112,
      "reported_cached_tokens": 112,
      "reported_cached_tiers": {
        "device": 112,
        "host": 0
      },
      "recorded_application_gap_seconds_exact": "500449/500000000",
      "conditional_bf16_prefix_payload_bytes": 16515072,
      "conditional_retain_through_gap_byte_seconds_exact": "32284965888/1953125",
      "conditional_hbm_restore_payload_bytes": 0,
      "counterfactual_host_restore_seconds_exact": "16128/48828125",
      "counterfactual_remote_via_host_seconds_exact": "5692681/1562500000",
      "minimum_host_bytes_per_second_exact": "8257536000000000/500449",
      "remote_gap_after_lookup_and_h2d_seconds_exact": "8257457/12500000000",
      "minimum_remote_bytes_per_second_exact": "206438400000000000/8257457",
      "host_copy_fits_recorded_gap": true,
      "remote_copy_fits_recorded_gap": false,
      "cold_prefill_totals": {
        "matrix_flops": 2343395655680,
        "accounted_scalar_flops": 829996776,
        "special_ops": {
          "sin": 21504,
          "cos": 21504,
          "rsqrt": 254184,
          "negate": 89800704,
          "exp": 90671616,
          "compare_max": 16160256,
          "mask_decisions": 32514048
        },
        "known_interfaces": {
          "weight_read_once_per_operator_bytes": 15138187264,
          "activation_operand_read_bytes": 1527999360,
          "activation_operand_write_bytes": 1278931712,
          "kv_existing_history_unique_payload_bytes": 0,
          "kv_new_write_bytes": 24772608
        }
      },
      "warm_prefill_totals": {
      ...
      "observed_page_identity": null,
      "observed_page_lifetime": null,
      "observed_restore_bytes": null,
      "actual_restore_seconds": null
    },
    {
      "previous_request": 1,
      "request": 2,
      "longest_common_token_prefix": 164,
      "reported_cached_tokens": 164,
      "reported_cached_tiers": {
        "device": 164,
        "host": 0
      },
      "recorded_application_gap_seconds_exact": "711117/1000000000",
      "conditional_bf16_prefix_payload_bytes": 24182784,
      "conditional_retain_through_gap_byte_seconds_exact": "33587478144/1953125",
      "conditional_hbm_restore_payload_bytes": 0,
      "counterfactual_host_restore_seconds_exact": "23616/48828125",
      "counterfactual_remote_via_host_seconds_exact": "8328457/1562500000",
      "minimum_host_bytes_per_second_exact": "2686976000000000/79013",
      "remote_gap_after_lookup_and_h2d_seconds_exact": "5436533/25000000000",
      "minimum_remote_bytes_per_second_exact": "604569600000000000/5436533",
      "host_copy_fits_recorded_gap": true,
      "remote_copy_fits_recorded_gap": false,
      "cold_prefill_totals": {
        "matrix_flops": 3029658828800,
        "accounted_scalar_flops": 1096577601,
        "special_ops": {
          "sin": 27776,
          "cos": 27776,
          "rsqrt": 328321,
          "negate": 115992576,
          "exp": 123242112,
          "compare_max": 26998272,
          "mask_decisions": 54246528
        },
        "known_interfaces": {
          "weight_read_once_per_operator_bytes": 15138588672,
          "activation_operand_read_bytes": 2071657104,
          "activation_operand_write_bytes": 1749858560,
          "kv_existing_history_unique_payload_bytes": 0,
          "kv_new_write_bytes": 31997952
        }
      },
      "warm_prefill_totals": {
    ...
    },
    {
      "previous_request": 2,
      "request": 3,
      "longest_common_token_prefix": 213,
      "reported_cached_tokens": 213,
      "reported_cached_tiers": {
        "device": 213,
        "host": 0
      },
      "recorded_application_gap_seconds_exact": "747389/1000000000",
      "conditional_bf16_prefix_payload_bytes": 31408128,
      "conditional_retain_through_gap_byte_seconds_exact": "45847830816/1953125",
      "conditional_hbm_restore_payload_bytes": 0,
      "counterfactual_host_restore_seconds_exact": "30672/48828125",
      "counterfactual_remote_via_host_seconds_exact": "10812169/1562500000",
      "minimum_host_bytes_per_second_exact": "31408128000000000/747389",
      "remote_gap_after_lookup_and_h2d_seconds_exact": "2730661/25000000000",
      "minimum_remote_bytes_per_second_exact": "785203200000000000/2730661",
      "host_copy_fits_recorded_gap": true,
      "remote_copy_fits_recorded_gap": false,
      "cold_prefill_totals": {
        "matrix_flops": 3520713850880,
        "accounted_scalar_flops": 1293766236,
        "special_ops": {
          "sin": 32256,
          "cos": 32256,
          "rsqrt": 381276,
          "negate": 134701056,
          "exp": 148200192,
          "compare_max": 36433152,
          "mask_decisions": 73156608
        },
        "known_interfaces": {
          "weight_read_once_per_operator_bytes": 15138875392,
          "activation_operand_read_bytes": 2487079104,
          "activation_operand_write_bytes": 2113329920,
          "kv_existing_history_unique_payload_bytes": 0,
          "kv_new_write_bytes": 37158912
        }
      },
      "warm_prefill_totals": {
  ...
  "conditional_prefix_gap_byte_seconds_exact": "111720274848/1953125",
  "scope": [
