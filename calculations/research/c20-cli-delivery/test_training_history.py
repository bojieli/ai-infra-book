...
from training_history import calculate, verify_archives

PROJECT = Path('/Users/boj/book/ai-infra-book/calculations')
...
class HistoricalTests(unittest.TestCase):
    ...
    def test_duration_interpretations(self):
        ...
        self.assertEqual(maximum['calendar_lower_bound_days_exact'], maximum['conditional_constant_count_days_exact'])
