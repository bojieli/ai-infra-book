...
def _model(row):
    ...
    return dict(
        ...
        duration=dict(
            ...
            calendar_lower_bound_days_exact=_exact(days if maximum else None),
...
def calculate(project=None, comparisons=None, duration_scenarios=None, lifecycle=None):
    ...
    for record in [*models, *catalog.get('stage_reports', [])]:
    ...
    return dict(
        ...
        assumptions=[
            ...
            'Reported configurations require a constant-count assumption; reported maxima give lower bounds, not measured durations or dates.',
