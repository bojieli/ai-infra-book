...
from infra_calc.topics import v4_compressor_online as module
...
def main():
    ...
    deps += [
        BASE.parents[1]
        / "v4-compressor-training/public/src/infra_calc/topics/v4_compressor_training.py",
        BASE.parents[1]
        / "v4-compressor-overlap/public/src/infra_calc/topics/v4_compressor_overlap.py",
    ]
    import torch
