...
class ComparisonTests(unittest.TestCase):
    ...
    def test_one_byte_capacity_boundary(self):
        # GB values below are exact decimal strings converted by a test fixture
        # using integer GiB-aligned workload budgets, avoiding fractional GB.
