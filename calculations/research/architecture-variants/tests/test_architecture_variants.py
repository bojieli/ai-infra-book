...
MODULE = Path(__file__).resolve().parents[1] / "src/infra_calc/topics/architecture_variants.py"
spec = importlib.util.spec_from_file_location("architecture_variants_candidate", MODULE)
