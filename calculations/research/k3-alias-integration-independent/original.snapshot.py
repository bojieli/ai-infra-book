...
def calculate(batch: int = 1, tokens: int = 1, history: int = 8192) -> dict:
    ...
    return dict(schema_version=1, calculation='kimi-k3-kda-recurrent-ledger', model='kimi-k3',
                ...
                assumptions=[
                    ...
                    'Selected FLA revision is algorithm evidence, not a proven K3 release dependency. Its state_v_first API differs from K3 transpose_state_layout; compatibility is not claimed.',
