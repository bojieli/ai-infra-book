...
def calculate(
    ...
    return dict(
        ...
        scope=[
            ...
            "One logical unsharded model, tp=1; all matrix operators including Q/K/V/O, gate/up/down, QK/PV and all-position vocabulary head are counted. Nonmatrix arithmetic, KV copies and communication remain external.",
