...
| 资料 ID | 资料与本地原件 | 原清单章节 | 大纲主要引用 | 原件状态 |
| --- | --- | --- | --- | --- |
| `transformer` | [Attention Is All You Need](../references/files/papers/transformer.pdf) | 2 | 2 | 已归档 |
| `mqa` | [Fast Transformer Decoding: One Write-Head is All You Need](../references/files/papers/mqa.pdf) | 2,9 | 2 | 已归档 |
| `gqa` | [GQA: Training Generalized Multi-Query Transformer Models from Multi-Head Checkpoints](../references/files/papers/gqa.pdf) | 2,9 | 2 | 已归档 |
| `deepseek-moe` | [DeepSeekMoE: Towards Ultimate Expert Specialization in Mixture-of-Experts Language Models](../references/files/papers/deepseek-moe.pdf) | 2,10 | 2 | 已归档 |
| `deepseek-v2` | [DeepSeek-V2: A Strong, Economical, and Efficient Mixture-of-Experts Language Model](../references/files/papers/deepseek-v2.pdf) | 2,9 | 9 | 已归档 |
| `deepseek-v3` | [DeepSeek-V3 Technical Report](../references/files/papers/deepseek-v3.pdf) | 2,3,10,11,13 | 3,6,10,11 | 已归档 |
...
| `deepseek-v4` | [DeepSeek-V4: Towards Highly Efficient Million-Token Context Intelligence](../references/files/papers/deepseek-v4.pdf) | 2,3,10,11,13 | 2,3,6,7,9,10,11,12,13 | 已归档 |
| `kimi-k3` | [Kimi K3: Open Frontier Intelligence](../references/files/papers/kimi-k3.pdf) | 2,3,10,11,12 | 2,3,6,7,11,13 | 已归档 |
| `kimi-linear` | [Kimi Linear: An Expressive, Efficient Attention Architecture](../references/files/papers/kimi-linear.pdf) | 2,4,9 | 2 | 已归档 |
| `gated-delta` | [Gated Delta Networks: Improving Mamba2 with Delta Rule](../references/files/papers/gated-delta.pdf) | 2,4 | 2 | 已归档 |
| `mamba` | [Mamba: Linear-Time Sequence Modeling with Selective State Spaces](../references/files/papers/mamba.pdf) | 2 | 2 | 已归档 |
| `switch-transformer` | [Switch Transformers: Scaling to Trillion Parameter Models with Simple and Efficient Sparsity](../references/files/papers/switch-transformer.pdf) | 2,10,11 | 2 | 已归档 |
| `scaling-laws` | [Scaling Laws for Neural Language Models](../references/files/papers/scaling-laws.pdf) | 3,13 | 3,13 | 已归档 |
| `chinchilla` | [Training Compute-Optimal Large Language Models](../references/files/papers/chinchilla.pdf) | 3,13 | 3,13 | 已归档 |
| `qwen35-config` | [Qwen3.5-397B-A17B official configuration](../references/files/models/qwen35-config.json) | 2,3 | 2 | 已归档 |
| `qwen35-card` | [Qwen3.5-397B-A17B official model card](../references/files/models/qwen35-card.md) | 2,3 | 3 | 已归档 |
| `flashattention` | [FlashAttention: Fast and Memory-Efficient Exact Attention with IO-Awareness](../references/files/papers/flashattention.pdf) | 2,4,5 | 5 | 已归档 |
| `flashattention2` | [FlashAttention-2: Faster Attention with Better Parallelism and Work Partitioning](../references/files/papers/flashattention2.pdf) | 4,5 | 5 | 已归档 |
| `flashattention3` | [FlashAttention-3: Fast and Accurate Attention with Asynchrony and Low-precision](../references/files/papers/flashattention3.pdf) | 4,5 | 5 | 已归档 |
| `akg-pldi21` | [AKG: Automatic Kernel Generation for Neural Processing Units using Polyhedral Transformations](../references/files/papers/akg-pldi21.pdf) | 5 | 5 | 已归档 |
| `tvm` | [TVM: An Automated End-to-End Optimizing Compiler for Deep Learning](../references/files/papers/tvm.pdf) | 5 | 5 | 已归档 |
| `tensorir` | [TensorIR: An Abstraction for Automatic Tensorized Program Optimization](../references/files/papers/tensorir.pdf) | 5 | 5 | 已归档 |
| `isl-tutorial` | [Presburger Formulas and Polyhedral Compilation](../references/files/documents/isl-tutorial.pdf) | 5 | 5 | 已归档 |
...
| `roofline` | [Roofline: An Insightful Visual Performance Model for Floating-Point Programs and Multicore Architectures](../references/files/papers/roofline.pdf) | 1,4,13 | 1,4 | 已归档 |
| `hardware-lottery` | [The Hardware Lottery](../references/files/papers/hardware-lottery.pdf) | 1,13 | 2,13 | 已归档 |
| `tpu-v1` | [In-Datacenter Performance Analysis of a Tensor Processing Unit](../references/files/papers/tpu-v1.pdf) | 1,3,4,13 | 1,4,13 | 已归档 |
| `tpu-v4` | [TPU v4: An Optically Reconfigurable Supercomputer for Machine Learning with Hardware Support for Embeddings](../references/files/papers/tpu-v4.pdf) | 4,6,13 | 6 | 已归档 |
| `nvidia-v100` | [NVIDIA Tesla V100 GPU Architecture](../references/files/specs/nvidia-v100.pdf) | 4 | 4 | 已归档 |
| `nvidia-a100` | [NVIDIA A100 Tensor Core GPU Architecture](../references/files/specs/nvidia-a100.pdf) | 4 | 4 | 已归档 |
| `nvidia-h100` | [NVIDIA H100 Tensor Core GPU Architecture](../references/files/specs/nvidia-h100.pdf) | 4,6 | 4 | 已归档 |
| `nvidia-h100-spec` | [NVIDIA H100 Product Specifications](../references/files/specs/nvidia-h100-spec.html) | 4 | 1 | 已归档 |
...
| `nvidia-gb200` | [NVIDIA GB200 NVL72](../references/files/specs/nvidia-gb200.html) | 6,13 | 6,13 | 已归档 |
| `nvidia-rtx4090` | [NVIDIA GeForce RTX 4090 Specifications](../references/files/specs/nvidia-rtx4090.html) | 4,10,11 | 补充／版本参照 | 已归档 |
| `ascend-davinci` | [Communications of HUAWEI RESEARCH：昇腾架构论文所在期](../references/files/specs/ascend-davinci.pdf) | 4 | 4 | 已归档 |
| `ascend-c-guide` | [CANN 8.1.RC1.alpha002 Ascend C 算子开发指南](../references/files/specs/ascend-c-guide.pdf) | 4,5 | 4,5 | 已归档 |
...
| `mlx` | [MLX official README](../references/files/documents/mlx.md) | 5,8 | 5 | 已归档 |
...
| `nccl-guide` | [NCCL User Guide](../references/files/documents/nccl-guide.html) | 6,7 | 6,7 | 已归档 |
| `nccl-collectives` | [NCCL Collective Operations](../references/files/documents/nccl-collectives.html) | 6,7 | 6,7 | 已归档 |
| `ub-reflection` | [Unified Bus 背后的思考](../references/files/documents/ub-reflection.html) | 6,7,13 | 1,6,7,13 | 已归档 |
| `ub-spec-entry` | [Unified Bus Base Specification 2.0 Preview 官方入口](../references/files/specs/ub-spec-entry.html) | 6,7 | 补充／版本参照 | 仅入口 |
| `openurma` | [OpenURMA: A Clean-Room Open Implementation of the Unified Bus Protocol](../references/files/papers/openurma.pdf) | 6,7 | 7 | 已归档 |
...
| `rdma-guide` | [NVIDIA DOCA RDMA-Aware Networks Programming Guide](../references/files/documents/rdma-guide.html) | 7 | 7 | 已归档 |
| `dcqcn` | [Congestion Control for Large-Scale RDMA Deployments](../references/files/papers/dcqcn.pdf) | 7 | 7 | 已归档 |
| `timely` | [TIMELY: RTT-based Congestion Control for the Datacenter](../references/files/papers/timely.pdf) | 7 | 7 | 已归档 |
| `rfc9293` | [RFC 9293: Transmission Control Protocol](../references/files/standards/rfc9293.txt) | 7,8 | 8 | 已归档 |
| `rfc9000` | [RFC 9000: QUIC Transport](../references/files/standards/rfc9000.txt) | 8 | 8 | 已归档 |
| `rfc9002` | [RFC 9002: QUIC Loss Detection and Congestion Control](../references/files/standards/rfc9002.txt) | 8 | 8 | 已归档 |
| `rfc3550` | [RFC 3550: RTP](../references/files/standards/rfc3550.txt) | 8 | 8 | 已归档 |
| `rfc8831` | [RFC 8831: WebRTC Data Channels](../references/files/standards/rfc8831.txt) | 8,12 | 8 | 已归档 |
| `rfc8836` | [RFC 8836: Congestion Control Requirements for Interactive Real-Time Media](../references/files/standards/rfc8836.txt) | 8 | 8 | 已归档 |
| `whisper` | [Robust Speech Recognition via Large-Scale Weak Supervision](../references/files/papers/whisper.pdf) | 3,8 | 8 | 已归档 |
| `vits` | [Conditional Variational Autoencoder with Adversarial Learning for End-to-End Text-to-Speech](../references/files/papers/vits.pdf) | 3,8 | 8 | 已归档 |
| `network-golden-1` | [计算机网络的新黄金时代（一）](../references/files/documents/network-golden-1.html) | 1,6,7 | 1,6,7,12 | 已归档 |
| `network-golden-2` | [计算机网络的新黄金时代（二）](../references/files/documents/network-golden-2.html) | 8 | 3,8 | 已归档 |
| `network-golden-3` | [计算机网络的新黄金时代（三）](../references/files/documents/network-golden-3.html) | 4,8 | 8 | 已归档 |
| `vllm` | [Efficient Memory Management for Large Language Model Serving with PagedAttention](../references/files/papers/vllm.pdf) | 9,10 | 9 | 已归档 |
| `orca` | [Orca: A Distributed Serving System for Transformer-Based Generative Models](../references/files/papers/orca.pdf) | 9 | 9 | 已归档 |
| `sarathi-serve` | [Taming Throughput-Latency Tradeoff in LLM Inference with Sarathi-Serve](../references/files/papers/sarathi-serve.pdf) | 9 | 9 | 已归档 |
| `sglang` | [SGLang: Efficient Execution of Structured Language Model Programs](../references/files/papers/sglang.pdf) | 9,10 | 9,10 | 已归档 |
| `speculative-decoding` | [Fast Inference from Transformers via Speculative Decoding](../references/files/papers/speculative-decoding.pdf) | 9 | 9 | 已归档 |
| `flexgen` | [FlexGen: High-Throughput Generative Inference of Large Language Models with a Single GPU](../references/files/papers/flexgen.pdf) | 4,8,9 | 9 | 已归档 |
| `distserve` | [DistServe: Disaggregating Prefill and Decoding for Goodput-optimized Large Language Model Serving](../references/files/papers/distserve.pdf) | 10 | 10 | 已归档 |
| `splitwise` | [Splitwise: Efficient Generative LLM Inference Using Phase Splitting](../references/files/papers/splitwise.pdf) | 10,13 | 10 | 已归档 |
| `mooncake` | [Mooncake: A KVCache-centric Disaggregated Architecture for LLM Serving](../references/files/papers/mooncake.pdf) | 3,10 | 10 | 已归档 |
| `megatron` | [Megatron-LM: Training Multi-Billion Parameter Language Models Using Model Parallelism](../references/files/papers/megatron.pdf) | 11 | 6,7,11 | 已归档 |
| `megatron-scale` | [Efficient Large-Scale Language Model Training on GPU Clusters Using Megatron-LM](../references/files/papers/megatron-scale.pdf) | 11 | 11 | 已归档 |
| `zero` | [ZeRO: Memory Optimizations Toward Training Trillion Parameter Models](../references/files/papers/zero.pdf) | 11 | 11 | 已归档 |
| `gpipe` | [GPipe: Easy Scaling with Micro-Batch Pipeline Parallelism](../references/files/papers/gpipe.pdf) | 11 | 11 | 已归档 |
| `activation-recompute` | [Reducing Activation Recomputation in Large Transformer Models](../references/files/papers/activation-recompute.pdf) | 4,11 | 11 | 已归档 |
| `checkfreq` | [CheckFreq: Frequent, Fine-Grained DNN Checkpointing](../references/files/papers/checkfreq.pdf) | 11 | 11 | 已归档 |
| `verl` | [HybridFlow: A Flexible and Efficient RLHF Framework](../references/files/papers/verl.pdf) | 11,12 | 11 | 已归档 |
| `areal` | [AReaL: A Large-Scale Asynchronous Reinforcement Learning System for Language Reasoning](../references/files/papers/areal.pdf) | 11,12 | 11 | 已归档 |
| `gavel` | [Heterogeneity-Aware Cluster Scheduling Policies for Deep Learning Workloads](../references/files/papers/gavel.pdf) | 12 | 12 | 已归档 |
| `pollux` | [Pollux: Co-adaptive Cluster Scheduling for Goodput-Optimized Deep Learning](../references/files/papers/pollux.pdf) | 12 | 12 | 已归档 |
...
| `drf` | [Dominant Resource Fairness: Fair Allocation of Multiple Resource Types](../references/files/papers/drf.pdf) | 12 | 12 | 已归档 |
| `routellm` | [RouteLLM: Learning to Route LLMs from Preference Data](../references/files/papers/routellm.pdf) | 12 | 12 | 已归档 |
| `frugalgpt` | [FrugalGPT: How to Use Large Language Models While Reducing Cost and Improving Performance](../references/files/papers/frugalgpt.pdf) | 12 | 12 | 已归档 |
| `firecracker` | [Firecracker: Lightweight Virtualization for Serverless Applications](../references/files/papers/firecracker.pdf) | 12 | 12 | 已归档 |
...
| `opencost` | [OpenCost Specification](../references/files/documents/opencost.html) | 12 | 12 | 已归档 |
...
| `nvidia-blackwell-brief` | [NVIDIA Blackwell Architecture Technical Brief](../references/files/specs/nvidia-blackwell-brief.pdf) | 4,6 | 4 | 已归档 |
...
| `h100-vs-4090` | [A100/H100 太贵，何不用 4090？](../references/files/documents/h100-vs-4090.html) | 3,4,11 | 1,4,6,8,9,10,11,13 | 已归档 |
| `opentallas-readme` | [OpenTallas architecture and analysis](../references/files/documents/opentallas-readme.md) | 2,4,5,6,7,9,13 | 4,13 | 本地固定快照 |
| `kueue-clusterqueue` | [Kueue ClusterQueue](../references/files/documents/kueue-clusterqueue.html) | 12 | 12 | 已归档 |
| `kueue-preemption` | [Kueue Preemption](../references/files/documents/kueue-preemption.html) | 12 | 12 | 已归档 |
| `fat-tree` | [A Scalable, Commodity Data Center Network Architecture](../references/files/papers/fat-tree.pdf) | 7 | 7 | 已归档 |
| `collective-algorithms` | [Optimization of Collective Communication Operations in MPICH](../references/files/papers/collective-algorithms.pdf) | 6,7 | 6,7 | 已归档 |
...
| `lora` | [LoRA: Low-Rank Adaptation of Large Language Models](../references/files/papers/lora.pdf) | 3,4,11 | 11 | 已归档 |
| `qlora` | [QLoRA: Efficient Finetuning of Quantized LLMs](../references/files/papers/qlora.pdf) | 3,4,11 | 11 | 已归档 |
| `llama2` | [Llama 2: Open Foundation and Fine-Tuned Chat Models](../references/files/papers/llama2.pdf) | 2,3,9 | 3,11 | 已归档 |
| `llama3` | [The Llama 3 Herd of Models](../references/files/papers/llama3.pdf) | 2,3,5,10,11,13 | 3,11,13 | 已归档 |
...
| `groq-tsp` | [Think Fast: A Tensor Streaming Processor (TSP) for Accelerating Deep Learning Workloads](../references/files/papers/groq-tsp.pdf) | 4,13 | 4 | 已归档 |
...
| `cerebras-wse3-spec` | [Cerebras Wafer-Scale Engine 3 Datasheet](../references/files/specs/cerebras-wse3-spec.pdf) | 4,6,13 | 4 | 已归档 |
| `cerebras-cs4-spec` | [Cerebras CS-4 Datasheet](../references/files/specs/cerebras-cs4-spec.pdf) | 4,6,13 | 补充／版本参照 | 已归档 |
| `ub-base-201-zh` | [灵衢基础规范 2.0.1（中文版）](../references/files/specs/UB-Base-Specification-2.0.1-zh-clean.pdf) | 6,7,12 | 6,7 | 作者提供 |
| `ub-os-zh` | [灵衢使能操作系统参考设计 2.0（中文版）](../references/files/specs/UB-Software-Reference-Design-for-OS-2.0-zh.pdf) | 6,7,12 | 6,7,12 | 作者提供 |
...
| `google-tpu8` | [Inside the Eighth-Generation TPU: An Architecture Deep Dive](../references/files/specs/google-tpu8.html) | 4,6,7,13 | 4 | 已归档 |
| `google-tpu-generations` | [Google's Training Supercomputers from TPU v2 to Ironwood: Architectural Stability, Scale, Resilience, Power Efficiency, and Sustainability Across Five Generations](../references/files/papers/google-tpu-generations.pdf) | 4,6,11,13 | 4,6,13 | 已归档 |
...
| `graphcore-programming` | [IPU Programming Model](../references/files/documents/graphcore-programming.html) | 4,6 | 4 | 已归档 |
...
| `sambanova-sn40l-paper` | [SambaNova SN40L: Scaling the AI Memory Wall with Dataflow and Composition of Experts](../references/files/papers/sambanova-sn40l-paper.pdf) | 4,6,9,12,13 | 4 | 已归档 |
...
| `nvidia-rubin-system` | [NVIDIA Vera Rubin NVL72 Specifications](../references/files/specs/nvidia-rubin-system.html) | 4,6,13 | 4 | 已归档 |
| `nvidia-nvlink-spec` | [NVIDIA NVLink and NVLink Switch Specifications](../references/files/specs/nvidia-nvlink-spec.html) | 6 | 6,7 | 已归档 |
...
| `cloudmatrix384-v2` | [Serving Large Language Models on Huawei CloudMatrix384, v2](../references/files/papers/cloudmatrix384-v2.pdf) | 4,5,6,9,10,11,13 | 4,5,6,13 | 已归档 |
...
| `nvidia-hopper-tuning` | [NVIDIA Hopper Tuning Guide](../references/files/documents/nvidia-hopper-tuning.html) | 4,5 | 4,5 | 已归档 |
...
| `cuda-graphs` | [CUDA Graph Best Practice for PyTorch: CUDA Graph](../references/files/documents/cuda-graphs.html) | 5,9,11 | 5 | 已归档 |
| `vllm-cuda-graphs` | [vLLM CUDA Graphs Design](../references/files/documents/vllm-cuda-graphs.html) | 5,9 | 5,9 | 已归档 |
...
| `triton-matmul` | [Triton Tutorial: Matrix Multiplication](../references/files/documents/triton-matmul.html) | 5 | 5 | 已归档 |
| `ascend-950-official` | [昇腾 950 NPU 架构白皮书（官方下载原件）](../references/files/specs/ascend-950-official.pdf) | 4,5,6,7,10,13 | 4,6,7 | 已归档 |
| `apple-m2-pro-max` | [Apple M2 Pro and M2 Max launch specifications](../references/files/specs/apple-m2-pro-max.html) | 4,8,9 | 4,8,9 | 已归档 |
| `apple-metal-memory` | [Choosing a resource storage mode for Apple GPUs — DocC JSON](../references/files/documents/apple-metal-memory.json) | 4,5 | 4 | 已归档 |
| `apple-gpu-architecture` | [Explore the architecture of Apple GPUs — WWDC20](../references/files/documents/apple-gpu-architecture.html) | 4,5 | 4 | 已归档 |
| `nvidia-rtx-pro6000-spec` | [RTX PRO 6000 Blackwell Workstation Edition Datasheet](../references/files/specs/nvidia-rtx-pro6000-spec.pdf) | 4,9 | 4,8,9 | 已归档 |
| `nvidia-rtx-blackwell-pro` | [NVIDIA RTX Blackwell PRO GPU Architecture v1.0](../references/files/specs/nvidia-rtx-blackwell-pro.pdf) | 4,5 | 4 | 已归档 |
| `ollama-hardware` | [Ollama Hardware support](../references/files/documents/ollama-hardware.html) | 5,9 | 补充／版本参照 | 已归档 |
| `ollama-api-generate` | [Ollama Generate API](../references/files/documents/ollama-api-generate.md) | 5,9 | 9 | 已归档 |
| `ollama-metal-device` | [Ollama v0.20.7 Apple device and working-set discovery](../references/files/documents/ollama-metal-device.txt) | 5,9 | 5 | 已归档 |
| `kt-kernel-guide` | [KT-Kernel inference README — fixed revision](../references/files/documents/kt-kernel-guide.md) | 5,9,10 | 10 | 已归档 |
| `kt-amx` | [KTransformers 0.3 AMX design notes](../references/files/documents/kt-amx.md) | 4,5,10 | 5,10 | 已归档 |
| `ktransformers-paper` | [KTransformers: Unleashing the Full Potential of CPU/GPU Hybrid Inference for MoE Models](../references/files/papers/ktransformers-paper.pdf) | 5,9,10 | 10 | 已归档 |
| `nvidia-a100-80-spec` | [NVIDIA A100 80GB datasheet — December 2020](../references/files/specs/nvidia-a100-80-spec.pdf) | 4,10 | 10 | 已归档 |
| `nvidia-h20-vgpu` | [NVIDIA AI Enterprise 6.2 supported H20 SXM5 configurations](../references/files/specs/nvidia-h20-vgpu.html) | 4,10 | 10 | 已归档 |
...
| `heterogeneous-pd` | [Demystifying the Design Space and Best Practices for Heterogeneous LLM Inference and Serving](../references/files/papers/heterogeneous-pd.pdf) | 10 | 10 | 已归档 |
| `ollama-ggml-metal-memory` | [Ollama v0.20.7 bundled ggml Metal device and buffers](../references/files/documents/ollama-ggml-metal-memory.txt) | 5,9 | 5 | 已归档 |
| `ollama-ggml-metal-kernels` | [Ollama v0.20.7 bundled ggml Metal kernels](../references/files/documents/ollama-ggml-metal-kernels.txt) | 4,5,9 | 4,5 | 已归档 |
...
| `scaling-inference` | [Efficiently Scaling Transformer Inference](../references/files/papers/scaling-inference.pdf) | 3,4,10,13 | 10,13 | 已归档 |
| `deepspeed-inference` | [DeepSpeed Inference: Enabling Efficient Inference of Transformer Models at Unprecedented Scale](../references/files/papers/deepspeed-inference.pdf) | 5,9,10 | 10 | 已归档 |
...
| `kivi` | [KIVI: A Tuning-Free Asymmetric 2bit Quantization for KV Cache](../references/files/papers/kivi.pdf) | 5,9 | 9 | 已归档 |
| `h2o` | [H$_2$O: Heavy-Hitter Oracle for Efficient Generative Inference of Large Language Models](../references/files/papers/h2o.pdf) | 9 | 9 | 已归档 |
| `streamingllm` | [Efficient Streaming Language Models with Attention Sinks](../references/files/papers/streamingllm.pdf) | 2,9 | 9 | 已归档 |
| `speculative-sampling` | [Accelerating Large Language Model Decoding with Speculative Sampling](../references/files/papers/speculative-sampling.pdf) | 9 | 9 | 已归档 |
...
| `eagle3` | [EAGLE-3: Scaling up Inference Acceleration of Large Language Models via Training-Time Test](../references/files/papers/eagle3.pdf) | 9 | 9 | 已归档 |
| `preble` | [Preble: Efficient Distributed Prompt Scheduling for LLM Serving](../references/files/papers/preble.pdf) | 10 | 10 | 已归档 |
| `lmcache` | [LMCache: An Efficient KV Cache Layer for Enterprise-Scale LLM Inference](../references/files/papers/lmcache.pdf) | 9,10 | 9,10 | 已归档 |
| `s-lora` | [S-LoRA: Serving Thousands of Concurrent LoRA Adapters](../references/files/papers/s-lora.pdf) | 9,12 | 12 | 已归档 |
| `alpaserve` | [AlpaServe: Statistical Multiplexing with Model Parallelism for Deep Learning Serving](../references/files/papers/alpaserve.pdf) | 10,12 | 12 | 已归档 |
...
| `qwen3` | [Qwen3 Technical Report](../references/files/papers/qwen3.pdf) | 2,3,13 | 2,3 | 已归档 |
| `mixtral` | [Mixtral of Experts](../references/files/papers/mixtral.pdf) | 2,10 | 补充／版本参照 | 已归档 |
| `deepseek-r1` | [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](../references/files/papers/deepseek-r1.pdf) | 3,11,13 | 3,11 | 已归档 |
| `test-time-compute` | [Scaling LLM Test-Time Compute Optimally can be More Effective than Scaling Model Parameters](../references/files/papers/test-time-compute.pdf) | 3,13 | 3,13 | 已归档 |
| `deepseek-infra` | [Insights into DeepSeek-V3: Scaling Challenges and Reflections on Hardware for AI Architectures](../references/files/papers/deepseek-infra.pdf) | 6,10,13 | 7,10 | 已归档 |
...
| `bojieli-phd-thesis` | [基于可编程网卡的高性能数据中心系统](../references/files/papers/bojieli-phd-thesis.pdf) | 1,4,5,7,13 | 1,7,13 | 作者提供 |
| `logicfolding-energy` | [Huawei’s τ Chip Was Supposed to Melt?](../references/files/papers/202609.00031v1.pdf) | 1,4,13 | 13 | 作者提供 |
...
| `beyond-chinchilla-v1` | [Beyond Chinchilla-Optimal，arXiv v1](../references/outline-checks/2026-09-07/beyond-chinchilla-v1.html) | 新增 | 3 | 已归档 |
...
| `rfc9001` | [RFC 9001](../references/outline-checks/2026-09-07/rfc9001.txt) | 新增 | 8 | 已归档 |
| `rfc9221` | [RFC 9221](../references/outline-checks/2026-09-07/rfc9221.txt) | 新增 | 8 | 已归档 |
| `beyond-chinchilla-icml24` | [Beyond Chinchilla-Optimal，ICML 2024 正式全文](../references/outline-checks/2026-09-07/beyond-chinchilla-icml24.pdf) | 新增 | 3,13 | 已归档 |
| `llama1-v1` | [LLaMA 原始技术报告 v1](../references/outline-checks/2026-09-07/scaling-history/llama1-v1.pdf) | 补充 | 2,3 | 已归档；固定快照 |
| `qwen25-v2` | [Qwen2.5 技术报告 v2](../references/outline-checks/2026-09-07/scaling-history/qwen25-v2.pdf) | 补充 | 3 | 已归档；固定快照 |
| `llama31-card` | [Llama 3.1 官方模型卡](../references/outline-checks/2026-09-07/scaling-history/llama31-card.md) | 补充 | 3 | 已归档；固定快照 |
| `qwen35-blog` | [Qwen3.5 官方发布与训练说明](../references/outline-checks/2026-09-07/scaling-history/qwen35-blog.html) | 补充 | 3 | 已归档；固定快照 |
| `kimi-k15-v4` | [Kimi k1.5 report v4](../references/outline-checks/2026-09-07/scaling-history/kimi-k15-v4.pdf) | 补充 | 历史备查；RL 主例已改为 V4 | 已归档；固定快照 |
| `jeff-dean-ladis2009` | [Jeff Dean LADIS 2009 original slides (Columbia mirror)](../references/outline-checks/2026-09-07/scaling-history/jeff-dean-ladis2009.pdf) | 补充 | 1 | 已归档；固定快照 |
| `qwen3-8b-config` | [qwen3-8b official configuration at b968826d9c46dd6066d109eabc6255188de91218](../references/outline-checks/2026-09-07/scaling-history/qwen3-8b-config.json) | 补充 | 2,6 | 已归档；固定快照 |
| `deepseek-v4-flash-config` | [deepseek-v4-flash official configuration at 60d8d70770c6776ff598c94bb586a859a38244f1](../references/outline-checks/2026-09-07/scaling-history/deepseek-v4-flash-config.json) | 补充 | 配套核对／实现参照 | 已归档；固定快照 |
| `deepseek-v4-flash-config.json` | [deepseek-v4-flash reference inference/config.json](../references/outline-checks/2026-09-07/scaling-history/deepseek-v4-flash-inference-config.json) | 补充 | 2 | 已归档；固定快照 |
| `deepseek-v4-flash-model.py` | [deepseek-v4-flash reference inference/model.py](../references/outline-checks/2026-09-07/scaling-history/deepseek-v4-flash-inference-model.py) | 补充 | 2,5 | 已归档；固定快照 |
| `vllm-qwen3` | [vLLM qwen3 model implementation at 58ad1f3b8973b23943107b51230d594050b42ec3](../references/outline-checks/2026-09-07/scaling-history/vllm-qwen3.py) | 补充 | 2,5 | 已归档；固定快照 |
| `vllm-deepseek_v2` | [vLLM deepseek_v2 model implementation at 58ad1f3b8973b23943107b51230d594050b42ec3](../references/outline-checks/2026-09-07/scaling-history/vllm-deepseek_v2.py) | 补充 | 配套核对／实现参照 | 已归档；固定快照 |
| `vllm-qwen2` | [vLLM Qwen2 MLP implementation reused by Qwen3](../references/outline-checks/2026-09-07/scaling-history/vllm-qwen2.py) | 补充 | 配套核对／实现参照 | 已归档；固定快照 |
| `qwen3-235b-config` | [Qwen3-235B-A22B official configuration](../references/outline-checks/2026-09-07/scaling-history/qwen3-235b-config.json) | 补充 | 2,6 | 已归档；固定快照 |
| `a800-lenovo` | [ThinkSystem A800 PCIe product guide](../references/outline-checks/2026-09-07/systems-cases/a800-lenovo.pdf) | 补充 | 11 | 已归档；固定快照 |
| `nvidia-hgx` | [NVIDIA HGX platform specifications](../references/outline-checks/2026-09-07/systems-cases/nvidia-hgx.html) | 补充 | 11 | 已归档；固定快照 |
| `eagle31` | [EAGLE 3.1 — EAGLE, vLLM, TorchSpec teams](../references/outline-checks/2026-09-07/systems-cases/eagle31.html) | 补充 | 9 | 已归档；固定快照 |
| `dflash-paper` | [DFlash paper v1](../references/outline-checks/2026-09-07/systems-cases/dflash-paper.pdf) | 补充 | 9 | 已归档；固定快照 |
| `dflash2` | [DFlash 2 — Inco AI](../references/outline-checks/2026-09-07/systems-cases/dflash2.html) | 补充 | 9 | 已归档；固定快照 |
| `mimo-tilert` | [Xiaomi MiMo V2.5 Pro — FP4 and DFlash](../references/outline-checks/2026-09-07/systems-cases/mimo-tilert.html) | 补充 | 9 | 已归档；固定快照 |
| `kt-v4` | [KTransformers V4 Flash tutorial — fixed revision](../references/outline-checks/2026-09-07/systems-cases/kt-v4.md) | 补充 | 10 | 已归档；固定快照 |
| `kt-kimi2` | [KTransformers Kimi K2 tutorial — fixed revision](../references/outline-checks/2026-09-07/systems-cases/kt-kimi2.md) | 补充 | 10 | 已归档；固定快照 |
| `kt-sft` | [KTransformers fine tuning cookbook — fixed revision](../references/outline-checks/2026-09-07/systems-cases/kt-sft.md) | 补充 | 11 | 已归档；固定快照 |
| `qwen235-gguf-metadata` | [Unsloth Qwen3-235B GGUF file metadata](../references/outline-checks/2026-09-07/systems-cases/qwen235-gguf-metadata.json) | 补充 | 9 | 已归档；固定快照 |
...
| `r1-gguf-readme` | [unsloth/DeepSeek-R1-GGUF model card at 4dab99fdb3fea560e5a402b49c6ef11e025321a8](../references/outline-checks/2026-09-07/systems-cases/r1-gguf-readme.md) | 补充 | 9 | 已归档；固定快照 |
| `apple-m3-evolution` | [Apple M3 GPU local-memory allocation](../references/outline-checks/2026-09-07/systems-cases/apple-m3-evolution.html) | 补充 | 4 | 已归档；固定快照 |
| `apple-m5-evolution` | [Apple M5 GPU Neural Accelerators](../references/outline-checks/2026-09-07/systems-cases/apple-m5-evolution.html) | 补充 | 4 | 已归档；固定快照 |
...
| `cutlass-blackwell` | [CUTLASS SM100 and SM120 distinctions](../references/outline-checks/2026-09-07/systems-cases/cutlass-blackwell.html) | 补充 | 4 | 已归档；固定快照 |
| `rubin-rechecked` | [Rubin architecture official article — rechecked](../references/outline-checks/2026-09-07/systems-cases/rubin-rechecked.html) | 补充 | 4 | 已归档；固定快照 |
...
| `raw-huawei-pro` | [华为：使用专业模式拍摄](../references/outline-checks/2026-09-07/edge-media/huawei-pro-raw.html) | 补充 | 8 | 已归档；固定快照 |
| `raw-adobe-indigo` | [Adobe Research：Project Indigo 图像处理路径](../references/outline-checks/2026-09-07/edge-media/adobe-indigo.html) | 补充 | 8 | 已归档；固定快照 |
| `raw-adobe-dng-compression` | [Adobe：DNG Pros, Cons and Myths](../references/outline-checks/2026-09-07/edge-media/adobe-dng-compression.html) | 补充 | 8 | 已归档；固定快照 |
| `edge-http3-rfc9114` | [RFC 9114：HTTP/3](../references/outline-checks/2026-09-07/edge-media/rfc9114.txt) | 补充 | 8 | 已归档；固定快照 |
| `model-linear-transformer` | [Linear Transformers：作者项目说明](../references/outline-checks/2026-09-07/edge-media/linear-transformers.html) | 补充 | 2 | 已归档；固定快照 |
...
| `accounting-kimi-k3-config-json` | [kimi-k3-config.json](../references/outline-checks/2026-09-07/model-accounting/kimi-k3-config.json) | 补充 | 2 | 已归档；固定快照 |
| `accounting-kimi-k3-modeling_kimi_linear-py` | [Kimi K3 modeling_kimi_linear.py](../references/outline-checks/2026-09-07/model-accounting/kimi-k3-modeling_kimi_linear.py) | 补充 | 2 | 已归档；固定快照 |
...
| `claude-api-pricing-20260907` | [Claude API 计价，2026-09-07 快照](../references/outline-checks/2026-09-07/platform-routing/claude-api-pricing.html) | 补充 | 12 | 已归档；固定快照 |
| `claude-plans-20260907` | [Claude 订阅方案，2026-09-07 快照](../references/outline-checks/2026-09-07/platform-routing/claude-plans.html) | 补充 | 12 | 已归档；固定快照 |
| `claude-prompt-cache` | [Claude：Prompt caching](../references/outline-checks/2026-09-07/platform-routing/claude-prompt-cache.html) | 补充 | 12 | 已归档；固定快照 |
| `claude-subscription-api` | [Claude：订阅与 API 分开计费](../references/outline-checks/2026-09-07/platform-routing/claude-subscription-api.html) | 补充 | 12 | 已归档；固定快照 |
| `e2b-infra-architecture` | [E2B infra 架构，固定提交 1f34e5d6c822](../references/outline-checks/2026-09-07/platform-routing/e2b-architecture.md) | 补充 | 12 | 已归档；固定快照 |
...
| `e2b-persistence` | [E2B：Sandbox persistence](../references/outline-checks/2026-09-07/platform-routing/e2b-persistence.html) | 补充 | 12 | 已归档；固定快照 |
| `e2b-sandbox` | [E2B：Sandbox](../references/outline-checks/2026-09-07/platform-routing/e2b-sandbox.html) | 补充 | 12 | 已归档；固定快照 |
| `e2b-snapshots` | [E2B：Snapshots](../references/outline-checks/2026-09-07/platform-routing/e2b-snapshots.html) | 补充 | 12 | 已归档；固定快照 |
| `gemini-api-pricing-20260907` | [Gemini API 计价，2026-09-07 快照](../references/outline-checks/2026-09-07/platform-routing/gemini-api-pricing.html) | 补充 | 12 | 已归档；固定快照 |
| `gemini-cache` | [Gemini：Context caching](../references/outline-checks/2026-09-07/platform-routing/gemini-cache.html) | 补充 | 12 | 已归档；固定快照 |
| `google-ai-plans-20260907` | [Google AI 订阅方案，2026-09-07 快照](../references/outline-checks/2026-09-07/platform-routing/google-ai-plans.html) | 补充 | 12 | 已归档；固定快照 |
| `scheduling-asi26` | [ASI：异构生产 AI 集群与 SpotGPU，OSDI 2026](../references/outline-checks/2026-09-07/platform-routing/asi-osdi26.pdf) | 补充 | 12 | 已归档；固定快照 |
| `scheduling-distrs26` | [DistRS，NSDI 2026](../references/outline-checks/2026-09-07/platform-routing/distrs-nsdi26.pdf) | 补充 | 12 | 已归档；固定快照 |
| `scheduling-rlboost26` | [RLBoost，NSDI 2026](../references/outline-checks/2026-09-07/platform-routing/rlboost-nsdi26.pdf) | 补充 | 12 | 已归档；固定快照 |
| `scheduling-specbox-v2` | [SpecBox，arXiv v2，2026-08-05](../references/outline-checks/2026-09-07/platform-routing/specbox-v2.html) | 补充 | 12 | 已归档；固定快照 |
| `ansor-osdi20` | [Ansor，OSDI 2020](../references/outline-checks/2026-09-07/execution-feedback/ansor.pdf) | 补充 | 5 | 已归档；固定快照 |
| `cuda-agent26` | [CUDA Agent，2026 v1](../references/outline-checks/2026-09-07/execution-feedback/cuda-agent.pdf) | 补充 | 5 | 已归档；固定快照 |
| `flashinfer-bench26` | [FlashInfer-Bench，2026 v1](../references/outline-checks/2026-09-07/execution-feedback/flashinfer-bench.html) | 补充 | 5 | 已归档；固定快照 |
| `kernelagent26` | [KernelAgent：基于硬件反馈的自动优化，2026-03](../references/outline-checks/2026-09-07/execution-feedback/kernelagent.html) | 补充 | 5 | 已归档；固定快照 |
| `megascale-infer25` | [MegaScale-Infer，2025 v1](../references/outline-checks/2026-09-07/execution-feedback/megascale-infer.pdf) | 补充 | 10 | 已归档；固定快照 |
| `megatron-moe26` | [Scalable Training of MoE with Megatron Core，2026 v1](../references/outline-checks/2026-09-07/execution-feedback/megatron-moe26.html) | 补充 | 11 | 已归档；固定快照 |
| `mpk26-v2` | [MPK，2026-06 v2](../references/outline-checks/2026-09-07/execution-feedback/mpk-v2.html) | 补充 | 5 | 已归档；固定快照 |
| `nanoflow-osdi25` | [NanoFlow，OSDI 2025](../references/outline-checks/2026-09-07/execution-feedback/nanoflow.pdf) | 补充 | 9 | 已归档；固定快照 |
| `nemo-automodel-r3` | [NeMo AutoModel：离散路由重放与梯度](../references/outline-checks/2026-09-07/execution-feedback/nemo-automodel-replay.html) | 补充 | 11 | 已归档；固定快照 |
| `nemo-r3-guide26` | [NeMo RL Router Replay 官方实现文档快照](../references/outline-checks/2026-09-07/execution-feedback/nemo-router-replay.html) | 补充 | 11 | 已归档；固定快照 |
| `r3-router25-v2` | [Stabilizing MoE RL by Aligning Training and Inference Routers，v2](../references/outline-checks/2026-09-07/execution-feedback/routing-replay.html) | 补充 | 11 | 已归档；固定快照 |
| `sglang-ep26` | [SGLang EP、重叠与 EPLB](../references/outline-checks/2026-09-07/execution-feedback/sglang-ep.html) | 补充 | 10 | 已归档；固定快照 |
| `sglang-hicache26` | [SGLang HiCache 官方实现](../references/outline-checks/2026-09-07/execution-feedback/sglang-hicache.html) | 补充 | 10 | 已归档；固定快照 |
| `tensorrt-quickstart26` | [TensorRT Quick Start Guide](../references/outline-checks/2026-09-07/execution-feedback/tensorrt-quickstart.html) | 补充 | 9 | 已归档；固定快照 |
| `trtllm-overview26` | [TensorRT-LLM Overview](../references/outline-checks/2026-09-07/execution-feedback/trtllm-overview.html) | 补充 | 9 | 已归档；固定快照 |
| `tvm-meta-schedule26` | [TVM MetaSchedule 官方调优文档](../references/outline-checks/2026-09-07/execution-feedback/tvm-meta-schedule.html) | 补充 | 5 | 已归档；固定快照 |
| `verl-overview26` | [verl 官方文档与后端入口](../references/outline-checks/2026-09-07/execution-feedback/verl-overview.html) | 补充 | 11 | 已归档；固定快照 |
| `vllm-dbo26` | [vLLM Dual Batch Overlap](../references/outline-checks/2026-09-07/execution-feedback/vllm-dbo.html) | 补充 | 10 | 已归档；固定快照 |
| `vllm-ep26` | [vLLM Expert Parallel Deployment](../references/outline-checks/2026-09-07/execution-feedback/vllm-ep.html) | 补充 | 10 | 已归档；固定快照 |
| `vllm-graphs26` | [vLLM CUDA Graphs design](../references/outline-checks/2026-09-07/execution-feedback/vllm-graphs.html) | 补充 | 5,9 | 已归档；固定快照 |
| `ollama-mlx-2026` | [Ollama MLX 预览，2026-03](../references/outline-checks/2026-09-07/framework-evolution/ollama-mlx.html) | 补充 | 5,9 | 已归档；固定快照 |
| `ollama-mtp-2026` | [Ollama MLX 多 token 预测，2026-06](../references/outline-checks/2026-09-07/framework-evolution/ollama-mtp.html) | 补充 | 5,9 | 已归档；固定快照 |
| `ollama-multimodal-2025` | [Ollama 多模态执行引擎，2025-05](../references/outline-checks/2026-09-07/framework-evolution/ollama-multimodal.html) | 补充 | 8 | 已归档；固定快照 |
| `ollama-schedule-2025` | [Ollama 新内存调度，2025-09](../references/outline-checks/2026-09-07/framework-evolution/ollama-scheduling.html) | 补充 | 9 | 已归档；固定快照 |
| `ollama-stream-tool-2025` | [Ollama 流式工具调用，2025-05](../references/outline-checks/2026-09-07/framework-evolution/ollama-stream-tool.html) | 补充 | 8,12 | 已归档；固定快照 |
| `sglang-graph-2026` | [SGLang Advanced CUDA Graph，2026-08](../references/outline-checks/2026-09-07/framework-evolution/sglang-graphs.html) | 补充 | 5,9 | 已归档；固定快照 |
| `sglang-hicache-2025` | [SGLang HiCache，2025-09](../references/outline-checks/2026-09-07/framework-evolution/sglang-hicache.html) | 补充 | 10 | 已归档；固定快照 |
| `sglang-hisparse-2026` | [SGLang HiSparse，2026-04](../references/outline-checks/2026-09-07/framework-evolution/sglang-hisparse.html) | 补充 | 10 | 已归档；固定快照 |
| `sglang-unified-cache-2026` | [SGLang Unified Radix Cache，2026-08](../references/outline-checks/2026-09-07/framework-evolution/sglang-unified-cache.html) | 补充 | 9,10 | 已归档；固定快照 |
| `sglang-v04-2024` | [SGLang v0.4，2024-12](../references/outline-checks/2026-09-07/framework-evolution/sglang-v04.html) | 补充 | 9 | 已归档；固定快照 |
| `vllm-afd-2026` | [vLLM AFD Plugin，2026-07](../references/outline-checks/2026-09-07/framework-evolution/vllm-afd.html) | 补充 | 10 | 已归档；固定快照 |
| `vllm-sleep-2026` | [vLLM Sleep Mode 官方文档快照](../references/outline-checks/2026-09-07/framework-evolution/vllm-sleep.html) | 补充 | 11 | 已归档；固定快照 |
| `vllm-v1-2025` | [vLLM V1 架构与当前指南](../references/outline-checks/2026-09-07/framework-evolution/vllm-v1.html) | 补充 | 9,11 | 已归档；固定快照 |
| `vllm-wide-ep-2025` | [vLLM 大规模服务，2025-12](../references/outline-checks/2026-09-07/framework-evolution/vllm-wide-ep.html) | 补充 | 10 | 已归档；固定快照 |
| `mlsys2024-054de805fcceb78a201f5e9d53c85908` | [Punica: Multi-Tenant LoRA Serving](../references/proceedings/MLSys/2024/papers/mlsys2024-054de805fcceb78a201f5e9d53c85908.pdf) | 补充 | 9 | 已归档；固定快照 |
| `mlsys2024-906419cd502575b617cc489a1a696a67` | [SLoRA: Scalable Serving of Thousands of LoRA Adapters](../references/proceedings/MLSys/2024/papers/mlsys2024-906419cd502575b617cc489a1a696a67.pdf) | 补充 | 9 | 已归档；固定快照 |
| `sglang-lora` | [SGLang LoRA Serving](../references/framework-history/2026-09-07/lora/sglang-lora.html) | 补充 | 9 | 已归档；固定快照 |
...
| `vllm-lora` | [vLLM LoRA document at fixed revision](../references/framework-history/2026-09-07/lora/vllm-lora.md) | 补充 | 9 | 已归档；固定快照 |
| `mlsys2025-26289c647c6828e862e271ca3c490486` | [Rethinking Key-Value Cache Compression Techniques for Large Language Model Serving](../references/proceedings/MLSys/2025/papers/mlsys2025-26289c647c6828e862e271ca3c490486.pdf) | 补充 | 9 | 已归档；固定快照 |
| `mlsys2025-270339c997293ca2988c62f4308e389f` | [Rubick: Exploiting Job Reconfigurability for Deep Learning Cluster Scheduling](../references/proceedings/MLSys/2025/papers/mlsys2025-270339c997293ca2988c62f4308e389f.pdf) | 补充 | 12 | 已归档；固定快照 |
| `mlsys2025-7c180af017258d239bac6248d1eb26ac` | [Marconi: Prefix Caching for the Era of Hybrid LLMs](../references/proceedings/MLSys/2025/papers/mlsys2025-7c180af017258d239bac6248d1eb26ac.pdf) | 补充 | 9 | 已归档；固定快照 |
| `mlsys2025-dbf02b21d77409a2db30e56866a8ab3a` | [FlashInfer: Efficient and Customizable Attention Engine for LLM Inference Serving](../references/proceedings/MLSys/2025/papers/mlsys2025-dbf02b21d77409a2db30e56866a8ab3a.pdf) | 补充 | 5 | 已归档；固定快照 |
| `flashinfer-attention-api-20260907` | [FlashInfer Attention API — retrieved 2026-09-07](../references/framework-history/2026-09-07/flashinfer/attention.html) | 补充 | 5 | 已归档；固定快照 |
| `mlsys2026-29416b66c2149872b9d1415a3fd2c5e0` | [Breaking the Ice: Analyzing Cold Start Latency in vLLM](../references/proceedings/MLSys/2026/papers/mlsys2026-29416b66c2149872b9d1415a3fd2c5e0.pdf) | 补充 | 10 | 已归档；固定快照 |
| `mlsys2026-3a7f9e485845dac27423375c934cb4db` | [CRAFT: Fine-Grained Cost-Aware Expert Replication For Efficient Mixture-of-Experts Serving](../references/proceedings/MLSys/2026/papers/mlsys2026-3a7f9e485845dac27423375c934cb4db.pdf) | 补充 | 10 | 已归档；固定快照 |
| `mlsys2026-42a452cbafa9dd64e9ba4aa95cc1ef21` | [Demystifying the Mixture of Experts Serving Tax](../references/proceedings/MLSys/2026/papers/mlsys2026-42a452cbafa9dd64e9ba4aa95cc1ef21.pdf) | 补充 | 6,10 | 已归档；固定快照 |
...
| `mlsys2026-ae8b0b5838ba510daff1198474e7b984` | [FlashAttention-4: Algorithm and Kernel Pipelining Co-Design for Asymmetric Hardware Scaling](../references/proceedings/MLSys/2026/papers/mlsys2026-ae8b0b5838ba510daff1198474e7b984.pdf) | 补充 | 4,5 | 已归档；固定快照 |
| `mlsys2026-fbe2b2f74a2ece8070d8fb073717bda6` | [Machine Learning Fleet Efficiency: Improving TPU Systems at Scale with ML Productivity Goodput](../references/proceedings/MLSys/2026/papers/mlsys2026-fbe2b2f74a2ece8070d8fb073717bda6.pdf) | 补充 | 11 | 已归档；固定快照 |
...
| `osdi24-agrawal` | [Taming Throughput-Latency Tradeoff in LLM Inference with Sarathi-Serve](../references/proceedings/OSDI/2024/selected/osdi24-agrawal.pdf) | 补充 | 9 | 已归档；固定快照 |
| `osdi24-sun-biao` | [Llumnix: Dynamic Scheduling for Large Language Model Serving](../references/proceedings/OSDI/2024/selected/osdi24-sun-biao.pdf) | 补充 | 10 | 已归档；固定快照 |
| `osdi24-zhong-yinmin` | [DistServe: Disaggregating Prefill and Decoding for Goodput-optimized Large Language Model Serving](../references/proceedings/OSDI/2024/selected/osdi24-zhong-yinmin.pdf) | 补充 | 10 | 已归档；固定快照 |
...
| `osdi25-ren` | [Enabling Efficient GPU Communication over Multiple NICs with FuseLink](../references/proceedings/OSDI/2025/selected/osdi25-ren.pdf) | 补充 | 7 | 已归档；固定快照 |
| `osdi25-zhu-kan` | [NanoFlow: Towards Optimal Large Language Model Serving Throughput](../references/proceedings/OSDI/2025/selected/osdi25-zhu-kan.pdf) | 补充 | 5,9 | 已归档；固定快照 |
...
| `osdi26-wu-tianyuan` | [Weave: Efficient Co-Scheduling for Disaggregated RL Post-Training](../references/proceedings/OSDI/2026/selected/osdi26-wu-tianyuan.pdf) | 补充 | 11 | 已归档；固定快照 |
| `osdi26-chen-zhenqian` | [RobustRL: Role-Based Fault Tolerance System for RL Post-Training](../references/proceedings/OSDI/2026/selected/osdi26-chen-zhenqian.pdf) | 补充 | 11 | 已归档；固定快照 |
| `osdi26-ghosh` | [GraCE: Unlocking CUDA Graphs with Compiler Support for ML Workloads](../references/proceedings/OSDI/2026/selected/osdi26-ghosh.pdf) | 补充 | 5 | 已归档；固定快照 |
| `nsdi24-hou` | [Understanding Routable PCIe Performance for Composable Infrastructures](../references/proceedings/NSDI/2024/selected/nsdi24-hou.pdf) | 补充 | 7 | 已归档；固定快照 |
| `nsdi24-jiang-ziheng` | [MegaScale: Scaling Large Language Model Training to More Than 10,000 GPUs](../references/proceedings/NSDI/2024/selected/nsdi24-jiang-ziheng.pdf) | 补充 | 7,11 | 已归档；固定快照 |
...
| `nsdi26-xiang-servegen` | [ServeGen: Workload Characterization and Generation of Large Language Model Serving in Production](../references/proceedings/NSDI/2026/selected/nsdi26-xiang-servegen.pdf) | 补充 | 3,10 | 已归档；固定快照 |
...
| `interview-fourth-anthropic-prachub` | [Anthropic Software Engineer Interview Experience — Perfect OA, Rejected at the ML Inference System Design Phone Screen | PracHub](../references/interviews/2026-09-08/fourth-pass/anthropic-prachub.html) | 补充 | 补充／版本参照 | 已归档；固定快照 |
...
| `interview-fourth-otel-resiliency` | [Resiliency | OpenTelemetry](../references/interviews/2026-09-08/fourth-pass/otel-resiliency.html) | 补充 | 补充／版本参照 | 已归档；固定快照 |
| `interview-fourth-otel-sampling` | [Sampling | OpenTelemetry](../references/interviews/2026-09-08/fourth-pass/otel-sampling.html) | 补充 | 补充／版本参照 | 已归档；固定快照 |
| `interview-fourth-kafka-delivery` | [Design | Apache Kafka](../references/interviews/2026-09-08/fourth-pass/kafka-delivery.html) | 补充 | 补充／版本参照 | 已归档；固定快照 |
...
| `isca24-public-011-author` | [Mind the Gap: author-hosted public PDF](../references/proceedings/ISCA/2024/public/paper-011-author.pdf) | 补充 | 5 | 已归档；固定快照 |
