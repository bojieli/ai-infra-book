...
axes[2].set_xticks(range(3),policies);axes[2].set_ylabel('Generated tokens per candidate');axes[2].axhline(4096,color='gray',ls='--');axes[2].set_title('Thinking + final output, total cap 4096')
