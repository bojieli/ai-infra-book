...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf0 = torch.ops.book504.opaque.default(arg0_1, arg1_1)
            del arg0_1
            del arg1_1
            buf1 = buf0[0]
            assert_size_stride(buf1, (1, 12288), (12288, 1), 'torch.ops.book504.opaque.default')
            assert_alignment(buf1, 16, 'torch.ops.book504.opaque.default')
            buf2 = buf0[1]
            assert_size_stride(buf2, (1, 1), (1, 1), 'torch.ops.book504.opaque.default')
