...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf0 = torch.ops.book504round.opaque.default(arg1_1, arg3_1)
            del arg1_1
            del arg3_1
            buf1 = buf0[0]
            assert_size_stride(buf1, (s33, 12288), (12288, 1), 'torch.ops.book504round.opaque.default')
            assert_alignment(buf1, 16, 'torch.ops.book504round.opaque.default')
            buf2 = buf0[1]
            assert_size_stride(buf2, (s33, 1), (1, 1), 'torch.ops.book504round.opaque.default')
